<?php 
    ...
    class proceso{
      ...
      //-----------------------------------------------------------------------------------------------------------
      public function BusquedaGrilla($estado,$tipo,$fecha1,$fecha2,$idbodega1,$id_departamentoe){
      
          
          if ( $id_departamentoe == '0'){
              $filtro = 'N';
          }else{
              $filtro = 'S';
          }
      	...
      	$qquery = 
      			...
      			array( campo => 'idbodega',     valor => $idbodega1 ,  filtro => 'S',   visor => 'N'),
      			 array( campo => 'id_departamento',     valor => $id_departamentoe ,  filtro => $filtro,   visor => 'N'),
        ...
        // filtro para fechas
      	...
      	while ($fetch=$this->bd->obtener_fila($resultado)){
      		...
      		$output[] = array (
      		                    $fetch['id_movimiento'],$fetch['unidad'],
      		                    $fetch['fecha'],$fetch['detalle'],
...
///------------------------------------------------------------------------ 
    		...
    		$gestion   = 	new proceso;
   			 ...
   			 if (isset($_GET['estado']))	{
   			 	...
   			 	$id_departamentoe =  $_GET['id_departamentoe'];
   			 	
   			 	
   			 	
   		 	 	 
   			 	$gestion->BusquedaGrilla($estado,$tipo,$fecha1,$fecha2,$idbodega1,$id_departamentoe);
