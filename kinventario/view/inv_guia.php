...
<head>
 ...
 <script type="text/javascript" src="../js/inv_guia.js"></script> 
 		 	     ...
 		 	     <div class="col-md-12">
                    ...
                    <ul id="mytabs" class="nav nav-tabs">                    
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> <b>GUIAS DE EMISION EMITIDAS </b>  </a>
                   		</li>
                  		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Informacion Guia por emitir</a>
                  		</li>
                   </ul>
                     <!-- ------------------------------------------------------ -->
                   <!-- Tab panes -->
                                                             ...
                                                             <div class="col-md-9">
                                                               ...
                                                               <table id="jsontable" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%"  >
                                                                                            <thead>
                                                                                                ...
                                                                                                <th width="20%">Direccion Partida</th>
