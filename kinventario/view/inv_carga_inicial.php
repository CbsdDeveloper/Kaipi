...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/inv_carga_inicial.js"></script> 
    ...
    <div class="col-md-12" style="padding-top: 35px"> 
	       ...
	       <ul id="mytabs" class="nav nav-tabs">          
                  		<li class="active"><a href="#tab1" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b>CARGA Y REVISIÓN DE INVENTARIOS</b>  </a>
						</li>
	 
                   	 
                  		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> DETALLE DE PRODUCTOS/ARTICULOS</a>
                  		</li>
           </ul>
					  		  ...
					  		  <table id="jsontable" class="display table-condensed" cellspacing="0" width="100%">
									 <thead  bgcolor=#F5F5F5>
									   <tr>   
													 ...
													 <th width="30%">Grupo Levantamiento Datos</th>
													 <th width="20%">Sesion</th>
