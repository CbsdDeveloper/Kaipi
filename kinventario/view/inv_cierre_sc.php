 ...
 <div class="col-md-12" style="padding-top: 55px"> 
	       ...
	       <ul id="mytabs" class="nav nav-tabs">          
                  		...
                  		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span>Cierre de Caja - Ventas</a>
                  		</li>
	 					<li><a href="#tab3" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span>Notas de Credito - Ventas</a>
                  		</li>
									         ...
									         <div class="alert alert-info"><div class="row">
													...
													<button type="button" class="btn btn-sm btn-primary" id="load"><i class="icon-white icon-search"></i> Buscar</button>
														...
														<button type="button" class="btn btn-sm btn-default" id="loadFac">
															<i class="icon-white icon-archive"></i> Actualizar Facturas</button>
												</div>
								 			 </div>
								  			</div>
