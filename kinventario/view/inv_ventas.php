 		 	     ...
 		 	     <div class="col-md-12">
                    ...
                    <ul id="mytabs" class="nav nav-tabs">                    
						...
						<li><a href="#tab3" data-toggle="tab">
                  			<span class="glyphicon glyphicon-glass"></span> Graficos</a>
                  		</li>
                  		<li><a href="#tab4" data-toggle="tab">
                  			<span class="glyphicon glyphicon-apple"></span> Analisis</a>
                  		</li>
						
						<li><a href="#tab5" data-toggle="tab">
                  			<span class="glyphicon glyphicon-bullhorn"></span> Resumen</a>
                  		</li>
                      ...
                      <div class="panel panel-default">
						  <div class="panel-body" > 
							...
							<div class="btn-group btn-group-sm">
								...
								<button type="button" onClick="goToURL(3)"  class="btn btn-warning">Resumen Anual</button>
								
								<button type="button" onClick="goToURL(6)"  class="btn btn-info">Resumen Categoria</button>
								<button type="button" onClick="goToURL(7)"  class="btn btn-success">Resumen Financiero</button>
								
								<button type="button" onClick="goToURL(8)"  class="btn btn-warning">Resumen por Caja</button>
								  ...
								  <div class="panel panel-default">
									  <div class="panel-body" > 
										   ...
										   <div class="col-md-12" style="padding: 8px">
												...
												<div class="col-md-3">
													<select id='ganio' class='form-control'>
						 ...
						 <div class="tab-pane fade in" id="tab4"  style="padding-top: 3px">
								  <div class="panel panel-default">
									  <div class="panel-body" > 
												 ...
												 <div class="col-md-12" style="padding: 8px">
													<button type="button" class="btn btn-sm btn-primary" id="loadanalisis" >  
														<i class="icon-white icon-search"></i> Generar Informacion</button>	

													   <button type="button" class="btn btn-sm btn-default" onClick="ExcelAnalisis()" id="saveAsExcel">  
																				<i class="icon-white icon-download-alt"></i></button>	

													 <button type="button" class="btn btn-sm btn-default" onClick="printDiv()" id="saveAsExcel">  
																				<i class="icon-white icon-print"></i></button>	

												 </div>  

												 <div class="col-md-12" style="padding: 8px" id="ImprimeAnalisis">
													   <div id="ViewAnalisis"></div> 
												</div>
						...
						<div class="tab-pane fade in" id="tab5"  style="padding-top: 3px">
								  <div class="panel panel-default">
									  <div class="panel-body" > 
												 ...
												 <div class="col-md-12" style="padding: 8px">
													<button type="button" class="btn btn-sm btn-primary" onClick="ProcesarInformacion()">  
														<i class="icon-white glyphicon-console"></i> Generar Informacion</button>	
													 
													 
													 <button type="button" class="btn btn-sm btn-default" onClick="PoneInformacion()">  
														<i class="icon-white icon-search"></i> Visualizar  Informacion</button>	

													   <button type="button" class="btn btn-sm btn-default" onClick="ExcelAnalisis()" id="saveAsExcel1">  
																				<i class="icon-white icon-download-alt"></i></button>	

													  
												 </div>  

												 <div class="col-md-12" style="padding: 8px" id="ImprimeAnalisisResumen">
													   <div id="ViewAnalisisInventarios"></div> 
												</div>
