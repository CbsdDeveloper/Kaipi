...
function ElectronicoTool( ) {
	...
	var estado =  $("#estado").val();
     ...
     var id 	 = $('#cab_codigo').val();
     
    
     alert('Generando Guia Electronica');
...
function firma_auto( id ) {
	  ...
	  $.ajax({
			data:  parametrosi,
			url:   '../../facturae/autoriza_guia_firma.php',
			type:  'GET' ,
			success:  function (data) {
...
function firma_electronica(  ) {
    ...
    var parametrosf = {
		...
		//---	url:   '../model/externo_guia.php',
		
   $.ajax({
				data:  parametrosf,
		    	url:   '../../facturae/autoriza_guia.php',
				type:  'GET' ,
				success:  function (data) {
...
function ElectronicoImprime( ) {
    ...
    if ( id > 0 ) {
		      ...
		      var url = '../../facturae/guia_electronica.php';
...
//-------------------------------
 ...
 function PoneDatoDetalle(codigo) {
			     ...
			     var parametros = {
				  ...
				  $.ajax({
								data:  parametros,
								url:   '../model/Model-guia_factura_cab.php',
								type:  'GET' ,
			 					success:  function (data) {
										 $("#det_factura").html(data);  // $("#cuenta").html(response);
