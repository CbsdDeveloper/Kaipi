...
<?php 
    ...
    class componente{
     ...
     function Formulario( ){
        ...
        $x = $this->bd->query_array('web_registro',
                                   'correo, web,  direccion, telefono, email,  idciudad', 
                                    'tipo='.$this->bd->sqlvalue_inyeccion('principal',true));
        
     
     
        $datos['idciudad'] =  trim($x['idciudad']);
        $datos['direccion'] = trim($x['direccion']);
	...
	$this->obj->text->text('FechaNacimiento','date','nacimiento',10,10,$datos ,'','','div-2-4') ;
