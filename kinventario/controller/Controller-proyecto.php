    ...
    class componente{
      ...
      function componente( ){
            //inicializamos la clase para conectarnos a la bd
               ...
               $this->formulario = 'Model-admin_proyecto.php'; 
     ...
     function Formulario( ){
        ...
        $this->set->body_tab('Proyectos','inicio');
        ...
        $datos = array();
                ...
                $this->obj->list->lista('Catalogo',$MATRIZ,'tipo',$datos,'required','','div-2-4'); 
                
                $this->obj->text->text('Nombre',"texto",'nombre',50,50,$datos,'required','','div-2-10') ;  
                
                $this->obj->text->text('Referencial',"texto",'codigo',50,50,$datos,'required','','div-2-4') ;   
                ...
                $this->obj->list->lista('Estado',$MATRIZ,'publica',$datos,'required','','div-2-10'); 
