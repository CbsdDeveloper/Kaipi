...
class componente{
    ...
    function _05_Cabecera_FacturaElectronica( $id){
        ...
        $﻿ATabla = array(
            ...
            array( campo => 'secuencial',   tipo => 'VARCHAR2',   id => '4',  add => 'S',   edit => 'S',   valor =>$secuencial,   filtro => 'N',   key => 'N'),
    ...
    function _Verifica_facturas(   ){
        ...
        //-----------------------------
        $sql = "update inv_movimiento_det
                     set monto_iva = 0,baseiva=0
                   where  monto_iva is null and  tarifa_cero > 0" ;
  ...
  //-----------------------------------------------------
    function _lote_factura( $cajero,$fecha  ){
...
if ($key == 1) {
    ...
    $data = $gestion->_lote_factura($cajero,$fecha1);
