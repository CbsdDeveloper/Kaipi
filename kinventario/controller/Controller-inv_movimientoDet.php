<?php 
    ...
    /*
    DETALLE DE INFORMACION DE ARTICULOS, EJEMPLO DE MAESTRO/DETALLE
   ENTRADA: CODIGO DE INVENTARIOS
   GRILLA DE INFORMACION DE LOS DETALLES DE LOS PRODUCTOS
    */
          ...
          $ii = 1;
           ...
           while ($x=$this->bd->obtener_fila($stmt)){
               ...
               echo '<tr>
                   ...
                   <td> '.$this->campo1('montoiva',$id,'calcular('.$id .' )',$x['monto_iva'],'N').'  </td>
                   <td> '.$this->campo1('pdescuento',$id,'calculard('.$id .' )',$x['pdescuento'],'N').'  </td>
                   <td> '.$this->campo1('descuento',$id,'calcularde('.$id .' )',$x['descuento'],'N').'  </td>
