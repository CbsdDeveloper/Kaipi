...
class proceso{
    ...
    function archivo_xml($archivo , $id, $bodega){
      ...
      //  $file = '../archivos/xml/'.$archivo ;
        ...
        if ( $procesado == 1){
            ...
            $idmovimiento =  $this->movimiento($bodega   );
            
            $this->_VariablesFactura($id,$bodega,$idmovimiento);
            
            $procesado = 'Proceso generado ...ok Actualice la informacion...Nro.Movimiento: '.$idmovimiento;
        }
   ...
   //------------------------------------ 
    function _VariablesFactura( $id,$bodega ,$idmovimiento ){
        ...
        while ($x=$this->bd->obtener_fila($stmt13)){
            ...
            $nn = $this->existe_asiento($idproducto,$idmovimiento);
            
            if ( $nn == 0 ){
                
                $this->nuevo($idmovimiento,$idproducto,$datos);
            }
