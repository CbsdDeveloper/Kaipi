<?php 
	...
	if ($accion == 'add'){
	    if ($idproducto <> '...'){
	        nuevo( $id_movimiento,$idbarra, $bd ,$estado,$tipo,$idbodega,$registro);
	    }
	}
...
//--- funciones grud	
	...
	function nuevo($id_movimiento,$idbarra, $bd ,$estado,$tipo,$idbodega,$registro ){
 	    ...
 	    $AProducto = $bd->query_array( 'web_producto',
 	        ...
 	        'codigob='.$bd->sqlvalue_inyeccion(trim($idbarra),true)." and  
