    ...
    class componente{
     ...
     function Formulario( ){
        ...
        while ($fila= $this->bd->obtener_fila($stmt)){
            ...
            $evento = ' onClick="actualiza_cliente('.$codigo.','."'" .$marca."',". $id_par_ciu .','. "'". $correo ."'".')" ';

          

            echo ' <div class="col-md-3"  align="center" style="padding-bottom: 10px;padding-top: 10px">';

            echo '  <a href="#" '.$evento .' ><img src="../../kimages/'.$grafico.'" align="absmiddle" width="180" height="130" alt=""/> <br><b>'.$marca.'</b></a><br>';
