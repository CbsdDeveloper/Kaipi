    ...
    class componente{
      ...
      function componente( ){
            //inicializamos la clase para conectarnos a la bd
               ...
               $this->formulario = 'Model-ren_tramites_uni.php'; 
  ...
  //----------------------------------------------------......................-------------------------------------------------------------
   ...
   $eventoaa              = "Abrir_informacion()";
    ...
    $ToolArray = array( 
                ...
                array( boton => 'Enviar requerimiento a la unidad Rentas', evento =>$eventop,  grafico => 'glyphicon glyphicon-flash' ,  type=>"button_success"),
                array( boton => 'Anular/Cierre Transaccion', evento =>$eventoa,  grafico => 'glyphicon glyphicon-trash' ,  type=>"button_danger"),
                array( boton => 'Apertura/Abrir Transaccion', evento =>$eventoaa,  grafico => 'glyphicon glyphicon-alert' ,  type=>"button_primary"),
                );
