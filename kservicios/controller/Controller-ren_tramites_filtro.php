    ...
    class componente{
      ...
      function FiltroFormulario(){
       ...
       $MATRIZ  = array(
        ...
        $sql = " select 0 as codigo , ' -- 0. Seleccionar Servicios --  ' as nombre union
      ...
      $evento = 'onchange="AsignaRubro(this.value)"';
            ...
            $this->obj->list->listadbe($resultado,$tipo,'','midrubro',$datos,'required','',$evento,'div-0-6');
            ...
            $this->obj->list->lista('',$MATRIZ,'festado',$datos,'required','','div-0-3');
        
            $this->obj->text->text_place('Busqueda Identificacion','texto','ruc',120,120,$datos ,' ','','div-0-3') ;
 
            $this->obj->text->text_place('Busqueda Contribuyente','texto','nombrec',120,120,$datos ,' ','','div-0-6') ;
