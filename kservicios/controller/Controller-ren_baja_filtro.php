...
session_start();   
    ...
    class componente{
      ...
      function FiltroFormulario(){
       ...
       $this->obj->text->text_place('Busqueda Identificacion','texto','ruc',120,120,$datos ,' ','','div-0-2') ;
    
    
       $this->obj->text->text_place('Busqueda Contribuyente','texto','nombrec',120,120,$datos ,' ','','div-0-3') ;
