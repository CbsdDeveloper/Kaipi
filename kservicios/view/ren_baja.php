...
<head>
   ...
   .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th {
    ...
    border-top: 1px solid #ddd;
 	...
 	<script type="text/javascript" src="../js/ren_baja.js"></script> 
    ...
    <div class="col-md-12"> 
						   ...
						   <ul id="mytabs" class="nav nav-tabs">          
										...
										<li class="active"><a href="#tab1" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b> BAJA DE TITULOS</b>  </a>
										</li>
														 ...
														 <div class="col-md-12"> 
																  ...
																  <table id="jsontable" class="display table-condensed" cellspacing="0" width="100%">
																		 <thead  bgcolor=#F5F5F5>
																		   <tr>   
																						<th width="10%">Nro.Baja</th>
																						<th width="10%">Fecha</th>
																						<th width="10%">Identificacion</th>
																						<th width="25%">Contribuyente</th>
	  ...
	  <div class="modal fade" id="myModalpa" tabindex="-1" role="dialog">
		  ...
		  <div class="modal-dialog" id="mdialTamanio1">
					...
					<div class="modal-content">
								  ...
								  <div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
									<h3  class="modal-title">Titulos generados</h3>
								  </div>
											 ...
											 <div class="form-group" style="padding-bottom: 10px">
													 <div class="panel panel-default">
														 ...
														 <div class="panel-body">
															 ...
															 <div id="ViewFiltroTitulo"> var</div> 
