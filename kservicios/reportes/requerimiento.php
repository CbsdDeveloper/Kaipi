...
<body>
     ...
     <div class="col-md-12" style="padding-top: 5px;padding-bottom: 5px"> 	
 			...
 			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
				  <td colspan="4" align="center" style="font-size: 12px;color:#727272"><b>Nro.Tramite <?php echo $datos['comprobante'] ?></b></td>
  				</tr>
				<tr>
	 ...
	 <div class="col-md-12" style="padding-top: 5px;padding-bottom: 5px"> 	
		...
		<table width="100%">
 					...
 					<tr>
							  <td  style="font-size: 10px;padding-bottom:10px;padding-top: 30px; border-collapse: collapse; border: 1px solid #AAAAAA;" align="center" valign="middle"><img src="firma_inspector.png" width="148" height="80" alt=""/><br> 
							    FIRMA INSPECTOR:<br>
							  CC.:</td>
							  <td  style="font-size: 10px;padding-bottom:10px;padding-top: 30px;;border-collapse: collapse; border: 1px solid #AAAAAA;"  align="center" valign="bottom">FIRMA DEL SOLICITANTE<br> NOMBRE:<br>
							  CC.:</td>
					</tr>
					<tr>
		  					<td  style="font-size: 10px;padding-bottom:10px;padding-top: 40px;;border-collapse: collapse; border: 1px solid #AAAAAA;"  align="center" valign="middle"><br>
		  					  VISTO BUENO<br>
		   					 APROBADO 
								<?php 
							 
								
										if ( trim( $imagen  ) == 'aprobado'){
											
											   echo '<img src="../../kimages/chequeok.png" align="absmiddle"  width="10" height="10"/>';
											 }else{
												echo '<img src="../../kimages/chequea.png" align="absmiddle"  width="10" height="10"/>';
											 }
								...
								&nbsp;&nbsp; 
								NEGADO  
								<img src="../../kimages/chequea.png" align="absmiddle"  width="10" height="10"/></td>
					 		 <td  style="font-size: 10px;padding-bottom:10px;padding-top: 40px;;border-collapse: collapse; border: 1px solid #AAAAAA;"  align="center" valign="middle"><br>
		 		      TCRNL. HUGO ASTUDILLO TORRES<br>JEFE DE CBVS</td>
	  				</tr>
				</table>
