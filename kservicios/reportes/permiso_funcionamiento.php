...
<body>
	...
	<div class="page" align="center">
				...
				<tr>
				  <td>
					...
					<tbody>
					  ...
					  <tr>
					    <td colspan="3" align="center" style="font-size: 13px">&nbsp;</td>
				      </tr>
					  <tr>
					    <td colspan="3" align="center" style="font-size: 13px;padding: 12px">&nbsp;</td>
				      </tr>
					  <tr>
					    <td colspan="3" align="center" ><span style="font-size: 22px"><b>PERMISO ANUAL DE FUNCIONAMIENTO</b></span></td>
				      </tr>
					  <tr>
					    <td colspan="3" align="center" style="font-size: 13px" >Válido del 01 de enero al 31 de diciembre del presente periodo <b>- <?php echo $datos['anio']; ?>- </b></td>
				      </tr>
					  <tr>
					    <td colspan="3" align="right"><img width="75" height="75" src='logo_qr.png'/><br>		</td>
				      </tr>
					  <tr>
					    <td colspan="3" style="font-size: 13px" align="justify">Al haber dado cumplimiento con lo que dispone la LEY DE DEFENSA CONTRA INCENDIOS en el Art. 35 que obliga adaptar todas las medidas necesarias para prevenir flagelos.
					      Se otorga el Permiso Anual de Funcionamiento, a: <b><?php echo substr($actividad,0,100).'...' ?> </b>
					      <br> 
				...
				<tr>
				  <td align="right"><span style="font-size: 8px;color:#8F8F8F;font-style: italic"> <?php  $codigo.' '.$gestion->QR_Firma(); ?><br> <?php  echo date('Y-m-d h:i:s a') ?></span>	</td>
				</tr>
			  </tbody>
			</table>
