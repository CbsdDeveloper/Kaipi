...
<body>
	 ...
	 <div class="col-md-12" style="padding-top: 5px;padding-bottom: 5px"> 	
					...
					<?php $gestion->Tramite_variables_formulario($idasiento, $datos['id_rubro']);  ?>
	 ...
	 <div class="col-md-12" style="padding-top: 5px;padding-bottom: 5px"> 	
		...
		<table width="100%">
 					...
 					<tr>
							  <td  style="font-size: 10px;padding-bottom:10px;padding-top: 30px; border-collapse: collapse; border: 1px solid #AAAAAA;" align="center" valign="middle"> <br> 
							    FIRMA INSPECTOR:<br>
							  CC.:</td>
