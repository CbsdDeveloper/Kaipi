...
class proceso{
    ...
    public function BusquedaGrilla($tipo,$idcategoria1){
        ...
        $qquery = array(
            ...
            array( campo => 'especie',   valor => 'S',  filtro => 'S',   visor => 'S'),
            array( campo => 'tipo',   valor => $tipo ,  filtro => 'N',   visor => 'N'),
        ...
        $resultado = $this->bd->JqueryCursorVisor('rentas.ren_servicios',$qquery );
