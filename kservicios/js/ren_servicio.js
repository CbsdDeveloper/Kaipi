...
function goToURL(accion,id) {
     ...
     var parametros = {
	  ...
	  $.ajax({
					data:  parametros,
					url:   '../model/Model-ren_servicio.php',
					type:  'GET' ,
 					beforeSend: function () { 
 ...
 function fecha_hoy()
{
  ...
  function BusquedaGrilla(oTable){        
			...
			$.ajax({
			 	data:  parametros,  
			    url: '../grilla/grilla_ren_servicio.php',
				dataType: 'json',
				success: function(s){
						//console.log(s); 
						oTable.fnClearTable();
							...
							for(var i = 0; i < s.length; i++) {
							 oTable.fnAddData([
								...
								s[i][2],
       	                        ...
       	                        s[i][4],
       	                        s[i][5],
                               	'<button  title="Editar registro"  class="btn btn-xs btn-warning" onClick="goToURL('+"'editar'"+','+ s[i][0] +')"><i class="glyphicon glyphicon-edit"></i></button>&nbsp;' + 
								'<button  title="Eliminar registro" class="btn btn-xs btn-danger" onClick="goToURL('+"'del'"+','+ s[i][0] +')"><i class="glyphicon glyphicon-remove"></i></button>' 
							]);										
						} // End For
				  }						
				},
...
function FormView()
{
	 ...
	 $("#ViewForm").load('../controller/Controller-ren_servicio.php');
...
function FormFiltro()
{
	 ...
	 $("#ViewFiltro").load('../controller/Controller-ren_servicio_filtro.php');
