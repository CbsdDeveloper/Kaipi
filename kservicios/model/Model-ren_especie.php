...
class proceso{
    ...
    function consultaId($accion,$id ){
        ...
        $qquery = array(
            ...
            array( campo => 'costoe',   valor => '-',  filtro => 'N',   visor => 'S')
         );
    ...
    function agregar(   ){
        ...
        $InsertQuery = array(
            ...
            array( campo => 'costoe',   valor => @$_POST["costoe"]),
    ...
    function edicion($id  ){
        ...
        $UpdateQuery = array(
            ...
            array( campo => 'costoe',        valor => @$_POST["costoe"],  filtro => 'N')  ,
