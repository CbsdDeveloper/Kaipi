...
function edicion( $id_ren_tramite ){
    ...
    */
    ...
    function abrir_cierra($id,$novedad){
        ...
        $estado =  $x["estado"];
            ...
            if (   $long  > 10 )  {
                    ...
                    echo ' APERTURA/ABRIR DE TRANSACCION...'; 
    ...
    */
    ...
    function envio_seg($id,$datosi){
        ...
        $result = $this->div_resultado('enviado',$id,'enviado',1).' Leido';
    ...
    if (isset($_GET['accion']))	{
            ...
            if ( $accion == 'aprobado'){
               ...
               $estado              = trim($_GET['estado']);
                ...
                $gestion->abrir_cierra($id,$novedad);
