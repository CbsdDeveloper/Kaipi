...
session_start( );   
    ...
    class componente{
     ...
     function Formulario( ){
        ...
        $this->obj->text->text('<b>Fecha(*)</b>','date','fechaemisiondocsustento',10,10,$datos ,'required','','div-3-3') ;
 ...
 function BarraHerramientas($autoriza){
             ...
             $eventon = 'javascript:goToURLNotaConta()';
             ...
             $ToolArray = array(
                 ...
                 array( boton => 'Contabilizar Notas de Credito', evento =>$eventon,  grafico => 'glyphicon glyphicon-time' ,  type=>"button_danger")
             );
