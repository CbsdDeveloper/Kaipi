<?php 
	...
	$DatosCarga = 'No Existe movimiento de carga inicial '.$id_movimiento;
	
	 

	     if (empty($Existe["id_movimientod"]))
            {
    ...
    function nuevo($id_movimiento,$idproducto, $bd ,$estado,$tipo,$costo,$cantidad){
 	  ...
 	  //  $IVADesglose       =    1 + $IVA;
 	    ...
 	    $ATabla = array(
 	        ...
 	        array( campo => 'tipo',   tipo => 'VARCHAR2',   id => '9',  add => 'S',   edit => 'S',   valor =>trim($AProducto['tributo']),   filtro => 'N',   key => 'N'),
