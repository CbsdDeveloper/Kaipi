...
<script src="../js/jquery.PrintArea.js" type="text/JavaScript" language="javascript"></script>	
	...
	<script language="javascript" src="../js/inicial.js?n=1"></script>
...
<body>
    ...
    <div class="col-md-12"> 
       <!-- Content Here -->
								...
								<ul id="mytabs" class="nav nav-tabs">                    
										<li class="active"><a href="#tab2" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b>PRESUPUESTO INICIAL DE GASTO</b></a>
										</li>
								   ...
								   <!-- Tab 2 -->
									  ...
									  <div class="panel panel-default">
										   ...
										   <div class="panel-body" > 
											   ...
											   <div id="dfanio" style="padding-top: 5px;" class="col-md-3"><input type="number" name="fanio" id="fanio" required="required" autocomplete="offS" class="form-control" placeholder="requerido" step="0.01" style="text-align:right" value="2021"></div>
											     </div>	
											      ...
											      <div class="col-md-12" style="padding: 5px">
													 ...
													 <div style="padding: 5px">
														   ...
														   <button type="button" class="btn btn-sm btn-default" id="loadprintg" title="Imprimir Presupuesto de ingreso">  
 ...
 <div class="col-md-12">
		  	<div align="center" style="font-size: 18px;font-weight: 500" id="presupuesto_total">	</div>	   
 </div>	  
	  ...
	  <div class="modal fade" id="myModalAux" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h3  class="modal-title">Movimiento Presupuestario</h3>
		  </div>
				  <div class="modal-body">
				   <div class="form-group" style="padding-bottom: 10px">
			          <div class="panel panel-default">
 				         ...
 				         <div class="panel-body">
 					  		 <div id="ViewDetallePartida"> var</div> 
 					     </div>
					     </div>   
  					 </div>
				  </div>
