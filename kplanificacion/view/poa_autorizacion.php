...
.derecha {
 ...
 #mdialTamanio1{
  ...
  <script language="javascript" src="../js/POAutorizacion.js?n=1"></script>
       ...
       <!-- Content Here -->
		 ...
		 <div class="col-md-12" style="padding-bottom: 10px"> 
			 <div class="col-md-12" style="padding-top: 8px;">
				  ...
				  <button type="button"  onclick="ResumenPOA(2)" class="btn btn-sm btn-success" ><i class="icon-white icon-search"></i> Resumen por Estrategico</button>
				 
				  <button type="button"  onClick="ResumenPOA(1)"  class="btn btn-sm btn-info" ><i class="icon-white icon-search"></i> Resumen por Unidad</button>
				 
				  <button type="button"  onClick="ResumenPOA(3)"  class="btn btn-sm btn-danger" ><i class="icon-white icon-search"></i> Resumen por Responsables</button>
				        
				 
				  <button type="button"  onClick="ResumenPOActa()"  class="btn btn-sm btn-default" ><i class="icon-white icon-search"></i> Acta De Actividades POA</button>
		 ...
		 <div class="col-md-12" style="padding-bottom: 10px"> 
			...
			<div class="panel panel-default">
			  <div class="panel-heading">SEGUIMIENTO DE ACTIVIDADES- TAREAS PLANIFICADAS</div>
			  <div class="panel-body">
