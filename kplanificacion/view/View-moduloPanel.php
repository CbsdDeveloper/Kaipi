...
html, /*  body { height: 80% } BODY BACKGROUND IMAGE DOESNT ALWAYS REACH THE BOTTOM OF THE BROWSER*/
body {
	background-color: rgb(0, 0, 0); 
/*	background-image: url( ../../kimages/erpK.jpg);*/
...
<nav class="navbar navbar-fixed-left navbar-minimal animate" role="navigation">
							...
							<ul class="navbar-menu animate">
								<li>
									<a href="inicio" class="animate">
										<span class="desc animate"> Parametros</span>
										<span class="glyphicon glyphicon-cog"></span>
									</a>
								</li>
								<li>
									<a href="../../kplanificacion" class="animate">
										<span class="desc animate"> Planificación </span>
										<span class="glyphicon glyphicon-tasks"></span>
									</a>
								</li>
							
								<li>
									<a href="../../kinventario" class="animate">
										<span class="desc animate"> Seguimiento </span>
										<span class="glyphicon glyphicon-inbox"></span>
									</a>
								</li>
							
								<li>
									<a href="../../kcrm" class="animate">
										<span class="desc animate"> Financiero </span>
										<span class="glyphicon glyphicon-comment"></span>
									</a>
								</li>
								<li>
									<a href="../../kcrm" class="animate">
										<span class="desc animate"> Reportes </span>
										<span class="glyphicon glyphicon-cog"></span>
									</a>
								</li>
							</ul>
