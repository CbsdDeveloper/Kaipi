...
<head>
 ...
 <style type="text/css">
  ...
  <script type="text/javascript" src="../js/reforma.js"></script> 
    ...
    <div class="col-md-12"> 
								...
								<ul id="mytabs" class="nav nav-tabs">                    
										<li class="active"><a href="#tab1" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b>REPROGRAMACION</b>  </a>
										</li>
  ...
  <div class="container"> 
	  <div class="modal fade" id="myModalgasto" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
				  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			<h5 class="modal-title">Selección de partida de Gasto</h5>
		  </div>
				  <div class="modal-body">
						   <div class="form-group" style="padding-bottom: 10px">
			         	   <div class="panel panel-default">
