...
<script src="../js/jquery.PrintArea.js" type="text/JavaScript" language="javascript"></script>	
 ...
 <script type="text/javascript" src="../js/aval_pac.js"></script> 
	    ...
	    <div class="row">
								...
								<ul id="mytabs" class="nav nav-tabs">                    
										<li class="active"><a href="#tab1" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b>GESTION ADMINISTRATIVA</b></a>
										</li>
														  ...
														  <div class="panel panel-default">
															...
															<div class="col-md-3" style="padding: 7px">
																   ...
																   <button type="button" class="btn btn-sm btn-info" id="loadCer">  
																	<i class="icon-white icon-search"></i> Detalle Tramites</button>	
							 ...
							 <div class="modal-header">
							  ...
							  <div class="modal-body">
											  <div class="panel-body">
												     ...
												     <label style="padding-top: 12px;text-align: right;" class="col-md-2">Id.Tramite</label>
												   ...
												   <label style="padding-top: 12px;text-align: right;" class="col-md-2">Fecha Solicitud</label>
													<div  style="padding-top: 5px;" class="col-md-4">
												  ...
												  <label style="padding-top: 12px;text-align: right;" class="col-md-2">Fecha Certificacion</label>
													<div  style="padding-top: 5px;" class="col-md-4">
														<input type="date" name="fechac" id="fechac" required="required" autocomplete="offS" class="form-control" placeholder="requerido" readonly size="80" maxlength="80" value="">
												    </div>
												  
												  
												   <label style="padding-top: 12px;text-align: right;" class="col-md-2">Certificacion</label>
													<div  style="padding-top: 5px;" class="col-md-4">
														<input type="text" name="cur" id="cur" readonly  autocomplete="offS" class="form-control" placeholder="requerido" size="80" maxlength="80" value="">
												    </div>
												  
												  
												  
												   <label style="padding-top: 12px;text-align: right;" class="col-md-2">Fecha Devengado</label>
													<div  style="padding-top: 5px;" class="col-md-4">
														<input type="date" name="fechacc" id="fechacc" required="required" autocomplete="offS" class="form-control" placeholder="requerido" readonly size="80" maxlength="80" value="">
												    </div>
												  
												  
												   <label style="padding-top: 12px;text-align: right;" class="col-md-2">Devengado</label>
													<div  style="padding-top: 5px;" class="col-md-4">
														<input type="text" name="cur" id="cur"  readonly autocomplete="offS" class="form-control" placeholder="requerido" size="80" maxlength="80" value="">
												    </div>
												  
												   <label style="padding-top: 12px;text-align: right;" class="col-md-2">Novedad</label>
													<div  style="padding-top: 5px;" class="col-md-10">
														
														<textarea name="novedad" id="novedad" class="form-control"  ></textarea>
													 
														
												    </div>
												  
												    <label style="padding-top: 12px;text-align: right;" class="col-md-2">Estado</label>
												  	<div  style="padding-top: 5px;" class="col-md-4">
														
												  	<select name="festado"  id="festado" class="form-control">
 														<option value="2.1">2.1 Aval de Planificacion</option>
														<option value="2.2">2.2 Aval de Compras Publicas</option>
														<option value="3">3. (*) Emitir Certificacion</option>
														<option value="3.1">3.1 En proceso de contratación</option>
														<option value="3.2">3.2 En proceso de recepción</option>
														<option value="3.3">3.3 En proceso orden pago</option>
