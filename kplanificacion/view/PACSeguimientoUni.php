...
.derecha {
 ...
 #mdialTamanio1{
  ...
  <script language="javascript" src="../js/PACSeguimientoUni.js?n=1"></script>
...
<body>
    ...
    <div class="col-md-12"> 
       ...
       <!-- Content Here -->
			...
			<li class="active"><a data-toggle="tab" href="#home"><b>PLAN ANUAL DE CONTRATACION POR UNIDAD</b></a></li>
			 <li><a data-toggle="tab" href="#menu1"><b>SEGUIMIENTO DE PROCESO</b></a></li>
		   </ul>
		  ...
		  <div class="tab-content">
			 ...
			 <div class="col-md-2"> <img src="../../kimages/if_bullet_green_35779.png" class="media-object"> EJECUTADO </div>
					...
					<div class="panel panel-default">
					  <div class="panel-heading">SEGUIMIENTO DE PAC- POR UNIDAD</div>
					  <div class="panel-body">
													  ...
													  <div class="widget-content">
														     ...
														     <div class="col-md-3"> 
																 <div class="list-group">
																	  <a href="#" class="list-group-item active">Gestión de PAC</a>
																	  <a href="#" class="list-group-item">Certificación</a>
																	  <a href="#" class="list-group-item">Seguimiento</a>
