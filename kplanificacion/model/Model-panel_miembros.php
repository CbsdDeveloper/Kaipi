...
function chat_msg( $bd, $obj ){
    ...
    $sesion 	 = $_SESSION['login'];
     ...
     ///-------- busqyeda
      ...
      $sql = "SELECT  a.sesion,  a.fecha, a.mensaje,   a.sesion AS nombre
              FROM web_chat_directo a 
              where a.estado = 'E' and a.modulo = 'panel'  
          ...
          $i = 0;
            while ($x=$bd->obtener_fila($stmt)){
                ...
                if($x[0] == $sesion)
                {
				  ...
				  $imagen='if_Comment_edit_33568.png';	
                }else{
             ...
             $result = $result.$div_estilo.'
                      ...
                      <img class="direct-chat-img" src="../../kimages/'.$imagen.'" title="message user image"  width="25" height="25"/>
					  <!-- /.direct-chat-img -->
                      <div class="direct-chat-text"><small>'.$x[2].'</small></div>  </div>' ;
