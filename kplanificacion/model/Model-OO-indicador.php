...
class proceso{
		...
		$this->secuencia 	     = 'planificacion.pyobjetivosindicador_idobjetivoindicador_seq';
 		...
 		$this->ATabla = array(
				array( campo => 'idobjetivoindicador',   tipo => 'NUMBER',   id => '0',  add => 'N',   edit => 'N',   visor => 'S',   valor => '-',   filtro => 'N',   key => 'S'),
      		    array( campo => 'idobjetivo',tipo => 'NUMBER',id => '1',add => 'S', edit => 'N', valor => '-', key => 'N'),
	...
	function consultaId($accion,$id ){
		...
		$qquery = array( 
		 ...
		 $this->bd->JqueryArrayVisorTab('planificacion.view_indicadores_oo',$qquery,'-' );
	...
	function agregar(   ){
		...
		$this->ATabla[8][valor]  =  $_POST["estado1"];
