...
class proceso{
    ...
    function consultaId($accion,$id ){
        ...
        $datos = $this->bd->JqueryArrayVisor('presupuesto.pre_sireprogramacion_det',$qquery);
   ...
   function ingreso($id_sireprogra,$partida,$saldo ){
        ...
        //------------------------------------------------------------
        $sql = "INSERT INTO presupuesto.pre_sireprogramacion_det (fsesion,id_sireprogra, registro, partida, tipo, saldo, aumento, sesion,anio, disminuye,idtarea)
										        VALUES (".$this->hoy.",".
										        $this->bd->sqlvalue_inyeccion($id_sireprogra, true).",".
										        ...
										        $this->bd->sqlvalue_inyeccion($tarea, true).")";
						echo $sql;			        
    ...
    function gastoaumenta($id,$monto1,$monto2){
            ...
            $sql = " UPDATE presupuesto.pre_sireprogramacion_det 
							              SET 	aumento    =".$this->bd->sqlvalue_inyeccion($monto1, true).",
											    disminuye  =".$this->bd->sqlvalue_inyeccion($monto2, true)."
							      WHERE id_sirepro_det     =".$this->bd->sqlvalue_inyeccion($id, true);
   ...
   function eliminar($id){
        ...
        $sql = "DELETE FROM presupuesto.pre_sireprogramacion_det 
				 WHERE id_sirepro_det    =".$this->bd->sqlvalue_inyeccion($id, true);
...
if (isset($_GET['id_sireprogra']))	{
    ...
    $gestion->ingreso($id_sireprogra,$partida,$saldo);
...
if (isset($_GET['accion']))	{
    ...
    if ( $tipo == 'del'){
        ...
        $id_sirepro_det = $_GET['id_sirepro_det'];
        
        $gestion->eliminar($id_sirepro_det);
