     ...
     function Formulario( ){
        ...
        $this->set->body_tab($titulo,'inicio');
                ...
                $this->BarraHerramientas();
                    ...
                    $this->obj->text->text('Identificaci�n',"texto",'ruc_registro',20,15,$datos,'required','','div-2-4') ; 
		            ...
		            $this->obj->text->text('Razon Social',"texto",'razon',40,45,$datos,'required','','div-2-4');
		 			...
		 			$this->obj->text->text('Sitio Web',"texto",'web',20,15,$datos,'required','','div-2-4') ; 
					...
					$this->obj->list->lista('Referencia',$MATRIZ,'tipo',$datos,'required','','div-2-4');
		 			...
		 			$this->set->div_label(12,'<h6>Informacion solo para referencia principal<h6>');

		 			$this->obj->text->text('Notificaciones',"email",'email',40,45,$datos,'required','','div-2-4');
                    
		 			$this->obj->text->text('Host SMTP',"texto",'smtp',40,45,$datos,'required','','div-2-4');
                   
                                   
		 			$this->set->div_label(12,'<h6>Si no cuenta con correo Corporativo se recomienda usar Cuentas de GMAIL y/ YAHOO Ejemplo: empresa@gmail.com / empresa@yahoo.com YAHOO: ssl://smtp.mail.yahoo.com GMAIL: ssl://smtp.gmail.com - Puerto: 465 (Yahoo,Gmail)</h6>');
		 			
		 			$this->obj->text->text('Puerto',"texto",'puerto',40,45,$datos,'required','','div-2-4');
                    
		 			$this->obj->text->text('Clave acceso',"password",'acceso',40,45,$datos,'required','','div-2-4');
		 
		 			
		 			$this->set->div_label(12,'<h6>Informacion Empresa</center>');

		 			
		 			$this->obj->text->editor('Mision','mision',4,75,500,$datos,'required','','div-2-10') ;
		 
		 			$this->obj->text->editor('Vision','vision',4,75,500,$datos,'required','','div-2-10') ;
