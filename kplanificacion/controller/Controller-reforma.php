    ...
    class componente{
     ...
     function Formulario( ){
        ...
        $this->set->body_tab($titulo,'inicio');
                ...
                $this->obj->text->text('Reprogramacion',"number",'id_reforma',0,10,$datos,'','readonly','div-1-3') ;
                ...
                $this->obj->list->lista('<b>TIPO</b>',$MATRIZ,'tipo',$datos,'','','div-1-3');
                ...
                $cboton1 = '<a href="#" '.$cadena1.'><img src="../../kimages/if_wishlist_add_64997.png"/></a>';
                 
                $this->set->div_labelmin(12,'<h6> Detalle de Reprogramacion<h6>'.$cboton1);
