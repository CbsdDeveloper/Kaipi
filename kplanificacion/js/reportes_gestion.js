...
$(document).ready(function(){
	    ...
	    $('#loadxls').on('click',function(){
 	    	  var page   = "../../kpresupuesto/reportes/excel_tramite.php?tipop=G" ;
		   ...
		   $("#tramite").val(idtramite);  
			...
			var parametros = {
							...
							$.ajax({
								    type:  'GET' ,
									data:  parametros,
									url:   '../../kpresupuesto/model/ajax_fecha_presupuesto.php',
									dataType: "json",
...
//----------------------
...

 {
	 ...
	 $("#ViewFiltro").load('../../kpresupuesto/controller/Controller-inicial_filtro_gestion.php');
 ...
 function Gastos( )
 {
 	...
 	$.ajax({
 			...
 			data:  parametros,
 			 ...
 			 url:   '../../kpresupuesto/model/Model_reportes_gestion.php',
...
///------------------- 
 function tramites_filtro_conta( )
 {
 	...
 	$.ajax({
 			 data:  parametros,
 			 url:   '../../kpresupuesto/model/Model_reportes_gestion_conta.php',
 			 type:  'GET' ,
 			 cache: false,
 			 beforeSend: function () { 
...
function tramites_filtro( )
{
	...
	$.ajax({
			 data:  parametros,
			 url:   '../../kpresupuesto/model/Model_reportes_gestion_tramite.php',
			 type:  'GET' ,
			 cache: false,
			 beforeSend: function () { 
						$("#DetalleVistaInformacion").html('Procesando');
