...
<head>
 ...
 <script type="text/javascript" src="../js/cli_informe.js"></script> 
    ...
    <div class="col-md-12" > 
					  ...
					  <ul id="mytabs" class="nav nav-tabs">                    
						...
						<li><a href="#tab2" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> Flujo de  Procesos</a>
                   		</li>
                      ...
                      <div class="panel panel-default">
						  <div class="panel-body" > 
								  ...
								  <div class="col-md-6" style="padding: 1px">
									 ...
									 <div id="ViewFormTareaUs" style="padding: 5px"></div>
 								 			 
    							  </div>  
								
									  <div class="col-md-3" style="padding: 1px">
									  
										   <div id="ViewFormTiempo" style="padding: 5px"></div>
				       ...
				       <div class="tab-pane fade" id="tab2" style="padding-top: 3px">
						  <div class="panel panel-default">
									  <div class="panel-body" > 
