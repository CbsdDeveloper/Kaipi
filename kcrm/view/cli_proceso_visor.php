	    ...
	    <div class="row">
 		 	     <div class="col-md-12">
					  <ul id="mytabs" class="nav nav-tabs">                    
						...
						<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> PROCEDIMIENTO DEL PROCESO</a>
                  		</li>
						
						<li><a href="#tab3" data-toggle="tab">
                  			<span class="glyphicon glyphicon-bed"></span> FLUJO DEL PROCESO</a>
                  		</li>
				...
				<div class="tab-pane fade in" id="tab2"  style="padding-top: 3px">
  												  ...
  												  <div class="col-md-6" style="padding: 20px"> 
 															  ...
 															  <div id="DibujoProcedimiento" align="justify" style="padding: 10px"></div>
