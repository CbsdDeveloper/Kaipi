...
<head>
 ...
 <script type="text/javascript" src="../js/cli_proceso_auto.js"></script> 
       ...
       <!-- Content Here -->
	    <div class="row">
 		 	     <div class="col-md-12">
					  ...
					  <h5><b>PUBLICACIÓN Y APROBACIÓN DE PROCESOS</b></h5>
					 
					  <ul id="mytabs" class="nav nav-tabs">                    
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> Publicación de Procesos</a>
                   		</li>
						
						<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Flujo del Proceso</a>
                  		</li>
			
                  		<li><a href="#tab3" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Parametros del Proceso</a>
                  		</li>
                   </ul>
                     <!-- ------------------------------------------------------ -->
                   <!-- Tab panes -->
						  		...
						  		<div class="col-md-12" style="padding: 1px">
 								  <div class="col-md-5" style="padding: 1px">
   								 ...
   								 <div class="col-md-7" style="padding: 1px">
   								 		  <div id="Nombreproceso"  style="padding: 1px; background-color:#FDFBFB"> </div>
							    </div>
                             </div>
                        </div>  
                     </div> 
						     		...
						     		<div class="col-md-12" >	
										...
										<div class="col-md-7">
											...
											<div  id="formVentana">  </div>  
											  ...
											  <h4><b>PUBLICACION DEL PROCESO</b></h4>
  										 	  <!--  VARIABLES   --> 
				  ...
				  <div class="modal-body">
				   <div class="form-group" style="padding-bottom: 10px">
			          <div class="panel panel-default">
				         ...
				         <div class="panel-body">
 					  		 <div id="ViewTarea">  </div> 
							  <div id="guardarTarea">  </div> 
								   ...
								   <div class="form-group" style="padding-bottom: 10px">
									  <div class="panel panel-default">
											<div class="panel-body">
												 ...
												 <textarea cols="4" rows="25" id="procedimiento" name="procedimiento" class="form-control">Procedimiento</textarea>
