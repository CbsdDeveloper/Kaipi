														...
														<div class="panel-group" id="accordion">
																		 ...
																		 <div id="collapseTwo" class="panel-collapse collapse">
																			...
																			<div class="panel-body">
																				  ...
																				  <table id="json_variable" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%"  >
																				   ...
																				   <button type="button" class="btn btn-warning btn-sm" onClick="agregaVariable();" data-toggle="modal" data-target="#myModalAux">
																	...
																	<!--  DESCARGAS   --> 	
																		...
																		<div class="panel-heading">
																			...
																			<h4 class="panel-title">
																				<a data-toggle="collapse" data-parent="#accordion" href="#collapsesix" id="documentodesc" style="font-size:11px" >Documentos de DESCARGABLES  </a>
																			</h4>
																		...
																		<div id="collapsesix" class="panel-collapse collapse">
																			...
																			<div class="panel-body">
																			    ...
																			    <div id="ViewFormfile" name="ViewFormfile" style="padding: 10px"></div>
																				  
																				<button type="button" class="btn btn-sm btn-danger" onclick="openFile('../../upload/uploadDoc_flow',650,360)"> Cargar/Descargar Documento</button>
																		...
																		<div id="collapsefive" class="panel-collapse collapse">
																			...
																			<div class="panel-body">
																						 ...
																						 <div class="alert alert-success">
																								 ...
																								 <div class="form-group">
																								   <label for="comment"><b>Ingrese novedad u observación para la implementación del proceso:</b></label>
																									 ...
																									 <input type="text" name="observa"  class="form-control" id="observa">
																								  ...
																								  <div class="form-group">        
																									...
																									<a href="../reportes/FichaProceso" class="btn btn-default" rel="pop-up">Ficha Proceso</a>
																									  ...
																									  <button type="button" class="btn btn-sm btn-info" onclick="openFile('../../upload/uploadDoc_logo',650,360)"> Cargar Imagen</button>
																				 ...
																				 <div class="col-md-12" align="center"> 
																					 	 <div class="col-md-5"> 
																					     <img id="ImagenUsuario" name = "ImagenUsuario" src="../../archivos/2020-7-42b0283145fa.png" width="500" height="350"/> </div> 
									  ...
									  <div class="panel panel-default">
											<div class="panel-body">
												 ...
												 <div class="col-md-12" align="center" style="padding: 7px;z-index: 800">
														<textarea  id="procedimiento" name="procedimiento"   > </textarea>
												 </div> 
