...
<head>
    ...
    <script language="javascript" src="../js/cli_incidencias_super.js"></script>
										      ...
										      <div class="panel-body"  > 
											      ...
											      <div class="col-md-2">
 														 <div class="col-md-12">
															 ...
															 <input type="text" name="codigo_tramite" id="codigo_tramite" class="form-control" placeholder="Ingresar codigo">
															 
														
															 
														 </div>	 
													   <div class="col-md-12" style="padding-bottom: 10px;padding-top: 10px">
													     		 <button type="button" onClick="goToURLProceso()" class="btn btn-sm btn-success">Búsqueda</button>
														 </div>	 
