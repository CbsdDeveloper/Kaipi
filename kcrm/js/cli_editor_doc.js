...
function PoneVariables( id) {
	...
	$.ajax({
				data:  parametros,
				url:   '../model/Model-ver_variables',
				type:  'GET' ,
				cache: false,
				beforeSend: function () { 
							$("#view_variables").html('Procesando');
					},
				success:  function (data) {
						 $("#view_variables").html(data);  
