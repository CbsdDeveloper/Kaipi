...
<head>
    ...
    <?php  require('Head.php')  ?> 
	 ...
	 <script language="javascript" src="vehiculos_bomberos.js"></script>
									 ...
									 <div class="col-md-12">
										 		 ...
										 		 <div class="col-md-6">
													  ...
													  <div class="col-md-12">
														    ...
														    <h4>Vehiculos Asignados </h4>
																 
																   <div id="Vehiculo_asigna"> Seleccionar vehiculo</div> 
 															 </div>
