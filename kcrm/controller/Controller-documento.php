        ...
        $MATRIZ = array(
         ...
         $evento = ' ';
     		...
     		$this->set->div_label(12,'<h6> Documentos del proceso<h6>');
                 ...
                 $this->obj->text->text_yellow('Documento',"texto",'documento',70,70,$datos,'required','','div-3-9') ;
                
                 $this->obj->list->listae('Tipo ',$MATRIZ,'tipo',$datos,'required','',$evento,'div-3-9');
             
                 $this->obj->list->listae('Activo',$MATRIZ_SI,'estado',$datos,'required','',$evento,'div-3-9');
