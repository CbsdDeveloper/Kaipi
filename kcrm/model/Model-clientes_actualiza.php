...
class proceso{
    ...
    //--------------------------------------------------------------------------------
    function edicion($id,$razon,$correo,$telefono ){
...
if (isset($_GET['idprov']))	{
    ...
    if (!empty($id))  {
        ...
        if ($okCliente > 0)	{
            ...
            $gestion->edicion($id,$razon,$correo,$telefono);
            $okCliente = '<b>DATOS ACTUALIZADOS CORRECTAMENTE: '.$id.'-'.$razon.'</b>';
        }
