...
class proceso{
	...
	function proceso( ){
		...
		$this->ATabla = array(
				...
				array( campo => 'enlace_url',   tipo => 'VARCHAR2',   id => '9',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N'),
				array( campo => 'columna',   tipo => 'VARCHAR2',   id => '10',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N'),
				array( campo => 'etiqueta',   tipo => 'VARCHAR2',   id => '11',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N'),
		);
	...
	function consultaId($accion,$id ){
		...
		$qquery = array(
				...
				array( campo => 'enlace_url',   valor => '-',  filtro => 'N',   visor => 'S') ,
