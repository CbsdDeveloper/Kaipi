...
class proceso{
    ...
    public function BusquedaGrilla($PK_codigo){
        ...
        $qquery = array(
            array( campo => 'id_docmodelo',   valor =>'-',  filtro => 'N',   visor => 'S'),
            ...
            array( campo => 'plantilla',   valor => '-',  filtro => 'N',   visor => 'S'),
             array( campo => 'tipo',   valor => $PK_codigo,  filtro => 'S',   visor => 'S')
        );
        
 
        
        
        $resultado = $this->bd->JqueryCursorVisor('flow.wk_doc_modelo',$qquery );
        
        while ($fetch=$this->bd->obtener_fila($resultado)){
            
            $output[] = array ($fetch['id_docmodelo'],
                $fetch['plantilla'],
                $fetch['tipo'],
                $fetch['visor']
             );
