 			  ...
 			  <table width="100%">
				...
				<h6>&nbsp;  </h6>
				  ...
				  <tbody>
					...
					<tr> 
					  <td align="justify">El monto del presente compromiso presupuestaria asciende a $ <?php  echo $gestion->_total() ?> Dólares americanos, que corresponde a <b><?php  echo trim($datos['razon'])?></b>, con Nro.Identificacion <?php  echo $datos['idprov']?>.</td>
					</tr>
					<tr>
					  <td align="justify"></td>
					</tr>
