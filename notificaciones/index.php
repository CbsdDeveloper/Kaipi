...
<body>
	...
	<div class='col-md-4' style="padding: 5px">
		...
		$datos =  $bd->__user(str_replace('@cbsd.gob.ec', '', $sesion));
		...
		$yy = $bd->query_array(
			'planificacion.view_tarea_poa',   // TABLA
			'count(*) as nn',                        // CAMPOS
		...
		if ($perfil == 'planificacion') {
			...
			$xa = $bd->query_array(
				'planificacion.view_reprogramaciones',
				'count(*) as nn',
