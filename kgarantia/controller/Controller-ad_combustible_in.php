...
<?php 
    ...
    class componente{
     ...
     function Formulario( ){
         ...
         $datos  = array();
         $MATRIZ = array(
             '-'  => ' - Seleccione el uso requerido -',
             'S'  => 'Movilizacion',
             'N'  => 'Uso Interno/Limpieza'
         );
         ...
         $this->set->_formulario( $this->evento_form,'inicio' ); 
                ...
                $this->set->div_panel6('<b> CONTROL DE VEHICULO  </b>');
                        ...
                        $this->obj->text->text_blue('<b>Codigo Vehiculo</b>','texto','codigo_veh',10,10,$datos ,'','readonly','div-2-10') ;
                        
                        $this->obj->text->text_blue('<b>Vehiculo</b>','texto','nombre_vehiculo',10,10,$datos ,'','readonly','div-2-10') ;
                          
                       
                        $this->obj->text->text_blue('<b>Nro.Placa</b>','texto','placa_vehiculo',10,10,$datos ,'','readonly','div-2-10') ;
                        
                        $this->obj->text->text_blue('<b>Conductor</b>','texto','chofer_vehiculo',10,10,$datos ,'','readonly','div-2-10') ;
                        
                        $this->obj->text->text_blue('<b>Km. Actual</b>',"number" ,'u_km' ,80,80, $datos ,'required','readonly','div-2-10') ;
                ...
                $this->obj->text->text_yellow('<b>Comprobante</b>','texto','referencia',10,10,$datos ,'required','','div-2-10') ;
                        ...
                        $this->obj->text->text('Lugar Salida',"texto" ,'ubicacion_salida' ,80,80, $datos ,'required','','div-2-10') ;
                        
                        $this->obj->text->text_yellow('Km.Actual',"number" ,'u_km_inicio' ,80,80, $datos ,'required','','div-2-10') ;
                        ...
                        $resultado = $this->bd->ejecutar("select nombre as codigo, nombre
            			                     from par_catalogo
            								where tipo = 'COMBUSTIBLE' and publica = 'S' order by nombre ");
