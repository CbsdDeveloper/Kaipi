...
class proceso{
    ...
    function proceso( ){
        ...
        $this->ATabla = array(
            ...
            array( campo => 'u_km_inicio',tipo => 'NUMBER',id => '4',add => 'S', edit => 'S', valor => '0', key => 'N'),
            ...
            array( campo => 'id_prov',tipo => 'VARCHAR2',id => '12',add => 'S', edit => 'S', valor => '0000000000', key => 'N'),
            ...
            array( campo => 'uso',tipo => 'VARCHAR2',id => '16',add => 'S', edit => 'S', valor => 'N', key => 'N')
        );
    ...
    function consultaId($accion,$id ){
        ...
        $this->bd->JqueryArrayVisor('adm.view_comb_vehi_in',$qquery );
