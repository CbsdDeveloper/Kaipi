...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/ad_orden.js"></script> 
 ...
 <div class="col-md-12"> 
	       ...
	       <ul id="mytabs" class="nav nav-tabs">          
                   		...
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
 							<span class="glyphicon glyphicon-th-list"></span> <b> Lista de Orden de Movilización</b></a>
         				     </li>
                  		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Formulario de Orden de Movilización</a>
                  		</li>
					  		  ...
					  		  <table id="jsontable" class="display table-condensed" cellspacing="0" width="100%">
									 <thead  bgcolor=#F5F5F5>
									   <tr>   
									     ...
									     <th width="5%">Fecha</th>
										 <th width="5%">Hora</th>
										 <th width="16%">Solicita</th>    
										 <th width="15%">Motivo</th>
										 <th width="14%">Conductor</th>
									     <th width="25%">Vehiculo</th>
										 <th width="5%">Salida Km</th>
										 <th width="5%">Llegada Km</th>
					...
					<div class="col-md-12" style="padding: 10px"> 
						  			  ...
						  			  <div class="panel panel-default">
												...
												<div class="panel-body" > 
													...
													<H5>Enlace Ordenes de Combustibles</H5>
  														  <button type="button" data-toggle="modal" onClick="PonePlaca()" data-target="#myModalContrato" class="btn btn-primary btn-sm">Enlazar Combustible</button>
  ...
  <div class="modal-dialog" id="mdialTamanio">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Ordenes de Combustible</h4>
        </div>
        <div class="modal-body">
           <form>
 				  <div class="input-group" style="padding: 5px">
					<span class="input-group-addon">Nro.Orden Combustible</span>
