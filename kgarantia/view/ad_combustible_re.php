...
<head>
	...
	<script type="text/javascript" src="../js/ad_combustible_re.js"></script> 
 ...
 <div class="col-md-12"> 
	       ...
	       <ul id="mytabs" class="nav nav-tabs">          
                   		...
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
 							<span class="glyphicon glyphicon-th-list"></span> <b> Control de Combustible Estacion</b></a>
         				     </li>
  									  ...
  									  <div class="alert alert-info">
 									    	<div class="row">
												 ...
												 <div class="col-md-3"  style="padding-top: 5px;">
													 ...
													 <select  name="qproveedor"  id="qproveedor" class="form-control required" placeholder="Ingrese nombre proveedor"></select>
					  		  ...
					  		  <table id="jsontable" class="display table-condensed" cellspacing="0" width="100%">
									 <thead  bgcolor=#F5F5F5>
									   <tr>   
										 ...
										 <th width="10%">Km Anterior</th>    
										 <th width="10%">Km Abaste.</th>
										  <th width="10%">Tipo</th>
									     <th width="10%">Cantidad</th>
										 <th width="5%">Costo</th>
										 <th width="10%">Total</th>
										  <th width="20%">Conductor</th>  
