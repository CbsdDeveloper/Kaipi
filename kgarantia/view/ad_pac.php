...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/ad_pac.js"></script> 
    ...
    <div class="col-md-12"> 
	       ...
	       <ul id="mytabs" class="nav nav-tabs">          
                   		...
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> <b> GESTION DE PAC </b>  </a>
                   		</li>
                  		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> SEGUIMIENTO Y DETALLE DE EJECUCION</a>
                  		</li>
						<li><a href="#tab3" data-toggle="tab">
                  			<span class="glyphicon glyphicon-alert"></span> IMPORTAR INFORMACION</a>
                  		</li>
								...
								<div class="panel panel-info">
									  ...
									  <div class="panel-body">
										 <button type="button" class="btn btn-sm btn-default" id="loadContrato"   >  
										  Agregar Nuevo Documento</button>	
											...
											<div id="ViewFormfileDoc" style="padding: 10px"></div>
									</div>
								</div>
								    ...
								    <div class="panel panel-info">
									  ...
									  <div class="panel-body">
										 ...
										 <div id="ViewFormfile" style="padding: 10px"></div>
