     ...
     function Formulario( ){
        ...
        $this->set->_formulario( $this->evento_form,'inicio' ); // activa ajax para insertar informacion
                ...
                $this->set->div_panel7('<h6> Informacion Documento<h6>');
                                    ...
                                    $this->obj->text->text_blue('Fracci�n dia/hora',"number" ,'hora_tomados' ,80,80, $datos ,'','readonly','div-3-9') ;
                ...
                $this->obj->text->text_blue('Fracci�n dia/hora',"number" ,'hora_tomados' ,80,80, $datos ,'required','readonly','div-3-9') ;
