...
//-----------------
function impresion_aporte(accion,id ){   

	var id_rol1 			= 	$('#id_rol1').val();

	var url = '../../reportes/rol_aporte_patronal.php'

	var posicion_x; 
	var posicion_y; 
	var enlace = url + '?id_rol=' + id_rol1 +'&programa=' + id;
...
function ResumenRolFinal1(  )
 {
	...
	var url_dato 			=   '';
		...
		url_dato =  '../model/Model-nom_rol_lista01.php';
