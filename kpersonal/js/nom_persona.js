...
$(document).ready(function(){
       ...
       oTable 	= $('#jsontable').dataTable( {      
		...
		$('#loadDoc').on('click',function(){
            ...
            openFile('../../upload/uploadDoc',650,320)
...
function goToURL(accion,id) {
     ...
     var parametros = {
	  ...
	  $.ajax({
					...
					data:  parametros,
					url:   '../model/Model-nom_persona.php',
					type:  'GET' ,
 					beforeSend: function () { 
 							$("#Ficha").html('Procesando');

  					},
					success:  function (data) {
							 $("#Ficha").html(data);  // $("#cuenta").html(response);
							 Ver_doc_prov(id) ;
...
//-----------------
...

 {
	 ...
	 $("#ViewForm").load('../controller/Controller-nom_persona.php');
