...
$(document).ready(function(){
	...
	$('#loadC').on('click',function(){
		...
		$('#loaddatos').on('click',function(){

			goToURLDelVisorBuscar( );
...
//--------------
  ...
  function ActualizaDatos( valor,idprov,id_config_reg,accion,id_rold ){   
			     ...
			     $.ajax({
						data:  parametros,
						url:   '../model/ajax_manual_rol_personal.php',
						type:  'GET' ,
	 					beforeSend: function () { 
...
//---------------
function goToURLDelVisorBuscar( ){   

	var id_rol1 			= 	$('#id_rol1').val();
  var id_config     	= 	$('#id_config1').val();
   var regimen    		= 	$('#regimen').val();
  ...
  var parametros = {
   ...
   $.ajax({
				 data:  parametros,
				 url:   '../model/Model-nom_manual_visor.php',
				 type:  'GET' ,
				  beforeSend: function () { 
						  $("#ViewProceso").html('Procesando');
				   },
...
//-----------------------------------------------  
  function goToURLDelVisor( ){   
       ...
       var parametros = {
  	  ...
  	  $.ajax({
  					data:  parametros,
  					url:   '../model/Model-nom_manual_grilla.php',
  					type:  'GET' ,
   					beforeSend: function () { 
   							$("#ViewProceso").html('Procesando');
    					},
...
function FormView()
{
	 ...
	 $("#ViewFiltro").load('../controller/Controller-nom_manual_filtro.php');
