...
<head>
    ...
    <title>Administracion-Plataforma de Gestión Empresarial</title>
	
    <?php  require('Head.php')  ?> 
    
 	<script type="text/javascript" src="../js/nom_imp_renta.js"></script> 
																	  ...
																	  <table id="jsontable" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%">
																			<thead> 
																				<tr> 
																					<th width="10%">Id</th>
																					<th width="10%">Anio</th>
																					<th width="20%">Fracción basica</th>
																					<th width="15%">Excedente</th>
																					<th width="25%">Base imponible</th>
