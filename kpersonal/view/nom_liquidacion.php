...
<head>
 ...
 <script type="text/javascript" src="../js/nom_liquidacion.js"></script> 
 		 	 ...
 		 	 <div class="col-md-12">
                    ...
                    <ul id="mytabs" class="nav nav-tabs">                    
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> Reporte de Liquidacion de Personals</a>
                   		</li>
					   ...
					   <li><a href="#tab3" data-toggle="tab">
                  			<span class="glyphicon glyphicon-alert"></span> Historial Financiero</a>
                  		</li>
                                                           ...
                                                           <div class="col-md-12">
                                                               ...
                                                               <table id="jsontable" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%"  >
                                                                                            <thead>
																								...
																								<th width="15%">Regimen</th>
																								<th width="10%">Unidad</th>
 																								<th width="15%">Motivo</th>
																								<th width="10%">A Recibir</th>
                              ...
                              <div class="panel panel-default">
                                  <div class="panel-body" > 
									      ...
									      <div class="panel panel-success">
											  <div class="panel-heading">HISTORIAL FINANCIERO</div>
											  <div class="panel-body">
												  
												     <div class="col-md-12" style="padding: 5px">
														  <button type="button" class="btn btn-sm btn-primary" onClick="BuscaDatos()" id="load1">  <i class="icon-white icon-search"></i> Busqueda de datos</button>	
														  </div>
