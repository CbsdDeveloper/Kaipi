...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/nom_roles.js"></script> 
	       ...
	       <ul id="mytabs" class="nav nav-tabs">          
                    	...
                    	<li><a href="#tab2" data-toggle="tab">
	 					...
	 					<li><a href="#tab3" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> DETALLE RESUMEN DEL ROL</a>
                  		</li> 
											  ...
											  <div class="panel-body">
												   ...
												   <div class="col-md-9"  style="padding-top: 5px;">
													   ...
													   <button type="button" onClick="ResumenRolFinal()" class="btn btn-sm btn-default" id="lax">
														<i class="icon-white icon-ok-sign"></i> Generar por Programa</button>
													 
													 
													   <button type="button" onClick="ResumenRolDetalle()" class="btn btn-sm btn-success" >
														<i class="icon-white icon-ok-sign"></i> Generar Detalle</button>
