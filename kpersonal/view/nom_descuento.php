...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/nom_descuento.js"></script> 
 ...
 <div class="col-md-12"> 
	       ...
	       <ul id="mytabs" class="nav nav-tabs">          
                   		...
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> CONTROL DE DESCUENTO</a>
                   		</li>
                    		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Detalle por Descuento</a>
                  		</li> 
           </ul>
 									  	...
 									  	<div class="row">
											  ...
											  <div class="col-md-12"  style="padding-top: 5px;">
											    ...
											    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px; padding-left: 25px"> 
													  ...
													  <button type="button" class="btn btn-sm btn-danger" onClick="TraeNovedades()" data-toggle="modal" data-target="#myModalNovedad" >
														<i class="icon-white icon-asterisk"></i> Novedades</button>
													   ...
													   <button type="button" class="btn btn-sm btn-default" id="loadC"> Generar por Programa</button>
							  ...
							  <div id="ViewSave"> </div>
							   ...
							   <div class="col-md-12" style="padding-top: 15px;padding-top: 15px"> 
								  ...
								  <button type="button" onclick="window.open('nom_descuento', '_self')" class="btn btn-warning btn-sm">Descuentos</button>
								   ...
								   <button type="button" onclick="window.open('nom_manual', '_self')" class="btn btn-default btn-sm">Registro Manual</button>
 									  	...
 									  	<div class="row">
											  ...
											  <div class="col-md-12"  style="padding-top: 5px;">
											    ...
											    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px; padding-left: 25px"> 
													  ...
													  <button type="button" class="btn btn-sm btn-danger" onClick="VerAnticipo()" id="loadBuscarAnticipo" data-toggle="modal" data-target="#myModalAnticipo">
														<i class="icon-white icon-ambulance"></i> Ver Anticipos</button>
	 ...
	 <div class="container"> 
	  <div class="modal fade" id="myModalNovedad" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			<h5 class="modal-title"> <b>NOVEDADES DEL ROL </b></h5>
		  </div>
				  <div class="modal-body">
 			          <div class="panel panel-default">
  				         <div class="panel-body">
							   <div class="row">
								 <div id="ViewFormRolNovedad">  </div> 
 							   </div>	   
					     </div>
   					 </div>
				  </div>
	  ...
	  <div class="modal fade" id="myModalAnticipo" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			<h5 class="modal-title"> <b>ANTICIPOS POR DEVENGAR </b></h5>
		  </div>
				  <div class="modal-body">
 			          <div class="panel panel-default">
  				         <div class="panel-body">
							   ...
							   <div class="row">
								 ...
								 <div style="width:100%; height:350px;" id="ViewFormAnticipo">  </div> 
 				  ...
 				  <div class="modal-footer">
					  ...
					  <button type="button" class="btn btn-sm btn-primary"  onClick="EnlaceNomina()">Generar Anticipos</button>
