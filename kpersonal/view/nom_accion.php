...
<head>
 ...
 <script type="text/javascript" src="../js/nom_accion.js"></script> 
 		 	 ...
 		 	 <div class="col-md-12">
                    ...
                    <ul id="mytabs" class="nav nav-tabs">                    
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> Reporte de Acciones de Personal</a>
                   		</li>
                                  ...
                                  <div class="panel-body" > 
                                      <div class="col-md-12" style="padding: 1px">
                                                           ...
                                                           <div class="col-md-12">
                                                               ...
                                                               <table id="jsontable" style="font-size: 11px" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%"  >
                                                                                            <thead>
                                                                                                <tr>
                                                                                                <th width="5%">Id</th>
                                                                                                <th width="5%">Fecha</th>
