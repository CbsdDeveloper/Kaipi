...
<!-- ------------------------------------------------------ -->
 ...
 <div id="main">
  ...
  <!-- ------------------------------------------------------ -->  
		...
		<div class="col-md-12"> 
			<h3>GESTION INTEGRAL INSTITUCIONAL</h3>
	   </div>	
	     ...
	     <div class="col-md-12"> 
			     <div class="col-md-4">
						     <div class="panel panel-success">
							     <div class="panel-heading">GRUPO PRESUPUESTARIO PERSONAL</div>
			  ...
			  <div class="col-md-4">
						     <div class="panel panel-info">
							     <div class="panel-heading">PROGRAMA PRESUPUESTARIO PERSONAL</div>
								  <div class="panel-body">
			  ...
			  <div class="col-md-4">
						     <div class="panel panel-info">
							     <div class="panel-heading">REMUNERACIONES Y SALARIOS</div>
								  <div class="panel-body">
