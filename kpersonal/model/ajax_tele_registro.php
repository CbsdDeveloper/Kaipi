...
if ( $accion == 'visor') {
        ...
        $sql = "SELECT  id_teleasigna || ' ' as  id, fecha, motivo, referencia || ' ' as referencia,estado,sesion
                            FROM nom_tele_asigna
            ...
            $obj->table->table_basic_js($resultado, // resultado de la consulta
                ...
                "Referencia, Inicio,Motivo,Referencia,Activo,Sesion",  // nombre de cabecera de grill basica,
