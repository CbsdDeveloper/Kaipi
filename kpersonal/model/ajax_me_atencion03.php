...
$sql = "select  id_atencion_fami,fa_parentesto, fa_detalle
            from medico.ate_medica_familia
            where id_atencion = ".$bd->sqlvalue_inyeccion($id_atencion, true).
            " order by id_atencion_fami desc";
...
$evento   = "goToURL_familia-0";  // nombre funcion javascript-columna de codigo primario
$edita    = 'editar';
$del      = 'del';
...
$cabecera =  "Codigo,Tipo Parentesco,Antecedente"; // CABECERA DE TABLAR GRILLA HA VISUALIZAR
