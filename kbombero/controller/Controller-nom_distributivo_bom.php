     ...
     function Formulario( ){
        ...
        order by 2 asc";
                ...
                $this->set->div_panel6('<h6> PASO 1.- INFORMACION PRINCIPAL<h6>');
                                 ...
                                 $this->obj->text->text_blue('Documento',"texto",'doccumento',50,50,$datos,'required','','div-2-4') ; 
      
                                 $this->obj->text->editor('Comentario','detalle',4,350,350,$datos,'required','','div-2-10') ;
                ...
                $this->set->div_panel6('<h6> PASO 3.- LISTA DE ESTACIONES ASIGANADAS<h6>');

                        echo '<div id="listafun"> </div>';

                $this->set->div_panel6('fin');

                $this->set->div_panel6('<h6> PASO 4.- LISTA DE PERSONAL X ESTACION<h6>');
