...
<head>
	...
	<!--  FUNCIONES DEL FORMULARIO JAVASCRIPT ---------------------------------->
 	...
 	<script type="text/javascript" src="../js/bom_novedad_bom.js"></script> 
			   		...
			   		<!-- FORMULARIO DE BUSQUEDAS PRINCIPAL -->
                 		...
                 		<li class="active">
							<a href="#tab1" data-toggle="tab"> 
								<span class="glyphicon glyphicon-th-list"></span> <b>LIBRO DE NOVEDADES/BITACORA</b>  
			   				</a>
						</li>
			   		 ...
			   		 <!-- FORMULARIO DE INFORMACION DE DATOS -->
                  		...
                  		<li>
							<a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> HISTORIAL LIBRO DE NOVEDADES
							</a>
                  		</li>
