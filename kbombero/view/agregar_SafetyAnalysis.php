...
<head>
    <meta charset="UTF-8">
    <title>Agregar Análisis de Seguridad</title>
...
<body class="colorB">
    ...
    <div class="content">
        <div class="cuadro">
            <h6 class="card-header">Registro: Análisis de Seguridad</h6><br>
            <form id="agregarAnalisisForm">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" class="form-control" id="riesgo" name="riesgo" required>
                    </div>
                    <div class="col-xl-12 col-md-12 col-sm-12">
                        <label for="accion_mitigante" class="form-label">Acción Mitigante:</label>

                        <textarea class="form-control" id="accion_mitigante" name="accion_mitigante" rows="3" required></textarea>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
    ...
    <script>
        $(document).ready(function() {
            $('#agregarAnalisisForm').submit(function(e) {
                e.preventDefault();
