...
<head>
    <meta charset="UTF-8">
    <title>Agregar Plan de Comunicación</title>
...
<body class="colorB">
    ...
    <div class="content">
        <div class="cuadro">
            <h6 class="card-header">Registro: Plan de Comunicación</h6><br>
            <form id="agregarPlanForm">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" class="form-control" id="canal_frecuencia" name="canal_frecuencia" required>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#agregarPlanForm').submit(function(e) {
                e.preventDefault();
