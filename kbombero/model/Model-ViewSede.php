...
class proceso{
    ...
    function consultaId( ){
        ...
        while ($y=$this->bd->obtener_fila($resultado)){
            ...
            $detalle = trim($y['tipo_de_emergencia']);
           ...
           $cadena =  '<a href="#" data-toggle="modal" data-target="#myModal" onClick="ListaEmergencias('."'".$detalle ."'".')">'.$detalle.'</a>';
            
             echo '<tr>
		    	<td style="text-align: left;padding: 5px"   >'.$cadena.'</td>
    ...
    function cabecera( ){
        ...
        <tr>
        <th  style="text-align: center;padding: 5px"   bgcolor="lightblue" width="70%">Tipo de Emergencias</th>
