...
$tipo 		     = $bd->retorna_tipo(); // TIPO DE CONEXION DE BASE DE DATOS ... POSTGRES
    ...
    $sql = "select  id_bom_bita,funcionario, denominacion, actividad ,fecha_creacion, tiempo 
...
$evento   = "goToURL_bomberos_bitacora-0";  // nombre funcion javascript-columna de codigo primario
$edita    = 'editar';
$del      = 'del';
...
$cabecera =  "Codigo,Funcionario,Denominacion,Novedad,Creado,Hora"; // CABECERA DE TABLAR GRILLA HA VISUALIZAR
