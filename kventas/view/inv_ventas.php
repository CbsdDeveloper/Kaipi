                      ...
                      <div class="panel panel-default">
						  <div class="panel-body" > 
							...
							<div class="btn-group btn-group-sm">
								...
								<button type="button" onClick="goToURL(10)"  class="btn btn-success">Caja x Categoria</button>
								
								<button type="button" onClick="goToURL(9)"  class="btn btn-default">Resumen Diario</button>
							  ...
							  <h4>&nbsp;  </h4>
							    <div id="ViewComprobante" style="padding-top: 5px"><H5><b>COMPROBANTE: Factura </b></H5></div>
