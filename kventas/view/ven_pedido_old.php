    ...
    <div class="col-md-12" style="padding-top: 55px"> 
        ...
        <div class="col-md-3">
            ...
            <ul class="nav nav-pills nav-stacked">
				...
				<li><a href="#" onClick="javascript:BusquedaGrilla('','10');">En cotizacion</a></li>
				<li><a href="#" onClick="javascript:BusquedaGrilla('','11');"><b>En negociacion y condiciones</b></a></li>
                <li><a href="#" onClick="javascript:BusquedaGrilla('','12');">Notificacion y aceptacion</a></li>
				  ...
				  <div class="col-md-12"> 
				        ...
				        <div class="col-md-8"> 
							   ...
							   <form action="../model/EnvioEmail.php" method="post" enctype="application/x-www-form-urlencoded" id="form_email" accept-charset="UTF-8">
									 ...
									 <div class="col-md-10">  
												 <div class="form-group">
													  <input name="temail" type="email"  class="form-control" id="temail" placeholder="Email">
												   </div>
													<div class="form-group">
