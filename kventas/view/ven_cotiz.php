...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/ven_cotiz.js"></script> 
    ...
    <div class="col-md-12"> 
			 ...
			 <div class="col-sm-3 col-md-2">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<li><a  href="cliente.php" rel="pop-up">Crear Cliente</a></li>
								
					 
								<li><a  href="ven_cliente_post.php" rel="pop-up">Buscar Cliente</a></li>
			 ...
			 <div class="col-md-9">
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="#" onClick="javascript:BusquedaGrilla('No aplica','',0);">No aplica</a></li>
					 </ul>
				...
				<span style="color: #d9534f;padding:9px;font-weight:bold" id="nombre_actual">
		...
		<div class="row">
                 <div class="col-md-3">
                    ...
                    <a href="#" id="b1" class="btn btn-danger btn-sm btn-block" onClick="goToURL();"  role="button" data-toggle="modal" data-target="#myModal">
                        <i class="glyphicon glyphicon-edit"></i> Tarea 
                    </a>
                    <hr>
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active">
                            <a href="#" onClick="javascript:BusquedaGrilla('','1','1. Proceso de Negociacion',1);">
                                <b>1. Proceso de Negociacion </b>
                            </a>
                        </li>

                        <li>
                            <a href="#" onClick="javascript:BusquedaGrilla('','2','2. Condiciones Comerciales',1);">2. Condiciones Comerciales
                            </a>
                        </li>

                         <li>
                             <a href="#" onClick="javascript:BusquedaGrilla('','3','3. (*) Emitir Facturar Servicios/Bienes',1);">3. (*) Emitir Facturar Servicios/Bienes
                             </a>
                        </li>

                        <li>
                            <a href="#" onClick="javascript:BusquedaGrilla('','4','4. Tramites Finalizados',1);">4. Tramites Finalizados
                            </a>
                        </li>
                   ...
                   <h5 id="etiqueta_estado">[ Seleccione estado tramite ] </h5>	
                    ...
                    <ul class="nav nav-tabs" id="mytabs">
                       ...
                       <li><a href="#fproductos" data-toggle="tab"><span class="glyphicon glyphicon-apple">
                        ...
                        </span>  Orden Servicio/Trabajo</a></li>
                                        ...
                                        <div class="col-md-10">  
                                             <div class="col-md-2">  
                                                      <div class="form-group">
                                                           <button type="button"   onClick="NuevaOrden(1)" title="Generar Orden de Trabajo/Servicios" class="btn btn-info btn-sm" id="bnuevo" >  
                                                                <span class="glyphicon glyphicon-refresh"></span>  
                                                         </button>
                                                      </div>         
                                               </div>      
                                               <div class="col-md-3">  
                                                   <div class="form-group">  
                                                        ...
                                                        <button type="button"   onClick="LimpiaOrden()" title="Limpiar Informacion"       class="btn btn-default btn-sm" id="blimpia" >  
                                                                    <span class="glyphicon glyphicon-erase"></span>  
                                                            </button>
                                                       
                                                       
                                                            <button type="button"   onClick="GuardarOrden()" title="Guardar Informacion" class="btn btn-warning btn-sm" id="bnuevo" >  
                                                                    <span class="glyphicon glyphicon-saved"></span>  
                                                            </button>

                                                           <button type="button"   onClick="ImprimirOrden()"  title="Imprimir Orden Compra/Servicio" class="btn btn-info btn-sm" id="bprunter" >  
                                                               <span class="glyphicon glyphicon-print"></span>  
                                                           </button>
                                                            
                                                            <button type="button"   onClick="ImprimirActa()"  title="Orden de Entrega" class="btn btn-danger btn-sm" id="bprunter" >  
                                                           <span class="glyphicon glyphicon-print"></span>  
                                                       </button>
                                                    </div>	   
                                               </div>	     
                                             <div class="col-md-7" align="right">  
                                                 <div class="form-group">
                                                      ...
                                                      <button type="button" id="b2" onClick="ClienteFactura()" class="btn btn-warning btn-sm">Emitir Prefactura Venta</button> 

                                                     <button type="button" id="b3" onClick="CerrarFactura()" class="btn btn-danger btn-sm">Cerrar Proceso de Venta</button>
                                                </div>	
                                            </div>	 
                                        </div>

                                        <div id="mensaje_proceso"></div>
                                        <div class="col-md-12"> 
                                                ...
                                                <div class="col-md-12" style="padding: 5px;z-index: 800">
                                                    ...
                                                    <select name="editor5"  id="editor5"  class="form-control" >
                                                      ...
                                                      <option value="acumula">Acumula para Facturacion</option>
                                                      <option value="ingreso">Comprobante Ingreso</option>
                                                    </select>
                                                </div> 
                                                <h5><b>Orden de Trabajo/Servicios</b></h5>
                                          ...
                                          <div class="col-md-9" style="padding: 15px"> 
                                           <b> Referencia/Novedad </b>
                                          <input type="text" class="form-control" name="novedad_c"   id="novedad_c"  >
                                          </div>
