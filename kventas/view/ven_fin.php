...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/ven_fin.js"></script> 
...
<div id="main">
  ...
  <!-- ------------------------------------------------------ -->  
    <div class="col-md-12"> 
        ...
        <div class="col-md-3">
            <a href="#"  id="BtActividad" class="btn btn-danger btn-sm btn-block" onClick="goToURL();"  role="button" data-toggle="modal" data-target="#myModal">
            ...
            <ul class="nav nav-pills nav-stacked">
				...
				<li class="active">
					<a href="#" onClick="javascript:BusquedaGrilla('','10','Cierre de negocio');">
					<b>Cierre de negocio </b>
					</a>
				</li>
				
				<li>
					<a href="#" onClick="javascript:BusquedaGrilla('','11','Emitir Prefactura');">Emitir Prefactura
					</a>
				</li>
				
				 <li>
					 <a href="#" onClick="javascript:BusquedaGrilla('','12','(*) Cerrar proceso');">(*) Cerrar proceso
					 </a>
				</li>
 
                <li>
					<a href="#" onClick="javascript:BusquedaGrilla('','9','Anular proceso');">Anular proceso
					</a>
				</li>
        ...
        <div class="tab-content">
			...
			<div class="tab-pane fade in" id="fproductos">
 				<div class="panel panel-default">
						<div class="panel-body" > 
							<div class="col-md-10">  
								    <h5>Actualizar Informacion Cliente</h5>
								    <button type="button" onClick="ClienteCIU()" class="btn btn-success ">Actualizar Datos del Cliente</button>
								     <div id="mensaje_ciu"></div>
							 </div>
							<div class="col-md-10"> 
									<h5>Generar Prefactura</h5>
								    <button type="button" onClick="ClienteFactura()" class="btn btn-warning">Emitir Prefactura Venta</button>
								    <div id="mensaje_factura"></div>
							 </div>	
							<div class="col-md-10"> 	
									<h5>Cerrar Proceso</h5>
								<button type="button" onClick="CerrarFactura()" class="btn btn-danger">Cerrar Proceso de Venta</button>
					...
					<div class="panel-body" > 
				      ...
				      <div class="col-md-10">  
							 ...
							 <div class="col-md-12" style="border: 1px solid #000000;"> 
					   		   ...
					   		   <h5><b>Proforma - Cotizacion</b></h5>
						       <div class="col-md-12" style="padding: 5px;z-index: 800">
									 <div id="editor2" name="editor2"> </div>
							   </div> 
							  ...
							  <h5><b>Condiciones Comerciales</b></h5>
							   ...
							   <div class="col-md-12" style="padding: 7px;z-index: 800">
									  <div id="editor3" name="editor3"> </div>
							   </div> 
