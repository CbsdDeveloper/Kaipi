...
<script  type="text/javascript" language="javascript" src="../js/co_xpagar_nomina.js?n=1"></script>
     ...
     <div class="col-md-12"> 
				...
				<ul id="mytabs" class="nav nav-tabs">  
										...
										<li class="active"><a href="#tab1" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b>TRAMITES PENDIENTES POR PAGAR NOMINA</b></a>
										</li>
										...
										<li><a href="#tab3" data-toggle="tab">
											<span class="glyphicon glyphicon-duplicate"></span> Generar Comprobante de Pago</a>
										</li>
									  ...
									  <div class="panel panel-default">
										   ...
										   <div class="panel-body" > 
											   ...
											   <div class="col-md-12">
											    ...
											    <div class="col-md-12">
											  	<a href="#"  onClick="VerBeneficiarios()"  data-toggle="modal" data-target="#myModalprov"><img src="../../kimages/03_.png" align="absmiddle" /></a>  <b>Ver Auxiliares</b>
											    </div>
					...
					<div class="tab-pane fade in" id="tab3"  style="padding-top: 3px">
									  ...
									  <div class="panel panel-default">
										   ...
										   <div class="panel-body" > 
											...
											<h5> Generar comprobante de pago - asiento pagado </h5>
											   
										    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px">												   
												       <div class="col-md-3">
															<select  onChange=" BusquedaGrillapago(this.value)" class="form-control" id="tipo_prov" name="tipo_prov">
															  <option value="-">Seleccionar tipo de beneficiario</option>	
															  <option value="N">Personal de Nomina</option>
															  <option value="P">Proveedores - Beneficiario externos</option>
															</select>
														</div>  
											     ...
											     <div class="col-md-7" style="padding-top: 10px;padding-bottom: 10px">		
													  <div id="view_pago">   </div>  
												 </div>  
											   
											    <div class="col-md-5" style="padding-top: 10px;padding-bottom: 10px">		
													  <div id="view_pago_detalle">   </div>  
												 </div>  
										 
											    <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px">			
												  
													  <button type="button" id="bguardaPago" class="btn btn-danger btn-sm">Generar pago</button>
													
												 </div>	
											   
											    <div id="informacion_pago">   </div>  
