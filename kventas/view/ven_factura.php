...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/ven_factura.js"></script> 
		  ...
		  <!-- Content Here -->
                   ...
                   <ul id="mytabs" class="nav nav-tabs">          
                                ...
                                <li class="active"><a href="#tab2" data-toggle="tab">
                                    <span class="glyphicon glyphicon-link"></span> Emisión De Servicios</a>
                                </li>

                                <li ><a href="#tab1" data-toggle="tab"></span>
                                <span class="glyphicon glyphicon-th-list"></span> <b>Detalle de Servicios Diario</b>  </a>
                                </li>
																...
																<table id="jsontable" class="display table-condensed" cellspacing="0" width="100%">
																				 <thead  bgcolor=#F5F5F5>
																					   <tr>   
																							 ...
																							 <th width="34%">Nombre Beneficiario (Cliente)  </th>
																							 <th width="8%">Base 12%</th>
																							 <th width="5%">IVA</th>
    ...
    <div class="modal fade" id="myModalvar" role="dialog">
	    ...
	    <div class="modal fade" id="myModalProv" role="dialog">
                            ...
                            <div class="modal-body">
								     ...
								     <div id='DetProveedores'></div>
								
                                    <div id='VisorProveedores'></div>
