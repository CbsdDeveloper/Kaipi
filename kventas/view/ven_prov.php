    ...
    <div class="col-md-12"> 
		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2">
			 ...
			 <div class="col-md-9">
				...
				<span style="background-color:#337ab7;color: #FFFFFF;padding:8px;"  id="nombre_actual"><b> &nbsp; [ Seleccionar cliente ] </b></span>
        ...
        <div class="col-md-3">
            ...
            <ul class="nav nav-pills nav-stacked">
				...
				<li><a href="#" onClick="javascript:BusquedaGrilla('','1');"><b>Proceso de Negociacion </b></a></li>
                <li><a href="#" onClick="javascript:BusquedaGrilla('','2');">Condiciones Comerciales</a></li>
				
				 <li><a href="#" onClick="javascript:BusquedaGrilla('','3');">(*) Orden de trabajo/Servicio</a></li>
				
				<li><a href="#" onClick="javascript:BusquedaGrilla('','4');">(*) Cierre de tramite</a></li>
				
                <li><a href="#" onClick="javascript:BusquedaGrilla('','0');">Anular proceso</a></li>
                </li>
             </ul>
        </div>
							    ...
							    <div class="col-md-10"> 
					   		       <h5><b>Condiciones Comerciales</b></h5>
						       			<div class="col-md-12" style="padding: 5px;z-index: 800">
											<input type="text" class="form-control" name="editor5"  id="editor5"  >
