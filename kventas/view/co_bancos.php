	  ...
	  <div class="modal fade" id="myModalDeposito" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
			          ...
			          <div class="panel panel-default">
  				         <div class="panel-body">
							 	 ...
							 	 <div class="col-md-12" align="right" >
									   ...
									   <button type="button" onClick="SumarMarcados()" class="btn btn-sm btn-warning"> Suma Selecionados </button>
									 
									 <button type="button" onClick="MarcarSeleccion(1)" class="btn btn-sm btn-success">Marcar Selección</button>
									 
									 <button type="button" onClick="MarcarSeleccion(0)" class="btn btn-sm btn-danger">DesMarcar Selección</button>
									 
									 
									  <button type="button" onClick="SumarSeleccion()" class="btn btn-sm btn-info"> Selección (+) </button>
							  ...
							  <div class="col-md-12" align="right" style="padding: 10px">
 					  				 ...
 					  				 <div id="Marcado"> Total Seleccion</div> 
							 	
								 </div>
							 
							 	 <div class="col-md-12" align="right" style="padding: 10px">
									 
 					  				 <div id="Sumadebe"> Total Parcial</div> 
		  ...
		  <div class="modal-footer">
			  ...
			  <button type="button" onClick="myFunctionDeposito_genera()" class="btn btn-sm btn-primary" data-dismiss="modal">Generar informacion</button>
