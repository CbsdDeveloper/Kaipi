    ...
    <div class="col-md-12"> 
        ...
        <div class="col-md-3">
            ...
            <ul class="nav nav-pills nav-stacked">
 				<li class="active"><a href="#" onClick="javascript:BusquedaGrilla('','3','Muestra interes');"><b>Muestra interes</b></a></li>
                <li><a href="#" onClick="javascript:BusquedaGrilla('','4','Seguimiento en proceso');">Seguimiento en proceso</a></li>
                <li><a href="#" onClick="javascript:BusquedaGrilla('','5','Oferta - Cotizacion generada');">Oferta - Cotizacion generada</a></li>
                <li><a href="#" onClick="javascript:BusquedaGrilla('','9','Anular proceso');">Anular proceso</a></li>
                </li>
             </ul>
        </div>
      ...
      <div class="col-md-9">
            ...
            <ul class="nav nav-tabs" id="mytabs">
				...
				</span> Catalogo Productos/Servicios</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-body" > 
				      ...
				      <div class="col-md-10">  
						    ...
						    <input name="id_cotizacion" type="hidden" id="id_cotizacion" value="0">
					</div>
              </div>
 		 </div>
	<!-- ---------------------------------------------------------------------------------------  -->		
