...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/inv_cierre_sc.js"></script> 
                                                  ...
                                                  <div class="row">
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-primary" id="load">
                                                                 ...
                                                                 <button type="button" class="btn btn-sm btn-info" id="loadFac">
                                                                        <i class="icon-white icon-apple"></i> 1. Generar Comprobantes</button>
                                                                    
                                                                <button type="button" class="btn btn-sm btn-success" id="loadFaca">
                                                                        
                                                                    <i class="icon-white icon-archive"></i> 2.  Autorizar Comprobantes</button>    
                                        ...
                                        <div class="col-md-12"> 
											 ...
											 <div class="col-md-6" style="padding: 10px">
                                              ...
                                              <div class="col-md-6" style="padding: 10px">
												      ...
												      <button type="button" class="btn btn-sm btn-default" id="loadNotaImprime">
                                                                    <i class="icon-white icon-search"></i> Reportes</button>
