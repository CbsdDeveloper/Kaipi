    ...
    <div class="col-md-12" style="padding-top: 55px"> 
        ...
        <div class="col-md-3">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"> Detalle de opciones</a>
                </li>
				<li><a href="#" onClick="javascript:BusquedaGrilla('','8');"><b>Crear Noticia</b></a></li>
                <li><a href="#" onClick="javascript:BusquedaGrilla('','9');">Crear Eventos</a></li>
				<li><a href="#" onClick="javascript:BusquedaGrilla('','9');">Crear Promocioness</a></li>
 			    <li><a href="#" onClick="javascript:BusquedaGrilla('','0');">Notificaciones Cliente</a></li>
               </li>
             </ul>
        </div>
