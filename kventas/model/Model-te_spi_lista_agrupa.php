...
SELECT sum(monto_pagar), count(*),idprov, min(id_spi_det) as id_spi_det
        FROM tesoreria.view_spi_detalle
        where id_spi = 66
				group by idprov
				
				update tesoreria.spi_mov_det  set monto_pagar= 3966.42 where id_spi_det = 909;
				
				delete from tesoreria.spi_mov_det where id_spi_det  <> 909 and id_spi = 66;
