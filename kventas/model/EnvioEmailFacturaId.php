...
$sql = "SELECT id_movimiento,  comprobante,  idprov,   autorizacion,fecha
            ...
            where
                    ...
                    id_movimiento  = ".$bd->sqlvalue_inyeccion( $id ,true)." and
                    autorizacion is not null  and
                    transaccion   in ('E','X') and
...
while ($fila=$bd->obtener_fila($stmt)){
    ...
    $pathimagen = 'http://federacionsdt.org/gestor/facturae/firmas/'.$imagen;
   ...
   // $enlace = 'https://g-kaipi.cloud/kaipi/facturae/ride/RideComprobante?xml='.$xml.'&file='.$pa;
    ...
    $enlace = 'http://federacionsdt.org/gestor/facturae/ride/RideComprobante?xml='.$xml.'&file='.$pa;
    ...
    $url = 'http://federacionsdt.org/gestor/facturae/facturae/xml/'.$xml.'_A'.'.xml';
