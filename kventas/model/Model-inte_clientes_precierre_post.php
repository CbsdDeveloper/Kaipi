    ...
    function consultaId( $id,$idvengestion ){
        ...
        if ( $estado  == '3'){
            ...
            if ( $idmovimiento == 0  ){
                ...
                $dato = '<b>Debe generar prefactura '.$identificacion.' !!! </b>';
                
            }else{
                
                $sqlEdit = "update ven_cliente_gestion
                               set estado  =".$this->bd->sqlvalue_inyeccion( 4,true).",
                                    porcentaje  =".$this->bd->sqlvalue_inyeccion( 100,true).", 
                                   fecha_fin   =".$this->bd->hoy()."
                ...
                //-----------------------------------------------
                $dato = '<b>Proceso de Cierre generado '.$identificacion.' Nro Transaccion: '.$id_movimiento.'  </b>';
