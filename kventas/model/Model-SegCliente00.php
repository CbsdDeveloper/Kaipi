...
$sql1 = 'SELECT fecha, sesion,estado,razon,idprov,novedad,idvengestion
                  FROM  ven_cliente_seg
                  where estado ='.$bd->sqlvalue_inyeccion( $estado, true).
                  ...
                  while ($fila=$bd->obtener_fila($stmt1)){
                      ...
                      $idvengestion = $fila['idvengestion'];
                      
                      $eventoHistorial =  ' onClick="javascript:'.'VerHistorial('."'".$id."',".$nombre.','.$idvengestion.')" ';
                      ...
                      $BandejaDatos = ' <a href="#" class="list-group-item">
                            ...
                            <span class="text-muted" '.$eventoHistorial.' style="font-size: 12px;"> - '.substr($fila['novedad'],0,90).'... </span>
