	...
	function CrearPago(  $id_asiento,$id_tramite, $fecha_pago, $detalle_pago,$idbancos,$tipo_pago ,$cheque,$comprobante,$tipo_prov){
	    ...
	    if ( $bandera == 0 ){
        	    ...
        	    $id_asiento_banco = $this->saldos->_asiento_contable($fecha,$detalle,'B',
        	        ...
        	        $this->_detalle_pago_bancos($idbancos,$id_asiento_banco,$id_tramite,$tipo_prov,$fecha,$detalle,trim($cheque),trim($comprobante_pago),$tipo_pago);
        	        
        	        $this->_detalle_cxpagar($id_tramite,$fecha,$id_asiento_banco,$detalle,$id_asiento,$tipo_prov,trim($comprobante_pago),$tipo_pago);
