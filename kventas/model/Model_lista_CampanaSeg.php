 <?php 
    ...
    $sql = "SELECT estado,   count(*) as nn
     ...
     $ContactosCampana .=  utf8_encode( ' <h6><b> Resumen por estados de Campa�a </b></h6><ul class="list-group">');
   ...
   $ContactosCampana .=  utf8_encode( ' <h6><b> Resumen por Ciudades de Campa�a </b></h6><ul class="list-group">');
