 <?php 
	...
	<p>Contactos definidos en la campa�a</p>
	</div>
	</div>
	<hr>');
	...
	<div class="panel-heading">'.utf8_encode( 'Resumen por estados de Campa�a').'</div>
    ...
    $sql = "SELECT estado,   count(*) as nn
     ...
     $ContactosCampana .=  utf8_encode( '<ul class="list-group">');
   ...
   $ContactosCampana .=  utf8_encode( ' <h6><b> Resumen por usuarios de Campa�a </b></h6><ul class="list-group">');
   ...
   $ContactosCampana .=  ( ' </ul></div> </div> </div>' );
	
    
   
   $ContactosCampana .= '<div class="col-md-6"> <div class="panel panel-default">
	<div class="panel-heading">'.utf8_encode( 'Resumen por Ciudades de Campa�a').'</div>
	<div class="panel-body">';
