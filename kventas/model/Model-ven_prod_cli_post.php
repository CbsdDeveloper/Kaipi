...
class proceso{
    ...
    function proceso( ){
        ...
        $this->ATabla = array(
            ...
            array( campo => 'idproducto',   tipo => 'NUMBER',   id => '2',  add => 'S',     edit => 'N', valor => '-',    key => 'N'),
            array( campo => 'producto',     tipo => 'VARCHAR2', id => '3',  add => 'S',     edit => 'N', valor => '-',    key => 'N'),
            array( campo => 'estado',       tipo => 'NUMBER',   id => '4',  add => 'S',     edit => 'N', valor => '1',    key => 'N'),
        ...
        if (!empty($producto)){
            ...
            if ( $idproducto  > 0 ){
                ...
                $Aprod = $this->bd->query_array('ven_cliente_prod',
                    'count(*) as numero',
                    'idvengestion='.$this->bd->sqlvalue_inyeccion($id,true).' and
