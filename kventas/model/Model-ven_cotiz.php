...
class proceso{
    ...
    function proceso( ){
        ...
        $this->ATabla = array(
            ...
            array( campo => 'vendedor',tipo => 'VARCHAR2',id => '12',add => 'S', edit => 'S', valor => '-', key => 'N') 
        );
        ...
        $this->ATablaTarea  = array(
            ...
            array( campo => 'mensaje',tipo => 'VARCHAR2',id => '8',add => 'S', edit => 'S', valor => '-', key => 'N')
        );
    ...
    function agregar( ){
        ...
        $this->ATablaTarea[8][valor] =  trim($razon)	 ;
