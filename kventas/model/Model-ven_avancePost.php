...
class proceso{
    ...
    function ProcesoNombre($id,$idvengestion,$accion){
        ...
        $flujo = $this->bd->query_array('ven_cliente_gestion',
            'porcentaje,sesion,estado',
            'idven_gestion='.$this->bd->sqlvalue_inyeccion($idvengestion,true)
            );
        ...
        if ( $accion == 1) {
            ...
            if ( $flujo['estado'] == 4 ){
                ...
                $sql = "SELECT  fecha_fin - fecha::date as dias
                        FROM  ven_cliente_gestion where
                             idven_gestion=   ".$this->bd->sqlvalue_inyeccion($idvengestion,true);
...
if (isset($_GET['idcliente']))	{
    ...
    $id                 = $_GET['idcliente'];
    $idvengestion       = $_GET['idven_gestion'];
    $accion      = $_GET['accion'];
