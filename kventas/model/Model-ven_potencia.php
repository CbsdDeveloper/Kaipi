...
class proceso{
    ...
    function proceso( ){
        ...
        $this->ATabla = array(  
            ...
            array( campo => 'web',tipo => 'VARCHAR2',id => '5',add => 'S', edit => 'S', valor => '-', key => 'N'),
            ...
            array( campo => 'canton',tipo => 'VARCHAR2',id => '10',add => 'S', edit => 'S', valor => '-', key => 'N'),
            array( campo => 'id_campana',tipo => 'VARCHAR2',id => '11',add => 'S', edit => 'S', valor => '-', key => 'N'),
            array( campo => 'medio',tipo => 'VARCHAR2',id => '12',add => 'S', edit => 'S', valor => '-', key => 'N'),
            array( campo => 'fecha',tipo => 'DATE',id => '12',add => 'S', edit => 'S', valor => $this->hoy, key => 'N'),
             array( campo => 'sesion',tipo => 'VARCHAR2',id => '13',add => 'S', edit => 'S', valor => $this->sesion, key => 'N'),
            array( campo => 'registro',tipo => 'VARCHAR2',id => '14',add => 'S', edit => 'S', valor => $this->ruc, key => 'N')
        );
    } 
    //-----------------------------------------------------------------------------------------------------------
    //Constructor de la clase
    ...
    function consultaId($accion,$id ){
        ...
        $datos = $this->bd->JqueryArrayVisor('ven_cliente',$qquery );
    ...
    function agregar(   ){
           ...
           $this->ATabla[2][valor] =  strtoupper(trim($canton))	 ;
        
             
        $id = $this->bd->_InsertSQL($this->tabla,$this->ATabla,'ven_cliente_idvencliente_seq');
        
        if ($longitud < 8 ){
            $idpo = $id.'-'.rand(11,99);
            
            $sql = 'update ven_cliente
                        set idprov='.$this->bd->sqlvalue_inyeccion($idpo,true).' 
                        where idvencliente = '.$this->bd->sqlvalue_inyeccion($id,true);
