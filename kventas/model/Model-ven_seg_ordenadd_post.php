...
class proceso{
    ...
    function proceso( ){
        ...
        $this->ATabla = array(
            ...
            array( campo => 'modulo',tipo => 'VARCHAR2',id => '2',add => 'S', edit => 'S', valor => 'orden', key => 'N'),
            ...
            array( campo => 'condicion_comercial',tipo => 'VARCHAR2',id => '7',add => 'S', edit => 'S', valor => '-', key => 'N'),
            ...
            array( campo => 'registro',tipo => 'VARCHAR2',id => '12',add => 'S', edit => 'S', valor => $this->ruc , key => 'N')
        );
    ...
    //---retorna el valor del campo para impresion de pantalla ?articulo=' + articulo + '&id='+id_asiento,
    //--------------------------------------------------------------------------------
    function agregar( $id_cotizacion,$modulo,$idcliente,$razon, $editor2, $editor3,$idvengestion,$novedad ){
        ...
        $this->novedad($idvengestion, $novedad ) ;
    ...
    //--------------------------------------------------------------------------------
    function edicion( $id_cotizacion,$modulo,$idcliente,$razon, $editor2, $editor3,$idvengestion ,$novedad ){
    ...
    //--------------------------------------------------------------------------------
    function novedad($id, $novedad ){
        
        $sql = "UPDATE ven_cliente_gestion 
                    set novedad = ". $this->bd->sqlvalue_inyeccion($novedad, true).
                    ' where idven_gestion='.$this->bd->sqlvalue_inyeccion($id, true);
        
        
        if (!empty(trim($novedad))) {
...
if (isset($_POST['accion']))	{
    ...
    $novedad_c    = $_POST['novedad_c'];
    
    
    if( $accion == 'add'){
        
        $gestion->agregar($id_cotizacion,$modulo,$idcliente,$razon, $editor2, $editor3,$idvengestion,$novedad_c);
        
    }else{
        
        $gestion->edicion( $id_cotizacion,$modulo,$idcliente,$razon, $editor2, $editor3,$idvengestion ,$novedad_c);
