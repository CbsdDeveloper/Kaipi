       ...
       <h4 class="modal-title">
        <?php 
              if (isset($_SESSION['ruc_registro'])){
                                          ...
                                          echo '<h5><b>Empresa seleccionada: '.$datos1['razon']. '  -  '.$_SESSION['ruc_registro'].'</b></h5>'; 
                                        }
                                        else{
                                         echo '<h6>No existe referencia...seleccione empresa para gestionar!!!</h6>';
                                       }
                                      ?>
                                    </h4>
                                </div>
                              ...
                              <div class="modal-body">
                                  ...
                                  if  ( trim($x['empresas']) == '0000000000000'){
                                   ...
                                   echo '<h5><b>Periodo Disponible</b></h5>';
