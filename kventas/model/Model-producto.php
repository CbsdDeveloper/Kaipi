 ...
 function consultaId($accion,$id ){
     ...
     function agregar(   ){
         ...
         $InsertQuery = array(   
                                    ...
                                    array( campo => 'cuenta_gas',   valor => @$_POST["codigob"]),
            ...
            //--------- precio 
            $InsertQuery = array(
                array( campo => 'id_producto',   valor => $idD  ),
                array( campo => 'monto',   valor => $precio),
                array( campo => 'activo',   valor => 'S'),
                array( campo => 'detalle',   valor => 'Principal'),
           ...
           $serie = @$_POST["controlserie"];
             ...
             $UpdateQuery = array( 
                        ...
                        array( campo => 'registro',   valor => $this->ruc ),
             		    ...
             		    array( campo => 'codigob',       valor => @$_POST["codigob"],  filtro => 'N')  ,
             		    array( campo => 'tipourl',       valor => '1',  filtro => 'N')  
               );
