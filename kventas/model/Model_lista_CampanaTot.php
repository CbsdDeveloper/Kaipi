 <?php 
	...
	$TotalCampana .=  utf8_encode( ' <h6><b> Resumen por Campa�as </b></h6><ul class="list-group">');
   ...
   $TotalCampana .=  utf8_encode( ' <h6><b> Resumen por tipos de Campa�a </b></h6><ul class="list-group">');
