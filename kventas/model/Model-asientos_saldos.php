...
class saldo_contable{
    ...
    function _aprobacion($id){
        ...
        $estadoa = $this->bd->query_array('co_asiento',
            'estado,fecha,id_periodo,tipo,anio,detalle,modulo,comprobante',
            'id_asiento='.$this->bd->sqlvalue_inyeccion($id,true)
            );
    ...
    //--------------------------------------------------------------------------
    function _Comprobante($modulo,$anio,$tipo_asiento='F'){
        ...
        if ( $anio >= 2021 ){
            ...
            $input  = $this->_Comprobante2020($modulo,$anio,$tipo_asiento='F');
    ...
    //------------------
    function _asiento_contable($fecha,$detalle,$tipo,$comprobante,$id_asiento,$modulo ,$documento,$idprov,$id_tramite='0'){
    ...
    function _detalle_contable($fecha,$idasiento_matriz,$cuenta,$debe,$haber,$partida){
        ...
        $sql = " INSERT INTO co_asientod( id_asiento, cuenta, aux,debe, haber,id_periodo,anio,mes,partida,sesion, creacion, registro)
                    				VALUES (".
