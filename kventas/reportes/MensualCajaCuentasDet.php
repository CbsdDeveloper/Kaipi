...
<table>
			    ...
			    <tr bgcolor=#ECECEC><td colspan="4" align="center" style="font-size: 10px">RESUMEN MENSUAL DE CAJA CHICA </td> </tr>
	...
	<p></p>
 <?php    
 	 $gestion->GrillaResumenMensualCajaDet($fanio,$fmes,$cuenta); 
 ?>
 <p></p>
 <p></p>
 <p></p>
