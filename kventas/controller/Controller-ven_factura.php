...
session_start( );   
        ...
        echo '<div class="col-md-8">
                   ...
                   <div class="col-md-12"> ';
                        ...
                        echo '<h6><img src="../../kimages/use.png" align="absmiddle" /> &nbsp;Usuario : '.$ACaja['completo'] .'</h6>' ;
                                ...
                                $this->obj->text->text('Comprobante','texto','comprobante',10,10,$datos ,'','readonly','div-1-3') ;
            ...
            $this->obj->text->editor('DETALLE ADICIONAL'.$cboton2,'detalle',4,45,450,$datos,'required','','div-2-10') ;
        ...
        echo '<div class="col-md-4">
                ...
                <div class="col-md-12">
                     <div class="alert alert-info">
                        ...
                        $evento1 = ' onClick="BuscarClienteDato()" ';
                        $cboton2 = ' <a href="#" '.$evento1.' title="Busca transacciones del Contribuyente">Identificacion   <img src="../../kimages/1480250286_search_16.png" align="absmiddle"/></a>';
                        $this->obj->text->textautocomplete($cboton2,'texto','idprov',13,13,$datos ,'',' ','div-3-9') ;
 ...
 function BarraHerramientas($autoriza){
     ...
     if ( $autoriza == 'S') {
             ...
             $formulario_impresion = '../../reportes/view_print_servicio_qvial?tipo=51';
