     ...
     function Formulario( ){
        ...
        $this->set->body_tab($titulo,'inicio');
                ...
                $this->set->div_panel7('<b> INFORMACION DE BODEGA</b>');
                	...
                	$this->obj->text->text('Nombre Bodega','texto','nombre',50,50, $datos ,'required','','div-2-10') ;
                	
                	$resultado = $this->bd->ejecutar("SELECT idprov AS codigo, razon as nombre
																				  FROM par_ciu where modulo = 'N' AND estado = 'S' ORDER BY razon");
                	...
                	$this->obj->text->editor('Competencias','competencias',3,45,300,$datos,'required','','div-2-10') ;
