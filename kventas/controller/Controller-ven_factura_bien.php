     ...
     function Formulario( ){
        ...
        echo '<div class="col-md-3">
                    <div class="alert alert-info">
                                <div class="row">
                                     <h5 align="center"><b> Servicios Disponibles</b></h5>
                    ...
                    <div class="alert alert-danger">
                      <div class="row"> ';
                        ...
                        $this->obj->text->text('Factura','texto','comprobante',10,10,$datos ,'','readonly','div-3-9') ;
       ...
       echo '</div></div> </div>
        <div class="col-md-9">'; 
          echo'<h3>
                    ...
                    <b>[ 2 ] <i class="glyphicon glyphicon-user"></i> CLIENTE Y FORMA PAGO  </b></a> 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" class="btn btn-danger" role="button"><b> <div id="ver_pago">A PAGAR $ </div>
                    </b></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="#" class="btn btn-default" role="button"><b> <div id="ver_factura">NRO. </div>
                    </b></a>
              </h3>
               ...
               <div class="col-md-12">';
                   ...
                   $this->obj->text->textautocomplete('Producto/Servicio',"texto",'articulo',50,50,$datos,'','','div-2-10');
                        
                   $this->obj->text->text($cboton1,'texto','idproducto',30,30,$datos ,'','readonly','div-2-10') ;
 ...
 function BarraHerramientas($autoriza){
     ...
     if ( $autoriza == 'S') {
             ...
             $ToolArray = array(
                 ...
                 array( boton => 'Actualizar Factura Electronica', evento =>$eventog,  grafico => 'glyphicon glyphicon-download-alt' ,  type=>"button")
             );
