    ...
    class componente{
     ...
     function Formulario( ){
     	...
     	$datos = array();
                ...
                $this->obj->text->text_yellow('Nro.Asiento',"number",'id_asiento',0,10,$datos,'','readonly','div-2-4') ;
                ...
                $this->obj->text->text_yellow('Id.Tramite',"number",'id_tramite',0,10,$datos,'','readonly','div-2-4') ;
