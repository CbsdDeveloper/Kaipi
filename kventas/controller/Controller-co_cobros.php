...
class componente{
      ...
      function componente( ){
            //inicializamos la clase para conectarnos a la bd
               ...
               $this->formulario = 'Model-co_cobros.php'; 
   
               $this->evento_form = '../model/Model-co_cobros.php';        // eventos para ejecucion de editar eliminar y agregar 
      }
   /*
   */
     function Formulario( ){
        ...
        $this->set->body_tab($titulo,'inicio');
                ...
                $this->obj->text->text('Documento/Cheque',"texto",'cheque',15,15,$datos,'required','','div-2-4');
                
                $this->obj->text->text('US $',"number",'montoi',0,30,$datos,'required','readonly','div-2-4') ; 
