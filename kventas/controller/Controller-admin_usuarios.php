     ...
     function Formulario( ){
        ...
        $this->set->body_tab($titulo,'inicio');
                ...
                $this->BarraHerramientas();
                    ...
                    $this->obj->text->text('Identificaci�n',"texto",'cedula',20,15,$datos,'required','','div-2-4') ; 
                    ...
                    $this->obj->text->text('Tel�fono',"texto",'telefono',40,45,$datos,'required','','div-2-4');
                   
                    $this->obj->text->text('M�vil',"texto",'movil',40,45,$datos,'required','','div-2-4');

                    $MATRIZ =  $this->obj->array->catalogo_perfil();
                    
                	$this->obj->list->lista('Perfil',$MATRIZ,'tipo',$datos,'required','','div-2-4');
                    
                    $this->obj->text->text('Contrase�a',"password",'clave',40,45,$datos,'required','','div-2-4');
