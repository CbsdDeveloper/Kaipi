<?php 
    ...
    class componente{
     ...
     function Formulario( ){
         ...
         $this->obj->text->text('Fecha',"date" ,'fecha_pago' ,80,80, $datos ,'required','','div-2-4') ;
         $this->obj->text->text('Mes Pago',"texto" ,'mes_pago' ,7,7, $datos ,'required','','div-2-4') ;
         $this->obj->text->text('Referencia',"texto" ,'referencia_pago' ,5,5, $datos ,'required','','div-2-4') ;
         ...
         $this->obj->text->text('Cuenta BCE',"texto" ,'cuenta_bce' ,8,8, $datos ,'required','','div-2-4') ;
