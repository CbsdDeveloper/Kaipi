     ...
     function Formulario( ){
        ...
        $this->set->body_tab($titulo,'inicio');
         ...
         $datos['menwha'] = 'Aqui Mensaje'; 
                ...
                $this->obj->text->text('<b>NOMBRE</b>',"texto",'razon',80,95,$datos,'required','','div-2-10') ;
                ...
                $this->obj->text->textMask('<b>MOVIL</b>',"tel",'movil',18,20,$datos,'','','',$reg,'div-2-10');
                ...
                $this->set->div_label(12,'<h5> Actualice la informacion del potencial cliente, para el formato de envio se requiere codigo de pais (593) seguido del numero del movil sin el caracter (0) </h5>');
                
                
                $this->set->div_panel6('fin');
           
   
                $this->set->div_panel6('<b> ENVIAR MENSAJE POR WHATSAPP</b>');
                ...
                <div class="col-md-12" style="padding: 3px"> 
                    <div class="alert alert-warning">
                        ...
                        $this->obj->text->editor('<b>MENSAJE</b>','menwha',2,45,300,$datos,'required','','div-2-10') ;
              ...
              $this->obj->list->listae('<b>EVENTO</b>',$MATRIZ,'estado',$datos,'required','',$evento,'div-2-10');
