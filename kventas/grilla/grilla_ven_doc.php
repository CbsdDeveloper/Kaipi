    ...
    class proceso{
      ...
      public function BusquedaGrilla($idvengestion ){
      	...
      	$qquery = array(
      	    ...
      	    array( campo => 'idven_doc',   valor => '-',  filtro => 'N',   visor => 'S'),
      	    array( campo => 'idvengestion',   valor => $idvengestion,  filtro => 'S',   visor => 'N'),
       	);
      
 
      	
      	$resultado = $this->bd->JqueryCursorVisor('ven_cliente_doc',$qquery );
      
      	while ($fetch=$this->bd->obtener_fila($resultado)){
      		 
      	    $url = trim($fetch['carpeta'])  . trim($fetch['archivo']);
      	    
      		$output[] = array (  $fetch['idven_doc'],
      		                     $fetch['fecha'],
      		                     $fetch['detalle']	,
      		                     $fetch['sesion'] ,
      		                      $url
