...
$(document).ready(function(){
	    ...
	    $("#ViewForm").load('../controller/Controller-incentivo.php');
...
function LimpiarPantalla() {
	...
	$("#correo").val("alcaldia@gadchimbo.gob.ec");
  ...
  $("#direccion").val("3 de Marzo 19 13 y Chimborazo");
	
	$("#telefono").val("032988 046");
	
	$("#movil").val("032988 046");
