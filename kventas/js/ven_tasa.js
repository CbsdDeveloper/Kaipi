...
function goToURL(accion1,id) {
     ...
     var parametros = {
	  ...
	  $.ajax({
					data:  parametros,
					url:   '../model/Model-ven_factura_tasa.php',
					type:  'GET' ,
 					beforeSend: function () { 
...
return today;
 ...
 function BusquedaGrilla(oTable){        
     ...
     var parametros = {
		...
		$.ajax({
		 	data:  parametros,  
		    url: '../grilla/grilla_ven_tasa.php',
			dataType: 'json',
			success: function(s){
			        //console.log(s); 
					oTable.fnClearTable();
...
function FormView()
{
 	 ...
 	 $("#ViewForm").load('../controller/Controller-ven_tasa.php');
...
function FormFiltro()
{
	 ...
	 $("#ViewFiltro").load('../controller/Controller-ven_tasa_filtro.php');
