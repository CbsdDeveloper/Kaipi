...
function goToURL(accion,id) {
     ...
     var parametros = {
	  ...
	  $.ajax({
					data:  parametros,
					url:   '../model/Model-admin_servicio.php',
					type:  'GET' ,
 					beforeSend: function () { 
 ...
 function fecha_hoy()
{
  ...
  function BusquedaGrilla(oTable){        
			...
			$.ajax({
			 	data:  parametros,  
			    url: '../grilla/grilla_admin_servicio.php',
				dataType: 'json',
				success: function(s){
						//console.log(s); 
						oTable.fnClearTable();
...
function FormView()
{
	 ...
	 $("#ViewForm").load('../controller/Controller-admin_servicio.php');
...
function FormFiltro()
{
	 ...
	 $("#ViewFiltro").load('../controller/Controller-admin_servicio_filtro.php');
