...
<head lang="en">
	...
	<link href="impresion.css" rel="stylesheet">
...
<body>
	...
	<div id="content1">
		...
		<table style="border-collapse: collapse; border: 1px solid #AAAAAA;font-weight: normal;font-size: 10px" border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan="4" style="font-weight:bold;font-size: 12px;padding: 3px">FICHA DE INGRESO DE BIENES INSTITUCIONALES (MAL ESTADO Y/O DESTINADOS PARA DAR DE BAJA)</td>
			</tr>
			<tr>
		...
		<?php   $gestion->BienesHistorial($id ); ?>
 	
	   <table style="border-collapse: collapse; border: 1px solid #AAAAAA;font-weight: normal;font-size: 10px" border="0" width="100%" cellspacing="0" cellpadding="0">
 			<tr>
				<td colspan="2" bgcolor="#EDEDED" style="font-weight: normal;font-size: 11px;padding: 6px"> 7. INFORMACION COMPLEMENTARIA </td>
			</tr>
			<tr>
