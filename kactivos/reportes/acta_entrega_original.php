...
<div id="content">
		        ...
		        <table width="90%" border="0">
				  <tbody> 
					...
					<tr>
					  <td colspan="2" style="text-align: justify"><?php  echo $datos['detalle'] ?></td>
				    </tr>
			   ...
			   <?php      $gestion->GrillaBienes($id); ?>
				  ...
				  <tbody>
					...
					<tr>
					  <td align="justify" style="text-align: justify">Para constancia de su aceptación las partes suscriben el presente instrumento en dos ejemplares de igual tenor y efecto, en la ciudad de <?php echo $gestion->_Cab( 'ciudad' ); ?>,  <?php echo $datos['fecha_completa'] ?></td>
					</tr>
					<tr>
					  <td>&nbsp;</td>
				    </tr>
