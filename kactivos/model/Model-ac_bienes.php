...
class proceso{
    ...
    function copiar_lotes($idbien,$lote_bien){
        ...
        $parcial =  $x["costo_adquisicion"] / ( $lote_bien + 1)  ;
        ...
        $sql = "update activo.ac_bienes set clasificador = '-' where clasificador is null";
     
        $this->bd->ejecutar($sql);


        $sql = "update activo.ac_bienes 
                   set costo_adquisicion = ".$this->bd->sqlvalue_inyeccion(  $parcial ,true)."
    ...
    function agregar( ){
        ...
        $valor_residual                  =   $_POST["costo_adquisicion"] * (10/100);
        $this->ATabla[21][valor]         =   $valor_residual;
    ...
    //-------------------- 
    function BuscaActa($id){
        
      
        $x = $this->bd->query_array('activo.view_bienes',
                                    'tiene_acta', 
                                   'id_bien='.$this->bd->sqlvalue_inyeccion($id,true)
            );
