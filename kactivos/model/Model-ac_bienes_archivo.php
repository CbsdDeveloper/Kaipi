...
class proceso{
    ...
    function proceso( ){
        ...
        $this->ATabla = array(
            ...
            array( campo => 'descripcion',tipo => 'VARCHAR2',id => '6',add => 'S', edit => 'N', valor => '-', key => 'N'),
            ...
            array( campo => 'estado',tipo => 'VARCHAR2',id => '13',add => 'S', edit => 'N', valor => '-', key => 'N'),
            ...
            array( campo => 'color',tipo => 'VARCHAR2',id => '25',add => 'S', edit => 'N', valor => '-', key => 'N'),
            ...
            array( campo => 'clase',tipo => 'VARCHAR2',id => '29',add => 'S', edit => 'N', valor => '-', key => 'N'),
            ...
            array( campo => 'detalle',tipo => 'VARCHAR2',id => '35',add => 'S', edit => 'N', valor => '-', key => 'N'),
            array( campo => 'detalle_ubica',tipo => 'VARCHAR2',id => '36',add => 'S', edit => 'N', valor => '-', key => 'N'),
            ...
            array( campo => 'tiempo_garantia',tipo => 'VARCHAR2',id => '41',add => 'S', edit => 'N', valor => '-', key => 'N'),
            array( campo => 'garantia',tipo => 'VARCHAR2',id => '42',add => 'S', edit => 'N', valor => '-', key => 'N'),
        ...
        $this->ATabla_custodio = array(
            ...
            array( campo => 'modificacion',tipo => 'DATE',id => '6',add => 'S', edit => 'N', valor =>  $this->hoy, key => 'N'),
            array( campo => 'sesionm',tipo => 'VARCHAR2',id => '7',add => 'S', edit => 'N', valor => $this->sesion , key => 'N'),
            array( campo => 'tipo_ubicacion',tipo => 'VARCHAR2',id => '8',add => 'S', edit => 'N', valor => '-', key => 'N'),
            array( campo => 'tiene_acta',tipo => 'VARCHAR2',id => '9',add => 'S', edit => 'N', valor => 'N', key => 'N'),
            array( campo => 'ubicacion_fisica',tipo => 'VARCHAR2',id => '10',add => 'S', edit => 'N', valor => 'N', key => 'N')
        );
    ...
    function div_resultado($accion,$id,$tipo,$estado,$comprobante){
        ...
        if ($tipo == -1){
            $resultado = '<img src="../../kimages/nogusta.png" align="absmiddle"/>&nbsp;<b>VERIFIQUE LA INFORMACION ... (CLASE BIENES, CUENTA CONTABLE)</b>';
        }
    ...
    //--------------------------------------------------------------------------------
    function copiar_lotes($idbien,$lote_bien){
        ...
        for ($i = 1; $i <= $lote_bien ; $i++) {
        
            $this->ATabla[16][valor]         = $serie. ' - '.  $i;
        ...
        $resultado ='<img src="../../kimages/kfav.png" align="absmiddle"/><b> BIEN GENERADO EMITIDO CON EXITO NRO. bIENES [ ' .$i.'  ]</b>';
    ...
    function agregar( ){
        ...
        $n1 = strlen($clasificador);
        $n2 = strlen($identificador);
    ...
    function edicion($id  ){
        ...
        if ( $bandera == 2 ) {
            ...
            $datos = $this->div_resultado('editar',0, -1,'digitado','0') ;
    ...
    function eliminar($id ){
        ...
        if (trim($uso) == 'Libre') {
            ...
            $sql = 'delete from activo.ac_bienes   
                     where id_bien='.$this->bd->sqlvalue_inyeccion($id, true);
            
            $this->bd->ejecutar($sql);
            
            
            $sql = 'delete from activo.ac_bienes_custodio
                     where id_bien='.$this->bd->sqlvalue_inyeccion($id, true);
...
if (isset($_GET['accion']))	{
    ...
    if ( $accion == 'copiar'){
        ...
        if ( $accion == 'lotes'){
            ...
            $lote_bien       = $_GET['lote_bien'];
            $gestion->copiar_lotes($id,$lote_bien);
