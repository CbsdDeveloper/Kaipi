...
if (isset($_GET['accion']))	{
    ...
    if ( $_GET['accion'] == 'del'){
        ...
        $sql = "delete from activo.ac_bienes_historico
                     where tipo_h  in  ('Mantenimiento','Reparacion','Perdida', 'Defectuoso'  ) and 
                           id_bien_historico=".$bd->sqlvalue_inyeccion($id_bien_historico, true);
    ...
    while ($fetch=$bd->obtener_fila($resultado)){
        ...
        $boton1 = '<button class="btn btn-xs btn-warning"
                              title="Eliminar Registro"
                              onClick="goToURL_Revaldel('.$idproducto.","."'".$id."'".')">
