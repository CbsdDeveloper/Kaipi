...
class proceso{
    ...
    function consultaId( ){
        ...
        $sql = "select anio_adquisicion ,count(*) as bienes,sum(costo_adquisicion) as total
			from activo.view_bienes where uso <> 'Baja'
			group by anio_adquisicion order by 1 asc"   ;
        ...
        while ($y=$this->bd->obtener_fila($resultado)){
            ...
            $detalle = 'Periodo Compra '. trim($y['anio_adquisicion']) ;
    ...
    function cabecera( ){
        ...
        <tr>
        <th  style="text-align: center;padding: 5px"  bgcolor="lightblue" width="55%">Periodo Adquisicion</th>
