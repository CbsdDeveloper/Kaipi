...
var formulario = 'ac_bienes_archivo';
...
{
	var objetos = ["#clase_esigef", "#clasificador"];
...
//-----------------
 function FormView()
 {
	 ...
	 $("#ViewFiltro").load('../controller/Controller-ac_bienes_filtro');
