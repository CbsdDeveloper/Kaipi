...
function LimpiarPantalla() {
	...
	$("#origen_ingreso").val("");
	$("#tipo_documento").val("");
	$("#clase_documento").val("Compra - Venta");
	$("#tipo_comprobante").val("Escritura");
...
//----------------------------
 ...
 function BuscaCuenta( codigo) {
		 ...
		 var parametros = {
		   ...
		   $.ajax({
				 data:  parametros,
				 url: "../model/ajax_bienes_sede_uni_t.php",
				 type: "GET",
		       success: function(response)
		       {
