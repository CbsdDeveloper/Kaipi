...
<?php  require('Head.php')  ?> 
 ...
 <script type="text/javascript" src="../js/seg_inicio.js"></script> 
...
<div id="main">
    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-md-2">
            <a href="#" class="btn btn-danger btn-sm btn-block" role="button" data-toggle="modal" data-target="#myModal">
				<i class="glyphicon glyphicon-edit"></i> Crear documento</a>
            <hr>
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><span class="badge pull-right">0</span> Nro Tramites </a>
                </li>
                <li><a href="#" onClick="javascript:BusquedaGrilla('','D');"><b>Digitado por enviar</b></a></li>
                <li><a href="#" onClick="javascript:BusquedaGrilla('','E');">Enviar documento</a></li>
