...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/inv_movimientoa.js"></script> 
	       ...
	       <ul id="mytabs" class="nav nav-tabs">          
                 		...
                 		<li class="active">
							<a href="#tab1" data-toggle="tab"> 
								<span class="glyphicon glyphicon-th-list"></span> <b>MOVIMIENTO DE COMPRA DE BIENES</b>  
			   				</a>
						</li>
	 
                  		<li>
							<a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> DETALLE MATRIZ DE COMPRA DE BIENES
							</a>
                  		</li>
															...
															<div class="col-md-2" style="padding-top: 5px;">&nbsp;</div> 
													  	    ...
													  	    <div class="col-md-10" style="padding-top: 5px;">
																...
																<button type="button" class="btn btn-sm btn-primary" id="load"><i class="icon-white icon-search"></i> Buscar</button>
																	...
																	<button type="button" class="btn btn-sm btn-info" id="loadprinter"><i class="icon-white icon-print"></i> Resumen General </button>

																	<button type="button" class="btn btn-sm btn-success" id="loadprinter1"><i class="icon-white icon-print"></i> Agrupado por Cuenta</button>

																	<button type="button" class="btn btn-sm btn-danger" id="loadprinter3"><i class="icon-white icon-print"></i> Periodo por Cuenta</button>

																	<button type="button" class="btn btn-sm btn-warning" id="loadprinter2"><i class="icon-white icon-print"></i>  Agrupado por Clase</button>
