...
<?php
 ...
 function K_consulta($id ,$obj,$bd ){
	  ...
	  FROM activo.ac_movimiento  where id_acta =".$bd->sqlvalue_inyeccion($id ,true);
 ...
 function K_editar($id, $obj,$bd ){
 	  ...
 	  $sql = "UPDATE activo.ac_movimiento
			   SET  adicional=".$bd->sqlvalue_inyeccion(@$_POST["editor1"], true)."
			 WHERE id_acta =".$bd->sqlvalue_inyeccion($id, true);
