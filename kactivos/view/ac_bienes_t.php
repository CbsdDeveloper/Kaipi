...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	 ...
 	 <script type="text/javascript" src="../js/ac_bienes_t.js"></script> 
    ...
    <div class="col-md-12"> 
	        ...
	        <ul id="mytabs" class="nav nav-tabs">       
                   		...
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> <b>REGISTRO DE BIENES INMUEBLES</b></a>
                   		</li>
