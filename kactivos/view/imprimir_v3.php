...
<body  onload="imprimir();">
	...
	<div align="center">	
	   ...
	   <div class="page" style="font-size: 8px; margin:0; font-family:Courier, 'Courier New';font-weight: 650" align="center">
  	    	 <?php echo '<b style="font-size: 10px;"> '.$name.'</b> <br>'. $variable.'.'.	$codigo  .'<br>' ?> 
   			</div>	
	   
	  	<img src="<?php echo $archivo ?>" width="100" height="100" />
