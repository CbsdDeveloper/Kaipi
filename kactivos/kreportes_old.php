		...
		$Auser = $this->bd->query_array('par_usuario',
				...
				<tbody>
				  ...
				  <tr>
					...
					<td width="50%" align="center" style="font-weight: normal;font-size: 10px;">Mg. Marco Fernado Moreira Avila</td>
				  </tr>
				   <tr>
					<td width="50%" align="center" style="font-weight: normal;font-size: 5px;">&nbsp;</td>
					<td width="50%" align="center" style="font-weight: normal;font-size: 5px;">&nbsp;</td>
				  </tr>
				  <tr>
					<td width="50%" align="center" style="font-weight: normal;font-size: 10px;"></td>
					<td width="50%" align="center" style="font-weight: normal;font-size: 10px;">Director Administrativo</td>
				  </tr>
				  <tr>
					<td width="50%" align="center" style="font-weight: normal;font-size: 5px;"></td>
					<td width="50%" align="center" style="font-weight: normal;font-size: 5px;">&nbsp;</td>
