...
<?php 
     ...
     function Formulario( ){
        ...
        $datos = array();
               ...
               echo '<ul  id="mytabs_1"  class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">1. Registro de Novedades del Bien</a></li>
   ...
   function BarraHerramientas(){
       ...
       $formulario_impresion = '../reportes/fichaActivo_novedad';
       $eventoi = 'javascript:url_ficha('."'".$formulario_impresion."')";
 
       $evento1 = 'javascript:url_open(1)';
       $evento2 = 'javascript:url_open(2)';
...
//----------------------------------------------
 ...
 //-----------------------------
  function tab_3_custodios( ){
      ...
      $this->set->div_panel12('<b> HISTORIAL DEL BIEN</b>');
