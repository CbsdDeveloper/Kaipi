...
session_start( );   
    ...
    class componente{
      ...
      function FiltroFormulario(){
       ...
       $this->obj->text->text_yellow_filtro('',"texto",'vcodigo',35,35,$datos,'','','div-0-4','BUSCAR CODIGO DEL BIEN');
       ...
       $this->obj->list->listadbe($resultado,$tipo,'','vidsede',$datos,'','',$evento,'div-0-4');
      	...
      	$this->obj->list->listae('',$MATRIZ,'vtipo_bien',$datos,'','',$evento,'div-0-4');
      	...
      	$this->obj->text->text_yellow_filtro('',"texto",'vcustodio',35,35,$datos,'','','div-0-4','BUSCAR CUSTODIO ADMINISTRATIVO');
      	
      	
      	$this->obj->text->text_yellow_filtro('',"texto",'vactivo',35,35,$datos,'','','div-0-4','BUSCAR DETALLE DEL BIEN');
