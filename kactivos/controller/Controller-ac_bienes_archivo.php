    ...
    class componente{
      ...
      function componente( ){
            //inicializamos la clase para conectarnos a la bd
               ...
               $this->formulario = 'Model-ac_bienes_archivo.php'; 
...
//----------------------------------------------
 ...
 //--------------------
  function tab_2_caracteristicas( ){
      ...
      $this->obj->text->editor('Caracteristicas Adicionales','detalle',4,250,250,$datos,'','readonly','div-2-10');
  ...
  function tab_1_datos_bienes( ){
      ...
      $this->obj->text->text('Codigo Bien',"number",'id_bien',40,45,$datos,'','readonly','div-2-4') ;
      ...
      $evento='';
      $this->obj->list->listae('Ingreso',$MATRIZ,'forma_ingreso',$datos,'','disabled',$evento,'div-2-4');
      ...
      $this->obj->list->listae('Tipo Bien',$MATRIZ,'tipo_bien',$datos,'','disabled',$evento,'div-2-4');
      
      
      $this->obj->text->text('Fecha',"date",'fecha',15,15,$datos,'','readonly','div-2-4');
...
//     $cboton='';
      ...
      $this->obj->text->textautocomplete($cadena_titulo.$cboton,"texto",'clase_esigef',40,45,$datos,'','readonly','div-2-10');
      ...
      */
      ...
      $this->obj->text->textautocomplete('<b>Clase Bien</b>',"texto",'clase',40,45,$datos,'','readonly','div-2-10');
      
      
      $resultado = $this->sql(1);
      $this->obj->list->listadbe($resultado,$tipo,'<b>Enlace Contable</b>','cuenta',$datos,'','disabled',$evento,'div-2-10');
      ...
      $this->obj->list->lista('Estado',$MATRIZ,'estado',$datos,'','disabled','div-2-4');
      
      $this->obj->text->text('Codigo Anterior',"texto",'codigo_actual',20,20,$datos,'','readonly','div-2-4') ;
      ...
      $this->obj->text->textautocomplete('Marca '.$cboton,"texto",'marca',40,45,$datos,'','readonly','div-2-4');
      ...
      $this->obj->list->listadbe($resultado,$tipo,'Modelo '.$cboton,'id_modelo',$datos,'','disabled',$evento,'div-2-4');
      
      $this->obj->text->text('Serie',"texto",'serie',35,35,$datos,'','readonly','div-2-4');
      ...
      $this->obj->text->editor($cadena,'descripcion',3,70,100,$datos,'','readonly','div-2-10');
      ...
      $this->obj->list->lista('clase Documento',$MATRIZ,'clase_documento',$datos,'','readonly','div-2-4');
      ...
      $this->obj->list->listae('Tipo Comprobante',$MATRIZ,'tipo_comprobante',$datos,'','',$evento,'div-2-4');
      
      $this->obj->text->text('Fecha Comprobante',"date",'fecha_comprobante',15,15,$datos,'','','div-2-4');
      
      $this->obj->text->text('Fecha Adquisicion',"date",'fecha_adquisicion',15,15,$datos,'','','div-2-4');
      
      
      $this->obj->text->textautocomplete('Proveedor',"texto",'proveedor',40,45,$datos,'','','div-2-4');
      
      
      $this->obj->text->text('Identificacion',"texto",'idproveedor',13,13,$datos,'','readonly','div-2-4') ;
      
      $this->obj->text->text('Nro.Factura',"texto",'factura',9,9,$datos,'','','div-2-4') ;
      
 
      
      
      $this->obj->text->text('Costo Adquisicion','number','costo_adquisicion',10,10, $datos ,'','','div-2-4') ;
 ...
 /*    $evento = ' onClick="BuscaTramite()" ';
      ...
      */
      ...
      $this->obj->text->text('Vida Util','number','vida_util',10,10, $datos ,'','','div-2-4') ;
 ...
 //-----------------------------
  function tab_3_custodios( ){
      ...
      $this->obj->text->textautocomplete('Custodio',"texto",'razon',40,45,$datos,'','readonly','div-2-4');
