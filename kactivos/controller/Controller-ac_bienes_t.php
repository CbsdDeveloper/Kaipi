...
<?php 
    ...
    class componente{
      ...
      function componente( ){
            //inicializamos la clase para conectarnos a la bd
               ...
               $this->formulario = 'Model-ac_bienes_t.php'; 
   ...
   function BarraHerramientas(){
       ...
       $eventopp = 'javascript:modalVentana('."'".$formulario_impresion."')";
...
//----------------------------------------------
 ...
 //--------------------
  function tab_2_caracteristicas( ){
      ...
      $this->obj->text->editor('Caracteristicas Adicionales','detalle',4,70,100,$datos,'','','div-2-10');
  ...
  function tab_1_datos_bienes( ){
      ...
      $this->obj->text->textautocomplete('Catalogo Bienes',"texto",'clase_esigef',40,45,$datos,'','','div-2-10');
      ...
      */
      ...
      $this->obj->text->text('Nro.Predio',"texto",'codigo_actual',20,20,$datos,'required','','div-2-4') ;
      
      
      //-----------------------------------------------------
      $this->set->div_label(12,'<b>Identificacion del Bien Inmueble</b>');
      
      $cadena = 'javascript:open_spop('."'".'admin_marca'."','".''."',".'680,350)';
      $cboton = '<a href="'.$cadena.'"><img src="../../kimages/cnew.png"/></a>';
      
      $this->obj->text->textautocomplete('Uso '.$cboton,"texto",'marca',40,45,$datos,'','','div-2-4');
      ...
      $this->obj->list->listadbe($resultado,$tipo,'Destino '.$cboton,'id_modelo',$datos,'required','',$evento,'div-2-4');
      
      $this->obj->text->text('Clave Catastral',"texto",'serie',75,75,$datos,'required','','div-2-4');
      ...
      $this->obj->text->editor($cadena,'descripcion',3,250,250,$datos,'','','div-2-10');
      ...
      $this->obj->list->listae('Tipo Documento',$MATRIZ,'tipo_comprobante',$datos,'required','',$evento,'div-2-4');
      
      $this->obj->text->text('Fecha Escritura',"date",'fecha_comprobante',15,15,$datos,'required','','div-2-4');
      
      $this->obj->text->text('Fecha Adquisicion',"date",'fecha_adquisicion',15,15,$datos,'required','','div-2-4');
      
      
      $this->obj->text->textautocomplete('Propietario Anterior',"texto",'proveedor',40,45,$datos,'','','div-2-4');
      
      $this->obj->text->text('Año',"texto",'factura',20,20,$datos,'required','','div-2-4') ;
      
      $this->obj->text->text('Costo Avaluo','number','costo_adquisicion',10,10, $datos ,'required','','div-2-4') ;
      ...
      $this->obj->text->text('Ultima Depreciacion','number','anio_depre',10,10, $datos ,'disabled','readonly','div-2-4') ;
      
      $this->obj->text->text('Vida Util','number','vida_util',10,10, $datos ,'required','disabled','div-2-4') ;
      
      $this->obj->text->text('Valor Residual','number','valor_residual',10,10, $datos ,'disabled','readonly','div-2-4') ;
...
jQuery(document).ready(function() {
 ...
 jQuery('#clase_esigef').typeahead(
	    ...
	    highlight : true,
	    source:  function (query, process) {
        return jQuery.get('../model/Model-ac_busca_indicadort.php', { query: query  }, function (data) {
        		console.log(data);
