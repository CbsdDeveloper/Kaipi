     ...
     function Formulario( ){
        ...
        $this->set->_formulario( $this->evento_form,'inicio' );  
                ...
                $this->set->div_panel6('<b> Información de la secuencia </b>');
                	...
                	$this->obj->text->text_yellow('Carpeta','texto','carpeta',100,100, $datos ,'','','div-2-10') ;
                	 
                	
                	$this->obj->text->text_blue('Modulo','texto','modulo',100,100, $datos ,'required','','div-2-10') ;
                	
                	
                	$this->obj->text->text_yellow('Reporte/Variable','texto','carpetasub',100,100, $datos ,'required','','div-2-10') ;
