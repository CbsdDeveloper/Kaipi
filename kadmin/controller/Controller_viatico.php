...
<?php 
    ...
    class Controller_viatico{
      ...
      function Controller_viatico( ){
				...
				$this->formulario = 'Model_viatico.php'; 
     ...
     function Formulario( ){
        ...
        $this->obj->text->textautocomplete('Maxima Autoridad/Delegado',"texto",'autorizado',40,45,$datos,'required','','div-3-9');
      ...
      echo '<div class="col-md-12" >
              <div class="alert alert-info"><div class="container">';
                    ...
                    $this->obj->text->editor('ACTIVIDADES','informe',5,500,500,$datos,'','readonly','div-1-5','S') ;
                    
                     
                     
                    $this->obj->text->editor('PRODUCTOS','productos',5,500,500,$datos,'','readonly','div-1-5','S') ;
 ...
 function BarraHerramientas(){
     ...
     $ToolArray = array(
         ...
         array( boton => 'Enviar Solicitud de Viaticos',  evento =>$evento,  grafico => 'glyphicon glyphicon-transfer' ,  type=>"button_danger"),
