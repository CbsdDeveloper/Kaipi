        ...
        $this->set->body_tab($titulo,'inicio');
               ...
               //         $this->obj->list->lista('Tributa',$MATRIZ,'tributo',$datos,'required','','div-2-4');
                ...
                //        $this->obj->text->text('Codigo Externo',"texto",'codigo',50,50,$datos,'required','','div-2-4') ;  
                        $datos['codigo']='SC';
                        $this->obj->text->texto_oculto("codigo",$datos); 
                        ...
                        $this->obj->text->text('Costo Promedio',"number",'promedio',0,15,$datos,'','readonly','div-2-4') ;
                        
                        $this->obj->text->text('Costo Lifo',"number",'lifo',0,15,$datos,'','readonly','div-2-4') ;
                        
                        $this->obj->text->text('SALDO ACTUAL',"number",'saldo',0,15,$datos,'','readonly','div-2-4') ;
                       ...
                       // $this->obj->list->listadb($resultado,$tipo,'Cuenta Costo','cuenta_gas',$datos,'','','div-2-4');
                        $datos['cuenta_gas']='-';
                        $this->obj->text->texto_oculto("cuenta_gas",$datos); 
                    ...
                    */            
                        ...
                        $this->set->div_labelmin(12,'<h6>'.
                            '  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Carga Inicial '.$urlCarga .' <h6>');
