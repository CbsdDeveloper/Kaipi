...
//-----------------
 function FormView()
 {
	 ...
	 $("#ViewForm").load('../controller/Controller-admin_sede.php');
 ...
 function AsignaModulo(val,val2){   //esperando la carga... 
     ...
     var parametros = {
    	...
    	$.ajax({
						data:  parametros,
						url:   '../model/Model-admin_sede_usu.php',
						type:  'GET' ,
	 					beforeSend: function () { 
...
var parametros = {
	 ...
	 $.ajax({
			 type : 'POST',
			 data:  parametros,
			 url : '../model/ajax_rol_user_sede.php',
...
$.ajax({
				data:  parametros1,
				url:   '../model/ajax_admin_usuarios_sede.php',
				type:  'GET' ,
				beforeSend: function () { 
						$("#asignado").html('Procesando');
				},
