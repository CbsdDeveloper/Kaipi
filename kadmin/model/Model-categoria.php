<?php 
      ...
      function proceso( ){
            //inicializamos la clase para conectarnos a la bd
                ...
                $this->ATabla = array(
                        ...
                        array( campo => 'variable',   tipo => 'VARCHAR2',   id => '3',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N'),
                        array( campo => 'tipo_categoria',   tipo => 'VARCHAR2',   id => '4',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N'),
                        array( campo => 'registro',   tipo => 'VARCHAR2',   id => '5',  add => 'S',   edit => 'S',   valor =>  $this->ruc   ,   filtro => 'N',   key => 'N')
                );
      }
       //-----------------------------------------------------------------------------------------------------------
      //Constructor de la clase
 ...
 function consultaId($accion,$id ){
        ...
        $qquery = array( 
                            ...
                            array( campo => 'tipo_categoria',   valor => '-',  filtro => 'N',   visor => 'S'),
			        		array( campo => 'referencia',   valor => '-',  filtro => 'N',   visor => 'S'),
                    );
 
          
            $this->bd->JqueryArrayVisor('web_categoria',$qquery );           
