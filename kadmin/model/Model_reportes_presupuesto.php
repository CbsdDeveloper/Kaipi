...
class Model_reportes_presupuesto
{
    ...
    {
        $k = 0;
        echo '<table class="table table-sm table-bordered table-hover table-tabletools" id=' . "'" . $nombre . "'" . ' border="0" width="100%">
        <thead> <tr>';
        ...
        while ($row = pg_fetch_assoc($resultado)) {
            ...
            $nsuma8 = $nsuma8 + $c1;
            $nsuma9 = $nsuma9 + $c2;
            $nsuma10 = $nsuma10 + $row["certificado"];
        ...
        echo '<td align="right"><b>' . number_format($nsuma10, 2) . '</b></td>';
    ...
    function titulo($tipo_presupuesto, $cmes)
    {
        ...
        $imagen = '<img src="../../kimages/' . trim($_SESSION['logo']) . '" height="120">';
        echo '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 13px;table-layout: auto">
              <tr>
                  <td width="20%" rowspan="2" style="text-align: right">' . $imagen . '</td>
