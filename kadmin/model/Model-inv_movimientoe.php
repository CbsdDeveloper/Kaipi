...
class proceso{
    ...
    function proceso( ){
        ...
        $this->ATabla = array(
            ...
            array( campo => 'modulo',   tipo => 'VARCHAR2',   id => '18',  add => 'S',   edit => 'N',   valor => 'inicio',   filtro => 'N',   key => 'N')
        );
    ...
    function agregar( ){
        ...
        if ( $this->estado_periodo == 'abierto' ){
            ...
            if ($longitud < 5 ) {
                ...
                $datos = $this->div_resultado('add',0, -1,'solicitado','0') ;
                ...
                $datos = $this->div_resultado('editar',$id, 1,'solicitado','0') ;
    ...
    function AprobarComprobante($accion,$id,$tipo){
        ...
        $estado = 'digitado';
            ...
            $datos = $this->div_resultado('aprobado',$id, 2,'digitado',$comprobante) ;
