<?php 
    ...
    class proceso{
      ...
      function proceso( ){
            //inicializamos la clase para conectarnos a la bd
                ...
                $this->tabla 	  	  = 'web_marca';
                
                $this->secuencia 	     = '-';
                
                $this->ATabla = array(
                		array( campo => 'idmarca',   tipo => 'NUMBER',   id => '0',  add => 'N',   edit => 'N',   valor => '-',   filtro => 'N',   key => 'S'),
 ...
 function consultaId($accion,$id ){
        ...
        $qquery = array( 
        					array( campo => 'idmarca',   valor => $id,  filtro => 'S',   visor => 'S'),
			        		array( campo => 'nombre',   valor => '-',  filtro => 'N',   visor => 'S'),
			        		array( campo => 'referencia',   valor => '-',  filtro => 'N',   visor => 'S'),
                    );
 
          
            $datos = $this->bd->JqueryArrayVisor('web_marca',$qquery );           
