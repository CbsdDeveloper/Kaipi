...
if ($lcantidad > 0) {
    ...
    $ATabla = array(
        ...
        array( campo => 'cantidade',   tipo => 'NUMBER',   id => '1',  add => 'N',   edit => 'S',   valor => $lcantidad,   filtro => 'N',   key => 'N'),
        ...
        array( campo => 'cantidad',   tipo => 'NUMBER',   id => '15',  add => 'N',   edit => 'S',   valor => $lcantidad,   filtro => 'N',   key => 'N')
    );
