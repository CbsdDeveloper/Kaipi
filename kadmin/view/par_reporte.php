...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/par_reporte.js"></script> 
...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<div class="panel panel-primary">
		  <div class="panel-heading"><b>OPCIONES DEL MÓDULO</b></div>
 		 	     ...
 		 	     <div class="col-md-12">
                    ...
                    <ul id="mytabs" class="nav nav-tabs">      
                   		...
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> Lista de Reportes</a>
                   		</li>
                  		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Información del Reporte</a>
                  		</li>
					 ...
					 <div class="tab-pane fade in" id="tab3"  style="padding-top: 3px">
                      <div class="panel panel-default">
					        ...
					        <div class="panel-body" > 
						 	...
						 	<iframe src="editor_pie.php" width="100%" height="550px" frameborder="0" id="ieditor" name="ieditor"></iframe>
