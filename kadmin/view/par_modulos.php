...
<head>
    ...
    <?php  require('Head.php')  ?> 
 	...
 	<script type="text/javascript" src="../js/par_modulos.js"></script> 
 		 	     ...
 		 	     <div class="col-md-12">
                    ...
                    <ul id="mytabs" class="nav nav-tabs">      
                   		...
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> Lista de Módulos</a>
                   		</li>
                  		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Información del Módulo</a>
                  		</li>
