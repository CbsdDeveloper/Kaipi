...
.sidenav_proceso a:hover {
  color:#0A0A0A;
	    ...
	    <script language="javascript" src="../js/teletrabajo_jefe.js"></script>
    ...
    <div class="col-md-12"> 
 					  ...
 					  <ul id="mytabs" class="nav nav-tabs">  
							...
							<li class="active"><a href="#tab1" data-toggle="tab">
								<span class="glyphicon glyphicon-th-list"></span> Lista de Actividades</a>
							</li>

							<li><a href="#tab2" data-toggle="tab">
								<span class="glyphicon glyphicon-link"></span> Asignar actividades de trabajo funcionario </a>
							</li>
