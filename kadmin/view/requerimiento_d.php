...
.sidenav_proceso a:hover {
  color:#0A0A0A;
	    ...
	    <script language="javascript" src="../js/requerimiento_d.js"></script>
    ...
    <div class="col-md-12"> 
 					  ...
 					  <ul id="mytabs" class="nav nav-tabs">  
							...
							<li class="active"><a href="#tab1" data-toggle="tab">
								<span class="glyphicon glyphicon-th-list"></span> Documentos/Archivos de interes</a>
							</li>
										 ...
										 <div class="panel-body"  > 
											   ...
											   <div class="col-md-3">
												   ...
												   <div class="col-md-12" style="padding-bottom: 15px;padding-top: 10px">
													   ...
													   <button type="button" class="btn btn-sm btn-danger" onclick="openFile('../../upload/uploadDoc_dep',650,360)">Upload</button>
											   ...
											   <div class="col-md-9">
 												       ...
 												       <div class="col-md-12" id="main_proceso">
														     ...
														     <div class="col-md-9" id="main_proceso">
																   <div class="alert alert-success">
																	  <strong>Catalogo Archivo/Documental!</strong> 
																	   es el instrumento que pone a su disposición documentos administrativos, legales, jurídicos, informativos, que por su naturaleza poseen los documentos; la clasificación de la información reservada, confidencial y publica.
																	</div>
															</div>
