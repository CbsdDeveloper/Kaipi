...
.sidenav_proceso a:hover {
  color:#0A0A0A;
	    ...
	    <script language="javascript" src="../js/requerimiento_p.js"></script>
    ...
    <div class="col-md-12"> 
 					  ...
 					  <ul id="mytabs" class="nav nav-tabs">  
							...
							<li><a href="#tab2" data-toggle="tab">
								<span class="glyphicon glyphicon-link"></span> Formulario Permisos/Vacaciones </a>
							</li>
															 ...
															 <table id="json_variable" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%"  >
																 <thead>
																	<tr>
																		...
																		<th style="background-color: #f8f8f8" width="10%">Tipo</th>	
																		<th style="background-color: #f8f8f8" width="25%">Motivo</th>
																		<th style="background-color: #f8f8f8" width="20%">Novedad</th>	
																		<th style="background-color: #f8f8f8" width="5%">Dias</th>	
																		<th style="background-color: #f8f8f8" width="15%">Hora</th>	
																		<th style="background-color: #f8f8f8" width="7%">Fracción/Dia(Horas)</th>	
