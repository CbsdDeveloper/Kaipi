						...
						<ul>
							...
							/*	 $sql_nivel1 = 'SELECT IDUNIDAD, IDUNIDADPADRE, NOMBRE, NIVEL
								...
								*/
								 ...
								 $sql_nivel1 = 'SELECT id_departamento as  idunidad, 
								 					   id_departamentos as idunidadpadre, 
													   nombre, 
													   nivel
...
function _niveles($id_unidad,  $bd	, $obj){
     	...
     	$AResultado = $bd->query_array('nom_departamento',
											'count(*) as numero',
											'id_departamentos='.$bd->sqlvalue_inyeccion($id_unidad,true));
...
//--------------------------------------------------------
 function Subnivel($id_unidad,$bd,$obj,$nivel){
   ...
   $sql1 ="SELECT id_departamento as  idunidad, 
				  id_departamentos as idunidadpadre, 
				  nombre, 
				  nivel,
				  univel
   FROM nom_departamento
   WHERE id_departamentos =" .$bd->sqlvalue_inyeccion($id_unidad,true); ;
   ...
   while ($y=$bd->obtener_fila($stmt_nivel2)){
   	...
   	$id_departamento_nivel2 = trim($y['idunidad']);
   	$nivel2  				= $y['nivel'];
