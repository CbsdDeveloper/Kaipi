						    ...
						    <div class="col-md-9" style="padding: 20px" align="center">
							   ...
							   <div class="col-md-12">
								 ...
								 <div class="col-md-12" style="padding: 10px">
										 ...
										 <a href="#" title="Más Información" onClick="MiPerfil();" style="font-size: 14px;font-weight: 500">Panel Información Unidad-Usuario</a>
			 ...
			 <div class="col-md-3" style="padding: 5px">
							 ...
							 <div  style="padding-top:5px;padding-bottom: 5px;">  
									  ...
									  <div class="panel-heading">
										  ...
										  <div class="panel-body">
											    ...
											    <ul class="list-group">
												  <li class="list-group-item"><a href="../../kplanificacion/view/POASeguimientoUni.php" style="color: #232323"> - Gestion PAPP-POA </a></li>
													
													 <li class="list-group-item"><a href="../../kplanificacion/view/PACSeguimientoUni" style="color: #232323"> - Gestion PAC</a></li>	
												 ...
												 <?php	
													...
													*/
													...
													?>
													  ...
													  <li class="list-group-item"><a href="requerimiento_d" style="color: #232323"> - Documentos/Formularios de interes</a></li>	
					...
					<div class="col-md-12">
                              ...
                              <div  style="background-image: url(../../kimages/01.png);padding-top: 3px" align="center"> 
 								  ...
 								  <iframe width="100%" id="recordar" name = "recordar" height="275px" src="../../notificaciones/" border="0" scrolling="no" allowTransparency="true" frameborder="0"></iframe>
