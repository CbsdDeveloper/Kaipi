										 		...
										 		<div class="col-md-12" >
														     ...
														     <div class="col-md-9" id="main_proceso" style="padding-bottom: 5px;padding-top: 5px">
																   <div class="alert alert-success">
																	  <strong>SOLICITUD DE REQUERIMIENTO DE BODEGA</strong> </br>
																	  ...
																	  Paso 3.- Seleccione los articulos que desea solicitar y envie este requerimiento a la unidad administrativa
																	</div>
															</div>
