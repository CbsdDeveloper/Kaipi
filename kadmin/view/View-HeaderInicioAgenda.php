	...
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" style="padding-top: 5px;" href="#">
				<img src="../../kimages/Logocbsd.png" height="40"> </a>
			<a class="navbar-brand"> <span style="font-size:20px;cursor:pointer" onclick="openNav()">&#9776</span></a>
		</div>
		<ul class="nav navbar-nav">
			<li class="active">
				<a href="#" data-toggle="modal" data-target="#myModalEmail" title="Crear Cartelera de informacion"> CARTELERA</a>
			</li>
			<li><a href="../../kadmin/view/View-panel">INICIO</a></li>
