...
class proceso{
   ...
   //     $series5['name'] ='Devengado';
    ...
    function _pie_gasto_inversion(){
        ...
        $sql = "SELECT  grupo || subgrupo as grupo,  sum(codificado) as total
                FROM presupuesto.view_gestion_resumen
                where grupo in ( '75','84') and anio =  ".$this->bd->sqlvalue_inyeccion($this->anio,true)."
                group by grupo, subgrupo order by 1";
