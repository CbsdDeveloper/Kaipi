	...
	var parametros = {
	  ...
	  $.ajax({
					...
					success:  function (data) {
							 ...
							 goToURLProcedimiento(idproceso);
  					} 
			}); 
...
function goToURLTarea(idproceso) {
	...
	var parametros = {
	  ...
	  $.ajax({
					data:  parametros,
					url:   '../controller/Controller-auto_06.php',
					type:  'GET' ,
					cache: false,
					beforeSend: function () { 
					...
					success:  function (data) {
							 $("#VisorTarea").html(data);  // $("#cuenta").html(response);
...
//-------------
function goToURLProcedimiento(idproceso) {
	...
	var parametros = {
	  ...
	  $.ajax({
					data:  parametros,
					url:   '../controller/Controller-auto_07.php',
					type:  'GET' ,
					cache: false,
					beforeSend: function () { 
 							$("#DibujoProcedimiento").html('Procesando');
  					},
					success:  function (data) {
							 $("#DibujoProcedimiento").html(data);  // $("#cuenta").html(response);
