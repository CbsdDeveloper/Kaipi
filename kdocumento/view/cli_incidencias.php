											 ...
											 <div class="col-md-2">
												 ...
												 <div class="col-md-12" style="padding-top: 5px;padding-bottom: 5px" >
												  ...
												  <div class="col-md-12" style="padding-top: 3px;padding-bottom: 3px" >												 
													  	...
													  	<button type="button" class="btn btn-sm btn-primary" id="loadavanzada">  
															 ...
															 <table id="json_variable" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%"  >
																 <thead>
																	<tr>
																		...
																		<th style="background-color: #f8f8f8" width="30%">De</th>	
																		<th style="background-color: #f8f8f8" width="40%">Asunto</th>
