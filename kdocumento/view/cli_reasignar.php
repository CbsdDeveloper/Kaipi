 		 	     ...
 		 	     <div class="col-md-12">
					  ...
					  <ul id="mytabs" class="nav nav-tabs">                    
						...
						<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> Detalle de Documento</a>
                   		</li>
			
			
							<li><a href="#tab2" data-toggle="tab">
								<span class="glyphicon glyphicon-calendar"> </span> Recorrido Documento</a>
							</li>
							...
							<span class="glyphicon glyphicon-inbox"> </span> Documentos generados</a>
							</li>
									  ...
									  <div class="col-md-12">
									 		<table id="json_variable" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%"  >
																	 <thead>
																			...
																			<th style="background-color: #f8f8f8" width="10%">Estado</th>	
																			<th style="background-color: #f8f8f8" width="20%">Solicita</th>
																			<th style="background-color: #f8f8f8" width="30%">Caso</th>	
					   ...
					   <div class="tab-pane fade in" id="tab4"  style="padding-top: 3px;">
						    ...
						    <div class="panel panel-default">
							  ...
							  <div class="panel-body" > 
								   ...
								   <div class="col-md-6"> 
     								 		 <div id="ViewFormfile" style="padding: 1px"></div>
   								     </div>
							  </div>
