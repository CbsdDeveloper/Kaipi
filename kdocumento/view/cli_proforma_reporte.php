...
<script src="../js/jquery.PrintArea.js" type="text/JavaScript" language="javascript"></script>	
 ...
 <script type="text/javascript" src="../js/cli_proforma_reporte.js"></script> 
	    ...
	    <div class="row">
								...
								<ul id="mytabs" class="nav nav-tabs">       
										...
										<li class="active"><a href="#tab1" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b> GESTION DOCUMENTOS</b></a>
										</li>
											  ...
											  <div class="panel panel-default">
												   ...
												   <div class="panel-body" > 
														   ...
														   <div class="col-md-12" style="padding: 10px">
															     ...
															     <div class="col-md-3">
																	 <select name="canio" id="canio" class="form-control">
																    ...
																    <button type="button" class="btn btn-sm btn-success" id="loadproceso" title="Resumen Gestion">  
																	<i class="icon-white icon-ok-sign"></i></button>	
																   
																   
																   <button type="button" class="btn btn-sm btn-default" id="loadprintg" title="Imprimir Resumen">  
																	<i class="icon-white icon-print"></i></button>	
															    </div>   
