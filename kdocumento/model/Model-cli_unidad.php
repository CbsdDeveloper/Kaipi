...
class proceso{
    ...
    function proceso( ){
        ...
        $this->ATabla = array(
            ...
            array( campo => 'estado',   tipo => 'VARCHAR2',   id => '9',  add => 'S',   edit => 'N',   valor => '-',   filtro => 'N',   key => 'N'),
            ...
            array( campo => 'orden',   tipo => 'VARCHAR2',   id => '19',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N'),
        );
