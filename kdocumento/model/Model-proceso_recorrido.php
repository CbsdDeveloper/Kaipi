...
//---------------------------------------------------------------------------
 ...
 function _Actividades($bd,$obj,$idcaso){
    ...
    $sqlO1= 'SELECT caso,fecha,nombre_solicita,fecha_envio,fecha_recepcion,cumple,finaliza,hora_in,sesion_actual,
            dias_tramite,estado_tramite, anio, mes,novedad,dias_trascurrido
   ...
   echo '<tr>
    <td class="derecha" width="10%" style="text-align: center;padding: 5px" valign="top"  bgcolor="#A5CAE1">Instancias</td>
    <td class="derecha" width="25%" style="text-align: center;padding: 5px" valign="top"  bgcolor="#A5CAE1">Asignado </td>
    <td class="derecha" width="25%" style="text-align: center;padding: 5px" valign="top"  bgcolor="#A5CAE1">Comentario/Novedad</td>
    <td class="derecha" width="8%" style="text-align: center;padding: 5px" valign="top"  bgcolor="#A5CAE1">Fecha Recepcion</td>
    <td class="derecha" width="7%" style="text-align: center;padding: 5px" valign="top"  bgcolor="#A5CAE1">Fecha Envio</td>
    ...
    <td class="derecha" width="20%" style="text-align: center;padding: 5px" valign="top"  bgcolor="#A5CAE1">Estado</td>
