...
$(document).ready(function() {
	  ...
	  $.ajax({
        ...
        _barra('../grilla/grafico_inicio.php?tipo=1&anio='+anio , 'div_grafico_gasto_1', '  ' );
       
        _pie('../grilla/grafico_inicio?tipo=2&anio='+anio , 'div_grafico_gasto_2', '  ' );
        
        
        _pie2('../grilla/grafico_inicio?tipo=3&anio='+anio , 'div_grafico_gasto_3', '  ' );
       
        
        _barra('../grilla/grafico_inicio.php?tipo=4&anio='+anio , 'div_grafico_gasto_4', '  ' );
