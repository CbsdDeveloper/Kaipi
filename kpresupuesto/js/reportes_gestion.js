...
//----------------------
...

 {
	 ...
	 $("#ViewFiltro").load('../controller/Controller-inicial_filtro_gestion.php');

 
	 
 }
//----------------  
function GastosParcial( )
 {
...
function VerParcial_id( id )
{
	...
	$.ajax({
			 ...
			 cache: false,
			 beforeSend: function () { 
						$("#lista_parcial").html('Procesando');
				},
			success:  function (data) {
					 $("#lista_parcial").html(data);   
				} 

	});
} 
//-------------------------------
function VerParcial_det( id )
{
