			...
			if(s){
				...
				for(var i = 0; i < s.length; i++) {
					...
					oTableGasto.fnAddData([
						 ...
						 s[i][6],
						 s[i][7],
	                     '<button class="btn btn-xs" onClick="goToURLReforma('+"'gasto'"+','+ "'" + s[i][0] +"'," + s[i][7] +')"><i class="glyphicon glyphicon-edit"></i></button> '  
		...
		if(s){
			...
			for(var i = 0; i < s.length; i++) {
				...
				oTableIngreso.fnAddData([
					 ...
					 s[i][6],
					 s[i][7],
                     '<button class="btn btn-xs" onClick="goToURLReforma('+"'ingreso'"+','+ "'" + s[i][0] +"'," + s[i][7] +')"><i class="glyphicon glyphicon-edit"></i></button> '  
