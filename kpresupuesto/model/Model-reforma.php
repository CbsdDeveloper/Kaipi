...
class proceso{
    ...
    function agregar( ){
        ...
        if ( $bandera == 0){
                 ...
                 $sql = "INSERT INTO presupuesto.pre_reforma (	fecha, registro, anio, mes, detalle, sesion, creacion, 
                                                comprobante, estado, tipo, tipo_reforma, documento, id_departamento)
        										        VALUES (".$fecha.",".
        										        ...
        										        $this->bd->sqlvalue_inyeccion(@$_POST["tipo_reforma"], true).",".
        										        ...
        										        $idAsiento =  $this->bd->ultima_secuenciaP('presupuesto.pre_reforma_id_reforma_seq');
        										        
        										        $_SESSION['id_reforma']  = $idAsiento;
    ...
    function revierte_dato($id ){
        ...
        $x = $this->bd->query_array('presupuesto.pre_reforma',
            'estado', 'id_reforma='.$this->bd->sqlvalue_inyeccion($id,true)
            );
    ...
    function eliminar($id ){
        ...
        if ( trim($x["estado"]) == 'digitado'){
            ...
            $sql = " DELETE FROM presupuesto.pre_reforma
        							      WHERE id_reforma      =".$this->bd->sqlvalue_inyeccion($id, true);
