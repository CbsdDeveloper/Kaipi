      ...
      function proceso( ){
            //inicializamos la clase para conectarnos a la bd
                ...
                $this->ATabla = array(
                    ...
                    array( campo => 'fcertifica',tipo => 'DATE',id => '21',add => 'S', edit => 'N', valor => '-', key => 'N'),
                    array( campo => 'fcompromiso',tipo => 'DATE',id => '22',add => 'S', edit => 'N', valor => '-', key => 'N'),
                 );
 ...
 function consultaId($accion,$id ){
     ...
     function agregar(   ){
          ...
          // $estado = $_POST["estado"];
           ...
           $this->ATabla[21][valor] =    $fecha;
           $this->ATabla[22][valor] =   $fecha;  
