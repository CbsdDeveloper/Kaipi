...
class proceso{
    ...
    //-----------------
    function _barra_gasto_fuente1($currentYear){
...
$currentYear     = $gestion->_anio();

if ($tipo == 1) {
    $gestion->_barra_gasto_fuente1($currentYear);
}

if ($tipo ==2 ) {
    $gestion->_pie_gasto_fuente1($currentYear);
}

if ($tipo == 3 ) {
    $gestion->_pie_gasto_fuente2($currentYear);
}

if ($tipo == 4 ) {
    $gestion->_barra_gasto_fuente2($currentYear);
}
