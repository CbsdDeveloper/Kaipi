			  ...
			  <div class="container-fluid">
				<div class="navbar-header">
				   <a class="navbar-brand" href="#">GK-Gestiona</a>
					 <a class="navbar-brand"> <span style="font-size:20px;cursor:pointer" >&#9776</span></a>
				</div>
				<ul class="nav navbar-nav">
				  <li class="active"><a href="../../kadmin/view/View-panel">INICIO</a></li>
				  <li><a href="#">REQUERIMIENTO BIENES/SERVICIOS</a></li>
				  <li><a href="#"> <b><?php  echo $_SESSION['ruc_registro'];  ?> </b></a></li>
				   <li><a href="#"> <b><?php  echo trim($_SESSION['razon']);  ?> </b></a></li>
