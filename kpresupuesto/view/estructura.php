...
<head>
	...
	<style type="text/css">
		...
		<script language="javascript" src="../js/estructura.js?n=1"></script>
	...
	<div class="col-md-12"> 
								...
								<ul id="mytabs" class="nav nav-tabs">      
										...
										<li class="active"><a href="#tab1" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b> ESTRUCTURA PRESUPUESTARIA </b>  </a>
										</li>
												        ...
												        <h5>Transacciones por periódo</h5>
													      ...
													      <table id="jsontable" class="display table table-condensed table-hover datatable" cellspacing="0" width="100%">
																					<thead>
																						<tr>
																					    <th width="10%">Id</th>
																						<th width="40%">Estructura</th>
																						<th width="10%">Tipo</th>	
																						<th width="10%">Orden</th>
																						<th width="10%">Esigef</th>
