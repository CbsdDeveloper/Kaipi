...
<head>
	...
	<script language="javascript" src="../js/compromiso01.js?n=1"></script>
        ...
        <div class="col-md-12"> 
			...
			<div class="row">
				...
				<div class="col-md-2">
					...
					<a href="#" id="b1" class="btn btn-danger btn-sm btn-block"   onClick="LimpiarPantalla()" role="button" data-toggle="modal" data-target="#myModal">
                    ...
                    <hr>
                       ...
                       <ul class="nav nav-pills nav-stacked">
						   ...
						   <li>
                            ...
                            <li>
                             <a href="#" onClick="javascript:BusquedaGrilla('','3','3. Certificacion Presupuestaria',1);"><b>3. Certificacion Presupuestaria</b>
                             </a></li>
 						     <li>
                            <a href="#" onClick="javascript:BusquedaGrilla('','5','5. Compromiso Presupuestario',1);"><b>5. Compromiso Presupuestario</b>
                            </a></li>
 						   <li>
                            <a href="#" onClick="javascript:BusquedaGrilla('','6','6. Tramites Devengado',1);"><b>6. Tramites Devengado</b>
                            </a></li>
 						   <hr>
						   <li>
				    ...
				    <input type="hidden" id="qbusqueda" >
					   ...
					   <div class="col-md-12" style="padding-left: 15px; padding-top: 15px">
 						  <button type="button" id="qbuton" onClick="BusquedaCliente()" class="btn btn-info btn-sm btn-block">Busqueda de Tramite </button> 
					  </div>
					
					<div class="col-md-12" style="padding-left: 15px; padding-top: 5px">
 						  <button type="button" onClick="modalVentana('proveedor')" class="btn btn-default btn-sm btn-block">Crear Proveedores</button> 
					  </div>
					
					<div class="col-md-12" style="padding-left: 15px; padding-top: 5px">
 						  <button type="button"id="loadSaldosg" class="btn btn-success btn-sm btn-block"><i class="icon-white icon-ambulance"></i> Actualizar Saldos </button> 
					  </div>
					
					 <h5 align="center">........................</h5>
					
						<div class="col-md-12" style="padding-left: 10px; padding-top: 10px">
 						  <button type="button" onClick="modalVentana('co_xpagar')" class="btn btn-primary btn-sm btn-block">CUENTAS POR PAGAR</button> 
					  </div>
					
					 <div class="col-md-12" style="padding-left: 10px; padding-top: 10px">
 						  <button type="button" onClick="modalVentana1('te_pagos')" class="btn btn-warning btn-sm btn-block">REGISTRO PAGADO</button> 
					  </div>
