...
<div id="content">
				 ...
				 <tr>
				  <td bgcolor="#EDEDED" align="center" style="font-weight: normal;font-size: 14px"> 
					  <b>   AVAL DE PLANIFICACION NRO. <?php   	echo trim($datos['comprobante']) ?> </b>
				 </td>
				</tr>
				 <tr>
		        ...
		        <table width="100%"  class="tablap">
				 ...
				 <tr>
				   <td rowspan="2"  align="center"  style="font-weight: normal;font-size: 10px" with="33%"><?php echo $datos['elaborado'] ?> </td>
				   <td   with="33%"  align="center" style="font-weight: normal;font-size: 10px"><?php echo $datos['f10'] ?></td>
			      </tr>
				 <tr>
				   <td   with="33%"  align="center" style="font-weight: normal;font-size: 10px"><?php echo $datos['f11'] ?></td>
			      </tr>
				 <tr>
