...
<div id="content">
				 ...
				 <tr>
				  <td bgcolor="#EDEDED" align="center" style="font-weight: normal;font-size: 14px"> 
					  <b>   SOLICITUD DE CERTIFICACION NRO. <?php   	echo trim($datos['comprobante']) ?> </b>
				 </td>
				</tr>
				 <tr>
		        ...
		        <table width="100%" border="0">
				  <tbody>
					...
					<tr>
					  ...
					  De conformidad con lo expresado en el Art.115 del Código de Planificación y Finanzas Públicas y una vez revisado el presupuesto aprobado para el ejercicio fiscal, se solicita la certificacion presupuestaria detallada en la descripcion referida, previo a iniciar el proceso de emision de pagos de roles de pago emitido por la unidad de Talento Humano:	
					</td>
			    </tr>
				  </tbody>
				</table>
				<br>
		 		<?php      $gestion->GrillaCertificacion($id); ?>
				  ...
				  <tbody>
					<tr>
					  <td>El monto de la presente solicitud previa a la emision de la certificacion presupuestaria asciende a $ <?php  echo $gestion->_total() ?> Dólares americanos</td>
					</tr>
					<tr>
					  <td>&nbsp;</td>
					</tr>
		        ...
		        <table width="100%"  class="tablap">
				 ...
				 <tr >
				   <td class="lado" with="33%"  align="center" style="font-weight: normal;font-size: 10px"><p>&nbsp;</p>
			       <p>&nbsp;</p></td>
 				   <td class="lado" with="33%"  align="center" style="font-weight: normal;font-size: 10px">&nbsp;</td>
			     </tr>
				 <tr>
				   <td class="lado" with="33%"  align="center" style="font-weight: normal;font-size: 10px"> Elaborado </td>
 				   <td class="lado" with="33%"  align="center" style="font-weight: normal;font-size: 10px">Autorizado</td>
			     </tr>
