...
<div id="content" style="width: 100%">
	  ...
	  <div style="padding: 7px">  
		      ...
		      <table width="100%"  class="tablap">
				 ...
				 <tr>
				   <td rowspan="2"  align="center" style="font-weight: normal;font-size: 10px" with="33%">  <?php echo $datos['e10'] ?></td>
				   <td   with="33%"  align="center" style="font-weight: normal;font-size: 10px">&nbsp;</td>
			      </tr>
				 <tr>
				   <td    with="33%"  align="center" style="font-weight: normal;font-size: 10px">  
			       <?php  echo $datos['f10'] ?></td>
			      </tr>
				 <tr>
				   <td   with="33%"  align="center" style="font-weight: normal;font-size: 10px">Analista de Presupuesto</td>
				   <td   with="33%"  align="center" style="font-weight: normal;font-size: 10px">Director Financiera(a)</td>
			    </tr>
				 <tr>
				   <td   with="33%"  align="center" style="font-weight: normal;font-size: 10px">Elaborado</td>
 				   <td   with="33%"  align="center" style="font-weight: normal;font-size: 10px">Autorizado</td>
			     </tr>
				  
				  <tr>
				  <td colspan="2"  align="left" style="font-weight: normal;font-size: 10px"> 
