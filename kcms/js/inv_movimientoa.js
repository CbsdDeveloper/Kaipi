...
//-----------------('seleccion',134,0)
function deltramite(tipo,idtramite,codigo)
{
...
function FormFiltro()
{
	...
	$.ajax({
 			 url:   '../controller/Controller-inv_movimientoa_filtro.php',
			type:  'GET' ,
				beforeSend: function () { 
...
function InsertaProducto()
{
	...
	var id_movimiento = $('#id_movimiento').val();
 	...
 	var idproducto    = $('#idclasebien').val();
...
function calcular(id) {
	...
	var parciald 		=  $(objeto).val();
				 	...
				 	guarda_detalle(baseiva,monto_iva,tarifa_cero,lcantidad,total,estado,ingreso_egreso,id,pdtempo,parciald,lcosto,detalle);
	...
	var estado 			= $('#estado').val();
 	var ingreso_egreso 	= $('#tipo').val();
				...
				if (ingreso_egreso == 'I'){
			 				...
			 				guarda_detalle1(  total,id,estado,ingreso_egreso );
...
function PictureArticulo(id)
{
	...
	$.ajax({
			...
			success:  function (data) {
					 $("#VisorArticuloActualiza").html(data);  // $("#cuenta").html(response);
...
function ActualizaCuenta( )
{
	...
	$.ajax({
			...
			success:  function (data) {
					 $("#GuardaDatoA").html(data);  // $("#cuenta").html(response);
...
//-----------------
function guarda_detalle(baseiva,monto_iva,tarifa_cero,lcantidad,total,estado,ingreso_egreso,id,p1,descuento,lcosto,detalle)
{
