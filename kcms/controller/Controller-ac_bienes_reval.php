     ...
     function Formulario( ){
        ...
        $datos = array();
               ...
               echo '<ul  id="mytabs_1"  class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">1. Registro Historico</a></li>
...
//----------------------------------------------
 ...
 //--------------------
  ...
  function tab_1_datos_bienes( ){
      ...
      $this->obj->text->text('CodigoBien',"number",'id_bien',40,45,$datos,'required','readonly','div-2-10') ;
      $MATRIZ = array(
 ...
 //-----------------------------
  function tab_3_custodios( ){
      ...
      $this->set->div_panel12('<b> HISTORIAL HISTORICO BIEN</b>');
