 ...
 //--------------------
  ...
  function tab_1_datos_bienes( ){
      ...
      $this->set->div_panel6('INFORMACION FINANCIERA BIEN');
              ...
              $this->obj->text->text('Catalogo Bienes',"texto",'clase_esigef',40,45,$datos,'','readonly','div-2-10');
              
              $this->obj->text->text('<b>Clase Bien</b>',"texto",'clase',40,45,$datos,'','readonly','div-2-10');
