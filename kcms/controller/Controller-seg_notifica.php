...
<?php 
    ...
    class componente{
      ...
      function componente( ){
            //inicializamos la clase para conectarnos a la bd
               ...
               $this->formulario = 'Model-seg_notifica.php'; 
     ...
     function Formulario( ){
        ...
        $this->set->evento_formulario( $this->evento_form,'inicio' ); // activa ajax para insertar informacion
                ...
                $this->set->nav_tab("#tab_1_1",'Envio de notificacion',
                    "#tab_1_2",'Informacion Recomendacion',
                ...
                $this->K_tab_1_1('Envio de notificacion');
                
                $this->K_tab_1_2('Informacion Recomendacion');
                
                $this->K_tab_1_3('Documentos Complementarios');
   ...
   function K_tab_1_1($titulo){
       ...
       $this->obj->text->editor('Recomendacion','tema_recomendacion',3,350,350,$datos,'','readonly','div-2-10');
           
    
       
       echo '</div><p>&nbsp;</p><div class="alert alert-danger"><div class="row">';
       
       
       $this->obj->text->editor('Novedad','ultimo_comentario',3,350,350,$datos,'required','','div-2-10');
       ...
       $this->obj->text->texto_oculto("email_responsable",$datos); 
       ...
       $this->obj->list->lista('<b>ESTADO DE PROCESO</b>',$MATRIZ,'estado_envio',$datos,'required','','div-2-10');
   ...
   function K_tab_1_2($titulo){
       ...
       $this->obj->list->lista('Periodo',$MATRIZ,'anio_perido',$datos,'','disabled','div-2-4');
       
       $this->obj->text->text('Fecha Documento','date','fecha_apertura',10,10, $datos ,'required','','div-2-4') ;
    
       $this->obj->text->editor('Observacion','observacion',3,350,350,$datos,'','','div-2-10');
   ...
   function K_tab_1_3($titulo){
       ...
       $this->obj->text->editor('Marco legal','marco_legal',3,350,100,$datos,'','','div-2-10');
...
//----------------
  ...
  function listaValores($titulo,$campo,$evento){
      ...
      $this->obj->list->listadbe($resultado,$tipo,$titulo,$campo,$datos,'','',$evento,'div-2-10');
