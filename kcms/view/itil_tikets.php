...
<script src="../js/jquery.PrintArea.js" type="text/JavaScript"></script>	
 ...
 <script type="text/javascript" src="../js/itil_tikets.js"></script> 
...
<div id="main">
   ...
   <div class="col-md-12" role="banner">
			...
			<div class="row">
									...
									<ul id="mytabs" class="nav nav-tabs">  
											...
											<li class="active"><a href="#tab1" data-toggle="tab">
												<span class="glyphicon glyphicon-th-list"></span> <b>GESTION TICKETS</b></a>
											</li>
												  ...
												  <div class="panel panel-default">
													   ...
													   <div class="panel-body" > 
															   ...
															   <div class="col-md-12" style="padding: 10px">
																	   ...
																	   <button type="button" class="btn btn-sm btn-default" id="loadprintg" title="Resumen de control de soporte tecnico">  
																		<i class="icon-white icon-print"></i> Generar Reporte</button>	
														   ...
														   <div class="col-md-12" style="padding: 1px;">
																  ...
																  <div class="col-md-12">
																		   ...
																		   <div class="col-md-4"> 
																				 <div class="panel panel-info">
																							  <div class="panel-heading">Tramites  por Mes </div>
																							  <div class="panel-body">
																										   <?php    $gestion->tramites_por_mes(); ?> 
																							  </div>	
																				 </div> 
																			</div>	
																		   ...
																		   <div class="col-md-4"> 
																				 <div class="panel panel-info">
																							  <div class="panel-heading">Tramites por Unidad</div>
																							  <div class="panel-body">
																										   <?php    $gestion->tramites_por_unidad(); ?> 
																							  </div>	
																				 </div> 
																			</div>	
																		  ...
																		  <div class="col-md-4"> 
																				 <div class="panel panel-info">
																							  <div class="panel-heading">Tramites por Categoria</div>
																							  <div class="panel-body">
																										   <?php    $gestion->tramites_categoria(); ?> 
																							  </div>	
																				 </div> 
																			</div>	
																 </div>	
																 ...
																 <div class="col-md-12">
																		  ...
																		  <div class="col-md-4"> 
																				 <div class="panel panel-info">
																							  <div class="panel-heading">Tramites por Estados</div>
																							  <div class="panel-body">
																										   <?php    $gestion->tramites_estados(); ?> 
																							  </div>	
																				 </div> 
																			</div>	
																		  ...
																		  <div class="col-md-4"> 
																				 <div class="panel panel-info">
																							  <div class="panel-heading">Tramites por Responsables</div>
																							  <div class="panel-body">
																										   <?php    $gestion->tramites_usuarios(); ?> 
																							  </div>	
																				 </div> 
																			</div>	
																		 ...
																		 <div class="col-md-4"> 
																				 <div class="panel panel-info">
																							  <div class="panel-heading">Tramites por Solicitantes</div>
																							  <div class="panel-body">
																										   <?php    $gestion->tramites_solicita(); ?> 
																							  </div>	
																				 </div> 
																			</div>	
	...
	<input type="hidden" id="idtiki" name="idtiki">
  	<!-- Page Footer-->
    <div id="FormPie"></div>  
                        ...
                        <div class="modal-dialog" id="mdialTamanio">
                            <div class="modal-content">
                                      <div class="modal-header">
                                        ...
                                        <h5  class="modal-title">Soporte y Atencion al Cliente</h5>
                                      </div>
                                            ...
                                            <div class="panel panel-default">
                                                 <div class="panel-body">
													 <div class="col-md-12"  style="width:100%; height:300px;"> 
                                                    	    ...
                                                    	    <div id="view_mensaje"> HISTORIAL DE SOPORTE TECNICO</div> 
														 
														 	 <div  id="BandejaDatosSeg"> </div> 
                                      ...
                                      <div class="modal-footer">
										 ...
										 <div  id="BandejaDa"> </div> 

										 <button type="button" class="btn btn-sm btn-success" onClick="CambioEstado()">Cerrar Ticket</button>
