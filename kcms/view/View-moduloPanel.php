							...
							<ul class="navbar-menu animate">
								<li>
									<a href="inicio" class="animate">
										<span class="desc animate"> Administracion</span>
										<span class="glyphicon glyphicon-cog"></span>
									</a>
								</li>
								<li>
									<a href="../../kcontabilidad" class="animate">
										<span class="desc animate"> Contabilidad </span>
								...
								<li>
									<a href="../../kinventario" class="animate">
										<span class="desc animate"> Inventario </span>
								...
								<li>
									<a href="../../kcrm" class="animate">
										<span class="desc animate"> Gestion Interna </span>
