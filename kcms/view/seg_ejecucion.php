...
<?php  require('Head.php')  ?> 
 ...
 <script type="text/javascript" src="../js/seg_ejecucion.js"></script> 
    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-md-2">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#" onClick="javascript:BusquedaGrilla('','P');"><b>Proceso en ejecucion</b></a></li>
