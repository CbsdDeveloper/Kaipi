...
<?php 
 ...
 //-------------
   ...
   function K_tab_1_3($titulo){
       ...
       $this->obj->list->listae('% retencion IVA',$MATRIZ,'porcentaje_iva',$datos,'','disabled',$evento,'div-2-4');
       
       $this->obj->text->text('Bienes',"number",'valorretbienes',40,45,$datos,'','readonly','div-2-4') ;
       
       $this->obj->text->text('Servicios',"number",'valorretservicios',40,45,$datos,'','readonly','div-2-4') ;
       
       $this->obj->text->text('100% Servicios',"number",'valretserv100',40,45,$datos,'','readonly','div-2-4') ;
       
       
         
       $this->obj->text->texte('Base Imponible (+)',"number",'baseimpair',40,45,$datos,'','readonly',$evento,'div-2-4') ;
       ...
       $this->obj->list->listadbe($resultado,$tipo,'Retencion ','codretair',$datos,'','disabled',$evento,'div-2-4');
   ...
   function K_tab_1_4($titulo ){
       ...
       $this->obj->text->text('Estab./Emisi�n',"texto",'serie1',6,6,$datos,'required','','div-2-4');
   ...
   function K_tab_1_5($titulo ){
       ...
       $this->obj->list->listae('Pa�s al que efectua el pago',$MATRIZ,'paisefecpago',$datos,'required','',$evento,'div-3-3');
       ...
       $this->obj->list->listae('Pago sujeto a retenci�n en aplicaci�n de la norma legal?',$MATRIZ,'fpagextsujretnorLeg',$datos,'required','',$evento,'div-3-3');
   ...
   function BarraHerramientas(){
       ...
       $evento_anular  = "javascript:AnularRetencion()";
