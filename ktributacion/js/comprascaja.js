...
function goToURLElectronico(valor) {
     ...
     var autorizacion  = $("#autretencion1").val();
						  	...
						  	$.ajax({
				                     ...
				                     cache:false,   
						 			 ...
						 			 complete : function(){
											  ...
											  $.ajax({
									                 data:  parametrosi,
									               //  url:  '../../facturae/autoriza_comprobante_firma_tributa.php',
									                 url:   '../../facturae/autoriza_comprobante.php',
									                 type:  'GET' ,
									                 success:  function (data) {
...
function ImprimirRetencion(  ) {
    ...
    if ( id > 0 ) {
		      ...
		      var url = '../../facturae/comprobante_electronico_tributa.php';
