...
class proceso{
	...
	function proceso( ){
		...
		$this->ATabla = array(
		        ...
		        array( campo => 'sifondo',   tipo => 'VARCHAR2',   id => '13',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N'),
		    ...
		    array( campo => 'msesion',   tipo => 'VARCHAR2',   id => '18',  add => 'S',   edit => 'S',   valor =>$this->sesion,   filtro => 'N',   key => 'N'),
		        ...
		        array( campo => 'id_banco',   tipo => 'NUMBER',   id => '20',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N') ,
		        array( campo => 'tipo_cta',   tipo => 'VARCHAR2',   id => '21',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N') ,
		        array( campo => 'cta_banco',   tipo => 'VARCHAR2',   id => '22',  add => 'S',   edit => 'S',   valor => '-',   filtro => 'N',   key => 'N') 
		);
