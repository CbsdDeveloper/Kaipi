...
if ( $url['felectronica'] == 'S' ) {
    ...
    $sql = "SELECT id_compras, id_asiento, secretencion1,  idprov,   autretencion1, fecharegistro,razon,correo, detalle
                        ...
                        where
                                ...
                                id_compras  = ".$bd->sqlvalue_inyeccion( $id ,true)." and
    ...
    while ($fila=$bd->obtener_fila($stmt)){
        ...
        $url_original = 'https://www.g-kaipi.cloud/EP-Const/';
        
    
        
        //   $url_original = 'https://www.g-kaipi.cloud/Qvial/';
        //$url_original = 'https://g-kaipi.cloud/kaipi/';
        //$url_original = 'http://www.s2i.com.ec/kaipi/';
        //$url_original = 'http://200.94.83.133/kaipi/';
        
        
        $pathimagen = $url_original .'facturae/firmas/'.$imagen;
        ...
        $enlace =$url_original .'facturae/ride/RideComprobante?xml='.$xml.'&file='.$pa;
        ...
        $url = $url_original .'facturae/xml/'.$xml.'_A'.'.xml';
