...
require  '../../facturae/crearXMLComprobanteTributa.php';
...
$ADatos = $bd->query_array(
    'web_registro',
    'razon, contacto, correo,direccion,comercial,felectronica,estab,ruc_registro,obligado,firma,carpeta,ambiente',
