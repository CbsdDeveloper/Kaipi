...
<body>
 <div style="padding: 15px">
  <table border="0" cellpadding="0" cellspacing="0">
				...
				<tr> <td style="padding-bottom: 0px;padding-top: 0px; font-size: 10px">GESTION TRIBUTARIA KAIPI</td> </tr>
				<tr> <td style="padding-bottom: 1px;padding-top: 1px;font-size: 9px">DETALLE IMPUESTO A LA RENTA</td></tr>
