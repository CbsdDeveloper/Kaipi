<?php  
 ...
 class ReportePdf{
      ...
      function SqlGridProve( $anio,$mes){
          ...
          echo '<h6>GESTION TRIBUTARIA RESUMEN DE COMPRAS </h6>';
          
 
          $sql_maestro = 'SELECT id_asiento, fecharegistro,idprov, razon,secuencial,detalle,baseimponible, baseimpgrav,  montoiva
          ...
          echo  '<table  ' .$estiloTabla.'>
				  <tr>
					...
					<th width="25%" '.$estilo.' align="center">Proveedor</th>
          ...
          while($row=pg_fetch_assoc($resultado)) {
              ...
              echo  '<tr>
						...
						<td width="10%" '.$estilo.'  align="left">'.$row["fecharegistro"].'</td>
					    <td width="10%"  '.$estilo.'  align="left">'.$row["idprov"].'</td>
      ...
      function SqlGridMes( $anio,$mes){
          ...
          echo  '<table  ' .$estiloTabla.'>
				  <tr>
					...
					<th width="30%" '.$estilo.' align="center">Detalle Mensual</th>
