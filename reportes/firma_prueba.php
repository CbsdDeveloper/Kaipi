...
file_put_contents('eliana_isabel_duran_granda.pem', $privateKeyPem);
file_put_contents('eliana_isabel_duran_granda.pem', $publicKeyPem);
...
$privateKeyPem = file_get_contents('eliana_isabel_duran_granda.pem');
