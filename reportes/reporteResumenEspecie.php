...
<body>
	...
	<h3>  	DETALLE MENSUAL CONTROL DE ESPECIES VALORADAS	</h3>
	 ...
	 <h4>
		...
		<?php echo $g->Especie_nombre_mes($frubro,$fecha,$cajero) ; ?>
	...
	<h4>  DETALLE DE COMPROBANTES EMTIDOS </h4>
      ...
      <tbody>
        <tr>
		  ...
		  <td align="center" valign="middle">Desde</td>	
          <td align="center" valign="middle">Hasta</td>
		  <td align="center" valign="middle">Cantidad</td>
          <td align="center" valign="middle">Total</td>
			</tr>
 		  <?php   $g->resumenClientes_especie_mes($fecha,$cajero,$frubro);  ?>
       </tbody>
    </table> 
