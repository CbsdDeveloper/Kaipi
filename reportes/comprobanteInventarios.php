...
<table border="0" cellpadding="0" cellspacing="0" class="tableCabecera">
  <tr>
    <td colspan="4" align="center" valign="middle" class="Mensaje">COMPROBANTE INGRESO DE BODEGA</td>
  </tr> 
  <tr>
    <td class="Mensaje">&nbsp;</td>
    <td class="Mensaje">&nbsp;</td>
    <td align="right" valign="middle" class="Mensaje"><span class="titulo1">NRO.COMPROBANTE</span></td>
    <td class="Mensaje"><span class="titulo"><?php echo   $g->_getSolicita('comprobante'); ?></span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="13%" class="Mensaje">Proveedor</td>
  ...
  <tr>
    <td class="Mensaje">Nro.Factura</td>
    <td class="Mensaje" ><?php echo $g->_getSolicita('documento'); ?></td>
    <td class="Mensaje" align="right" >Fecha Factura</td>
    <td class="Mensaje" ><?php  echo $g->_getSolicita('fechaf'); ?></td>
  </tr>
  <tr>
