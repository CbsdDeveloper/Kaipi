...
<meta charset="UTF-8">
  ...
  <style>
	  	...
	  	@page { margin: 150px 30px 150px 30px; }   
...
<div id="header">
	   ...
	   <table width="100%" class="logo_header" bgcolor="#FDFFC9" >
		  <tbody>
			<tr>
			   
				<td width="75%" align="center" style="padding: 5px" class="cabecera_font">
				    <b> <?php  echo $gestion->Empresa(); ?><br>
					PROGRAMACIÓN ANUAL DE LA POLÍTICA PÚBLICA - PAPP POA ORDINARIA  </b> <br>
					 <b><?php  echo 'PERIODO ' .$periodo ?> </b><br>
					<?php  echo $gestion->_Cab( 'ruc_registro' ); ?>
...
<div id="content" >  
	 					 ...
	 					 <?php  $gestion->_ObjetivosE($id,$periodo) ;  ?>
	
						  <?php  $gestion->_ActividadesPOA_RESUMEN($id,$periodo) ;  ?>
