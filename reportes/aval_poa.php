...
$datos = $gestion->tarea_pac($seg  );

$doc              = $datos['seg_secuencia'];
$fecha            = $datos['seg_fecha'];
$pla              = $datos['pla'];
...
<div id="content"  >  
			  ...
			  <tbody>
				<tr>
				  <td align="right"> Nro.Documento:<?php  echo $doc ;   ?><br>Fecha Emisión:<?php  echo $fecha ;   ?></td>
				</tr>
				<tr>
				  <td align="justify"> <?php     $gestion->aval_poa('PP-SP', $id,$seg  ); ?></td>
				</tr>
			  </tbody>
			</table>
 			...
 			<?php   
				if ($pla == 'N') {
						echo '<h3 align="center"><b>DOCUMENTO BORRADOR </b></h3> ';
					}
