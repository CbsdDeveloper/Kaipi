    ...
    <tr>
      <td>
		   <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tbody>
				<tr>
				  <td width="10%"><img src="../kimages/Screenshot_1.png" width="108" height="101"/></td>
				  <td valign="top" align="center" class="Mensaje" width="90%"><span style="font-size: 14px">EMPRESA PUBLICA CUERPO DE BOMBEROS DEL CANTÓN VALENCIA</span><br>
        Dir. Calle 2 Agosto y Av. 13 de Diciembre<br>
        Valencia - Los Ríos - Ecuador<br>RUC: 1260049900001<br>
        <b><span style="font-size: 14px"><?php echo strtoupper($concepto) ?></span></b><br>
        Periodo <?php echo $cabecera['anio'] ?></td>
				</tr>
			  </tbody>
		  </table>
 </td>
    ...
    <tr>
      <td>
          ...
          <tbody>
            ...
            <tr> 
              <td   class="titulo"   colspan="2" rowspan="2" bgcolor="#E8E8E8">
                <?php echo $detalle ?>
                </td>
            ...
            <td width="75%"  style="font-size: 11px;padding: 4px">
 			 ...
 			 ?> 
				 <tr> <td colspan="1" align="right">Total a Pagar</td>
				   	  <td style="font-size: 15px;padding: 2px;font-weight: bold" align="center"><?php echo number_format($totalCosto,2,',','.')  ?></td>
				 </tr>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            ...
            <td align="center"><img src="../reportes/cabo.png" width="150" /></td>
          </tr>
          <tr>
            <td class="titulo" align="center">Cabo. Jose Jimenez </td>
            <td class="titulo" align="center">Ing. Maricela Navarro </td>
            <td class="titulo" align="center">CPA. Oscar Lucas Jaramillo </td>
          </tr>
          <tr>
