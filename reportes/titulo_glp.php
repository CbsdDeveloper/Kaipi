	...
	<div class="page" align="center">
				...
				<tr> <td>
							   ...
							   <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tbody>
									<tr>
									  <td style="text-align: justify; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size:19px;">En el uso de sus atribuciones establecidas en la Ley de Defensa Contra incendios, en su Art. 35 concede el siguiente Permiso de Transporte Provisional y Canjeable: </td>
									</tr>
								  </tbody>
							  </table>
				...
				<tr>
				  <td align="center">
						...
						<tr>
						   <td  class="titulo1" width="10%"><b>Identificacion</b></td>
						  <td  class="titulo"  width="50%"><?php echo $cliente['idprov'] ?></td>
						  <td  class="titulo1"  width="10%" align="right"><b> Nro. Emision</b></td>
						  <td  class="titulo1"  width="30%"><?php echo $row['id_ren_movimiento'] ?></td> 
						  </tr>

						<tr>
						  <td  class="titulo1"><b>A:</b></td>
						  <td  class="titulo"><?php echo $cliente['razon'] ?></td>
						  </tr>
						<tr>
						  <td rowspan="2"  class="titulo1" valign="top" ><b>Dirección </b></td>
						  <td rowspan="2"  class="titulo" valign="top"  ><?php echo $cliente['direccion'] ?></td>
						  </tr>
						 <tr>
						  <td  class="titulo1"><b>Ciudad</b></td>
						  <td  class="titulo">SigSig</td>
						  </tr>
						  <tr>
						  <td  class="titulo1"><b>Provincia</b></td>
						  <td  class="titulo">SigSig</td>
						   <td  class="titulo1"><b>Desde</b></td>
						   <td  class="titulo"><?php echo $glp['desde']; ?></td>
						  </tr>
						  <tr>
						  <td  class="titulo1" width="20%"><b>Para transportar </b></td>
						  <td  class="titulo"><?php  echo $glp['transporta']; ?></td>
						   <td  class="titulo1"><b>Hasta</b></td>
						   <td  class="titulo"><?php echo $glp['hasta']; ?></td>
						   

						  </tr>
						  <tr>
						  <td  class="titulo1"><b>Marca Vehiculo </b></td>
						  <td  class="titulo"><?php echo $glp['marca']; ?></td>
						   <td  class="titulo1"><b>Cilindraje</b></td>
						   <td  class="titulo"><?php  echo $glp['cilindraje']; ?></td>
						   
						  </tr>
						  <tr>
						  <td  class="titulo1"><b>Color</b></td>
						  <td  class="titulo"><?php  echo $glp['color']; ?></td>
						   <td  class="titulo1"><b>Placas</b></td>
						   <td  class="titulo"><?php  echo $glp['placa']; ?></td>
						   
						  </tr>
						  <tr>
						  <td  class="titulo1"><b>Fecha de expedición</b></td>
						  <td  class="titulo"><b><?php echo $row['fecha'] ?></td>
				  ...
				  <td align="center">
					...
					<tbody>
					  <tr>
						...
						<td width="80%" align="center" class="titulo"><img src="firma_sigsig.png" width="250" height="150" /></td>
