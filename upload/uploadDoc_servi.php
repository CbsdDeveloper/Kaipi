...
<script type="text/javascript">
 ...
 function procesa_informacion(archivo_file) {
       ...
       var 	id 			= document.getElementById('id_ren_tramite').value;
       var detalle 		= document.getElementById('detalle').value;
	   var modulo 		= 'servicios_rentas';
	     ...
	     <div class="panel panel-primary">
      		 ...
      		 <div class="panel-heading">Carga de archivos</div>
				...
				<div class="panel-body">
					...
					<form action="uploadDoc_servi?status=ok&file=<?php echo $_GET['file'] ?>&id=<?php echo $_GET['id'] ?>" method="post" enctype="multipart/form-data" id="forma">
								 
						<div class="col-md-10" style="padding: 2px"> 
							<input name="userfile" type="file" id="userfile"  accept=".pdf" class="btn btn-primary" >
				        </div>
								 
						<div class="col-md-10" style="padding: 2px"> 
							 <input type="submit" class="btn btn-success" value="1. Cargar Archivo"  />
						</div>
                        ...
                        <input type="hidden" id="id_ren_tramite" name="id_ren_tramite" value="<?php echo $_GET['id'] ?>">
...
<?php
   ...
   function guarda_imagen($sesion_variable,$carpeta_variable,$archivo ,$bd   ){
		  ...
		  global $filename;
		    ...
		    $prefijo = substr(md5(uniqid(rand())),0,12).'-'.$year ;
