	     ...
	     <div class="panel panel-primary">
      		 ...
      		 <div class="panel-heading">Carga de archivos</div>
				...
				<div class="panel-body">
					...
					<form action="uploadDoc_archivo?status=ok&file=<?php echo $_GET['file'] ?>&id=<?php echo $_GET['id'] ?>" method="post" enctype="multipart/form-data" id="forma">
                        ...
                        <div class="col-md-10" style="padding: 3px"> 
							   ...
							   <input type="text"  placeholder="Descripcion del Documento" class="form-control" name="detalle" id="detalle" value="<?php 
													global $archivo ;
						 ...
						 <div class="col-md-10" style="padding: 3px"> 
							 ...
							 <input type="text" placeholder="Nro. de Paginas Documento" class="form-control" name="paginas" id="paginas"  >
						     
				        </div>
						
						 <div class="col-md-10" style="padding: 3px"> 
						
						<select id="tipoa" class="form-control" name="tipoa">
						  ...
						  <input type="hidden" id="exten" name="exten" value="<?php 
													global $extencion ;
													echo str_replace('"', '&quot;', trim($extencion)); 
													?>" >
