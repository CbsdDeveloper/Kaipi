	     ...
	     <div class="panel panel-primary">
      		 ...
      		 <div class="panel-heading">Carga de archivos</div>
				...
				<div class="panel-body">
					...
					<form action="uploaditil?status=ok&file=<?php echo $_GET['file'] ?>&id=<?php echo $_GET['id'] ?>" method="post" enctype="multipart/form-data" id="forma">
...
<?php
   function guarda_imagen($sesion_variable,$carpeta_variable,$archivo ,$bd  , $id ){
		  ...
		  global $filename;
            ...
            $filename = $anio.'-'. $id.'-'.$prefijo.'.'.$tipo_archivo;
