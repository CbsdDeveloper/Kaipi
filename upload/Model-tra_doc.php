...
//-----------------------------------------------------
	...
	function eliminar( $id ,$idcodigo  ){
	    ...
	    $sql = "delete from  pdoc.doc_modulo 
            ...
            $this->BusquedaDoc( $idcodigo ) ;
            
	}
//---------------------------------------------------------
public function BusquedaDoc( $id,$modulo ){
	    ...
	    $qquery = array(
	        ...
	        array( campo => 'modulo',valor => trim($modulo) ,filtro => 'N', visor => 'S') 
	    );
	...
	public function BusquedaDocVisor( $id){
	    ...
	    $qquery = array(
	        ...
	        array( campo => 'fecha',valor => '-',filtro => 'N', visor => 'S'),
	        array( campo => 'archivo',valor => '-',filtro => 'N', visor => 'S'),
	        array( campo => 'modulo',valor => 'tramite',filtro => 'N', visor => 'S')
	    );
