 		 	     ...
 		 	     <div class="col-md-12">
					  <ul id="mytabs" class="nav nav-tabs">                    
						...
						<li><a href="#tab3" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Configurar Aplicacion Caja Disponible-Presupuesto</a>
                  		</li>
...
box-shadow: 5px 20px 21px -24px rgba(10,10,10,1);">
                 ...
                 <div class="tab-pane fade in" id="tab2"  style="padding-top: 3px">
                      ...
                      <div class="panel panel-default">
						  <div class="panel-body" > 
							   <h4> Aplicación Caja - Saldos Disponibles </h4>
							   <div class="col-md-9">
							  	 <div id="ViewFormCaja"  > </div>
							   </div>
							  <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Agregar</button>
		  ...
		  <div class="modal-dialog" id="mdialTamanio_aux_d">
					...
					<div class="modal-content">
								  ...
								  <div class="modal-header">
									...
									<h3  class="modal-title">Aplicacion Disponibles</h3>
								  </div>
								  ...
								  <div class="modal-footer" >
									 ...
									 <button type="button" class="btn btn-sm btn-success" onClick="GuardaCaja()">Guardar Datos</button>
