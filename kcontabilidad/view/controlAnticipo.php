...
<html lang="en"><head>
	 ...
	 <script type="text/javascript" src="../js/controlAnticipo.js"></script> 
		...
		<!-- Nav tabs     -->     
								...
								<ul id="mytabs" class="nav nav-tabs">
															...
															<li class="active"><a href="#tab1" data-toggle="tab"></span>
																<span class="glyphicon glyphicon-th-list"></span> <b>DETALLE DE ANTICIPOS POR ENTREGAR</b>  </a>
															</li>
															<li><a href="#tab2" data-toggle="tab">
																<span class="glyphicon glyphicon-link"></span> Registro Contables</a>
															</li>
												   				...
												   				<div class="col-md-12">
																	...
																	<div class="col-md-12" style="background-color:#ededed;padding-top: 10px;padding-bottom: 10px">
																					...
																					<div id="ViewFiltro"></div> 
  																					...
  																					<div style="padding-top: 9px;" class="col-md-12">
