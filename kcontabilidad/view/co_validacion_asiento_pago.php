					...
					<div class="panel panel-default">
					  <div class="panel-heading">
						<h4 class="panel-title">
						  <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Detalle Asiento</a>
						</h4>
					  </div>
			         ...
			         <div class="panel panel-default">
					  <div class="panel-heading">
						<h4 class="panel-title">
						  <a data-toggle="collapse" data-parent="#accordion" href="#collapse11">Presupuesto Por Programa</a>
						</h4>
					  </div>
	...
	<script>
		  function goToURLAsiento(id_asientod,cuenta,grupo) {
		 	    $('#xid_asientod').val( id_asientod );
                   ...
                   $.ajax({
						data:  parametros,
						url:   '../controller/Controller-co_asiento_enlacea.php',
						type:  'GET' ,
						cache: false,
