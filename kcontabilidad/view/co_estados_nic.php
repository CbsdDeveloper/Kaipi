...
<head>
	...
	<script type="text/javascript" src="../js/co_estado_nic.js"></script> 
 			     ...
 			     <div class="col-md-12" > 
					        <ul id="mytabs" class="nav nav-tabs">                    
									...
									<li><a href="#tab6" data-toggle="tab">
										<span class="glyphicon glyphicon-asterisk"></span> Estado Evolucion del Patrimonio</a>
									</li> 
						       ...
						       <div class="tab-pane fade in" id="tab2"  style="padding-top: 3px">
								  <div class="panel panel-default">
									  ...
									  <div class="col-md-12" style="padding-bottom:15;padding-top: 10px"> 
												  ...
												  <button type="button" class="btn btn-sm btn-default" id="financiero3">
