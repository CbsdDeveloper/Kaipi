...
<head>
 ...
 <script type="text/javascript" src="../js/te_cobro.js"></script> 
 		 	     ...
 		 	     <div class="col-md-12">
								...
								<ul id="mytabs" class="nav nav-tabs">                    
										<li class="active"><a href="#tab1" data-toggle="tab"></span>
											<span class="glyphicon glyphicon-th-list"></span> <b>COBROS POR REALIZAR</b></a>
										</li>
										<li><a href="#tab2" data-toggle="tab">
											<span class="glyphicon glyphicon-link"></span> Comprobante de Ingreso</a>
										</li>
...
box-shadow: 5px 20px 21px -24px rgba(10,10,10,1);">
											    ...
											    <div class="col-md-9">
                                                    ...
                                                    <div style="padding-top: 5px;" align="right" class="col-md-12">
																	...
																	<i class="icon-white icon-money"></i>  Generar cobro a proveedor</button>	
															</div>
