...
<html lang="en"><head>
	 ...
	 <script type="text/javascript" src="../js/co_asientos_tramite.js"></script> 
		...
		<!-- Nav tabs     -->     
								...
								<ul id="mytabs" class="nav nav-tabs">
															...
															<li class="active"><a href="#tab1" data-toggle="tab"></span>
																<span class="glyphicon glyphicon-th-list"></span> <b>ENLAZAR ASIENTOS CONTABLES - TRAMITES</b>  </a>
															</li>
										 			 ...
										 			 <div class="panel panel-default">
															  ...
															  <div class="panel-body" >
												   				...
												   				<div class="col-md-12">
																	...
																	<div class="col-md-12" style="background-color:#F4AAAC;padding-top: 10px;padding-bottom: 10px">
