...
<title>Plataforma de Gestión Empresarial</title>
 ...
 <link href="../app/bootstrap/bootstrap.min.css" rel="stylesheet" type="text/css">
  ...
  <!-- 
	...
	<link rel="stylesheet" href="../app/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css"/>
   ...
   <script type="text/javascript" src="../app/bootstrap/js/bootstrap.min.js"></script>
	...
	<script type="text/javascript" src="../../kconfig/lib/alertify.js"></script>
 	...
 	<link rel="stylesheet" href="../../kconfig/themes/alertify.default.css" />
  	<script type="text/javascript" src="../js/co_solicitupago.js"></script> 
          			 ...
          			 <div class="row">
						...
						<div class="col-md-3">
								 <div class="panel panel-primary">
									 <div class="panel-heading"><span class="glyphicon glyphicon-home"></span>  Opciones </div>
									  <div class="panel-body">
										  <div class="alert alert-success">
											  <h5>Inbox Doc</h5>
											  <ul class="list-group"> 
												<li class="list-group-item"><span class="glyphicon glyphicon-file"></span>  <a href="#" onClick="tramite('Pendiente')">Pendientes</a> </li>
												<li class="list-group-item"><span class="glyphicon glyphicon-apple"></span> Revisado </li>
												<li class="list-group-item"><span class="glyphicon glyphicon-flash"></span> Aprobadas </li>
												<li class="list-group-item"><span class="glyphicon glyphicon-usd"></span> Pagadas </li>
												<li class="list-group-item"><span class="glyphicon glyphicon-warning-sign"></span> Anuladas  </li>
											  </ul>
											 </div>  
                ...
                <!-- Nav tabs     <ul id="mytabs" class="nav nav-tabs" role="tablist">-->      	 
                    <ul id="mytabs" class="nav nav-tabs">                    
                   		<li class="active"><a href="#tab1" data-toggle="tab"></span>
                   			<span class="glyphicon glyphicon-th-list"></span> INBOX</a>
                   		</li>
                  		<li><a href="#tab2" data-toggle="tab">
                  			<span class="glyphicon glyphicon-link"></span> Nueva Solicitud de Pago</a>
                  		</li>
                   </ul>
                     <!-- ------------------------------------------------------ -->
                   <!-- Tab panes -->
						  ...
						  <div class="panel-body" > 
                           	   <div class="col-md-6" style="padding: 2px">
                           	     <div class="alert alert-warning" style="padding: 2px">
										<div style="width: 100%; height: 400px; overflow-y: scroll; padding: 3px">						       
						       						<div id="listramite"> </div>
						       			</div>			
							      </div>
                         	   </div> 
                         	    <div class="col-md-6"  style="padding: 2px">
 								 <div id="vertramite"> </div>
                         	   </div> 
	  ...
	  <div class="modal fade" id="myModal" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
		    <button type="button" class="btn btn-sm btn-primary" id="load"  data-dismiss="modal"><i class="icon-white icon-search"></i> Búsqueda</button>
