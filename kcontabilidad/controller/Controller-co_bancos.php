     ...
     function Formulario( ){
        ...
        $tipo = $this->bd->retorna_tipo();
                ...
                $this->set->div_panel6('<b> REFERENCIA CONCILIACION BANCARIA </b>');
                    ...
                    <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModalDeposito"  onClick="DepositoLista()">Deposito o Trasferencias</button>
                    ...
                    <button type="button" class="btn btn-warning btn-sm" onClick="total_saldos()">Diferencia Conciliar</button>
                    </div>';
                ...
                $this->set->div_panel6('<b> RESUMEN DE VALORES DE CONCILIACION </b>');
                    ...
                    $this->obj->text->text('(+) Depositos en transito','number','depositos',10,10, $datos ,'','readonly','div-4-8') ;
                ...
                $this->set->div_panel6('<b> MOVIMIENTOS CONTABLES DE BANCOS PERIODO MENSUAL</b>');
                 ...
                 echo '<div id="Mov_Desposito">(+) Despositos o Trasferencias</div>';
