...
<?php 
    ...
    class componente{
      ...
      function componente( ){
            //inicializamos la clase para conectarnos a la bd
               ...
               $this->formulario = 'Model-te_cobro.php'; 
   ...
   function BarraHerramientas(){
   	...
   	$eventoc = "javascript:open_pop_dato('../view/co_xcobrar')";
    ...
    $ToolArray = array( 
    		...
    		array( boton => 'Imprimir Comprobante de Pago', evento =>$evento1,  grafico => 'glyphicon glyphicon-tasks' ,  type=>"button") ,
      		array( boton => 'Comprobantes de Ingreso', evento =>$eventoc,  grafico => 'glyphicon glyphicon-new-window' ,  type=>"button") 
                 );
