...
class componente{
    ...
    function Formulario($idasientodet){
        ...
        $this->obj->text->text('Identificacion',"texto",'idprov1',15,15,$datos,'required','readonly','div-2-10');
        ...
        $this->obj->list->lista('Copiar',$MATRIZ,'fcopiar',$datos,'','','div-2-4');
        ...
        if ( $x['nn'] > 1  ) {
            ...
            $qcabecera = array(
                array(etiqueta => 'id_asientod',campo => 'id_asientod',ancho => '0%', filtro => 'S', valor => $idasientodet, indice => 'S', visor => 'N'),
                array(etiqueta => 'id_asiento',campo => 'id_asiento',ancho => '0%', filtro => 'S', valor => $id_asiento, indice => 'S', visor => 'N'),
                array(etiqueta => 'cuenta',campo => 'cuenta',ancho => '0%', filtro => 'N', valor => '-', indice => 'N', visor => 'N'),
                array(etiqueta => 'Referencia',campo => 'id_asiento_aux',ancho => '10%', filtro => 'N', valor => '-', indice => 'N', visor => 'S'),
