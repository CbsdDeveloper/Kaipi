    ...
    class componente{
      ...
      function componente( ){
            //inicializamos la clase para conectarnos a la bd
               ...
               $this->formulario = 'Model-co_asientos_rev.php'; 
   
               $this->evento_form = '../model/Model-co_asientos_rev.php';        // eventos para ejecucion de editar eliminar y agregar 
      }
       //-----------------------------------------------------------------------------------------------------------
      //Constructor de la clase
      //-----------------------------------------------------------------------------------------------------------
     ...
     function Formulario( ){
        ...
        $this->set->body_tab($titulo,'inicio');
                ...
                $this->obj->list->lista('Estado',$MATRIZ,'estado',$datos,'','','div-1-3');
                ...
                $cboton1 = 'Cuenta<a href="#" '.$evento.' title="Agregar Cuenta"><img src="../../kimages/cnew.png"/></a>';
