...
class proceso{
	...
	function cabecera($titulo){
	    ...
	    echo ' <tr>
                ...
                <tr>
                    <td width="20%" '. $estilo .'>Clasificador</td>
                    <td width="50%" '. $estilo .'>Detalle</td>
                    <td width="30%" '. $estilo .'>Inicial</td>
                 </tr>';
	...
	public function Bloque_Activo( $tipo,$anio){
		...
		echo "<td> </td>";
	    echo "<td> </td>";
	    echo "<td align='right'>".number_format($inicial_debe1,2)."</td> </tr>";
