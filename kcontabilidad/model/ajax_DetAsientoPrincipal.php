...
session_start();  
    ...
    while ($y=$bd->obtener_fila($resultado)){
        ...
        if( $y['partida_enlace'] == 'ingreso'){
            ...
            $grupo1    = "'".$y['cuenta']."'";
            $funcion1  = ' onClick="goToURver(0,'.$y['id_asientod'].','.$grupo1.')" ';
            $title1    = 'data-toggle="modal" data-target="#myModalpartidas" title="Enlace partidas"';
            $boton_enlaces = '<button   class="btn btn-xs" '.$title1.$funcion1.' ><i class="glyphicon glyphicon-bed"></i></button>&nbsp;';
        ...
        if( $y['partida_enlace'] == 'gasto'){
            ...
            $grupo1    = "'".$y['cuenta']."'";
            $funcion1  = ' onClick="goToURver(1,'.$y['id_asientod'].','.$grupo1.')" ';
            $title1    = 'data-toggle="modal" data-target="#myModalpartidas" title="Enlace partidas"';
            $boton_enlaces = '<button   class="btn btn-xs" '.$title1.$funcion1.' ><i class="glyphicon glyphicon-bed"></i></button>&nbsp;';
        ...
        $acciones = $boton_gas.$boton_del.$boton_ing.$boton_ingreso.$boton_anticipo.$boton_enlaces;
