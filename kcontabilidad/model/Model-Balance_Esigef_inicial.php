...
class proceso{
	...
	function sqlwhere($f1,$f2,$tipo,$nivel){
		...
		$cadena3 = '( anio ='.$this->bd->sqlvalue_inyeccion($this->anio ,true).")  and  (coalesce(inicial_debe,0) + coalesce(inicial_haber,0)) > 0  ";
	...
	function cabecera($valida){
	        ...
	        echo '  <tr>
                  <td colspan="3">&nbsp;</td>
                  <td colspan="2" align="center" bgcolor="#E4FFA7"><b>SALDOS INICIALES</b></td>
 
                </tr>
                <tr>
                  <td width="10%">Nivel</td>
                  <td width="10%">Cuenta</td>
                  <td width="60%">Denominacion</td>
                  <td width="10%">Deudor</td>
                  <td width="10%">Acreedor</td>
                </tr>';
	    ...
	    echo '<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 13px;table-layout: auto"> 
              <tr>
                  ...
                  <td  width="60%" rowspan="2" style="text-align: center"><b>'.$_SESSION['razon'].'</b><br>
                        ...
                        <b>BALANCE DE INICIAL POR UNIDAD EJECUTORA '.$f1.'  al '.$f2.'</b></td>
                  <td  width="20%">&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;<br>
