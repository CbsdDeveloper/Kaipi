<?php 
    ...
    $Array_Cabecera = $bd->query_array(
        ...
        'id_asiento ='.$bd->sqlvalue_inyeccion($id,true). ' and codigoe =10'
        );
    ...
    if ( $envio == 1) {
        ...
        //    $url  = "http://www.s2i.com.ec/kaipi/facturae/autoriza_comprobante_externo.php";
       //     $ruta = 'http://www.s2i.com.ec/kaipi/facturae/';
            
            
            $url  = "http://159.69.66.94/~grupoinv/factura/autoriza_comprobante_externo1.php";
