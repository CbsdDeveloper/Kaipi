<?php 
 ...
 class proceso{
      ...
      //-----------------------------------------------------------------------------------------------------------
      public function BusquedaGrilla($festado,$ffecha1,$ffecha2,$fmodulo,$qid_asiento){
      	...
      	if ( $fmodulo == 'todos'){
      	    $cadena01 = " trim(a.modulo) in ('cxpagar','cxcobrar','nomina','contabilidad') and " ;
      	}
      	else {
      	...
      	if ( $qid_asiento > 0){
      	    $cadena01 =  '( a.id_asiento = '.$this->bd->sqlvalue_inyeccion($qid_asiento,true).')   ';
      	    $cadena2  = '';
      	    $cadena1  = '';
      	}
...
///------------------------------------------------------------------------ 
            ...
            if (isset($_GET['festado']))	{
            	...
            	$gestion->BusquedaGrilla($festado,$ffecha1,$ffecha2,$fmodulo,$qid_asiento);
