<?php 
   ...
   require '../../kconfig/Obj.conf.php'; /*Incluimos el fichero de la clase objetos*/
    ...
    class grilla_co_validacion_gasto_g{
      ...
      //-----------------------------------------------------------------------------------------------------------
      function grilla_co_validacion_gasto_g( ){
...
public function Gasto( $fitem,$ffecha1,$ffecha2,$tipo_cta){
    ...
    $fecha = '( fecha BETWEEN '.$this->bd->sqlvalue_inyeccion($ffecha1,true)." and ".
                            ...
                            $sql = "select item_presupuesto,cuenta_c as cuenta,sum(debe) as devengado
                            ...
                            group by  item_presupuesto,cuenta_c";
...
public function Ingreso($fitem, $ffecha1,$ffecha2,$tipo_cta){
    ...
    $fecha = '( fecha BETWEEN '.$this->bd->sqlvalue_inyeccion($ffecha1,true)." and ".
        $this->bd->sqlvalue_inyeccion($ffecha2,true)." )   ";
            ...
            $sql = "select item_presupuesto as item,cuenta_c as cuenta,  sum(haber) as devengado
...
///------------------------------------------------------------------------ 
    		...
    		$gestion   = 	new grilla_co_validacion_gasto_g;
