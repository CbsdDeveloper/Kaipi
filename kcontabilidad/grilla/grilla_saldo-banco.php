...
class proceso{
    ...
    //-----------------------------------------------------------------------------------------------------------
    public function BusquedaSaldo($idbancos,$ffecha1,$ffecha2){
     
    
        $detalle = $this->bd->_ccuenta_detalle($idbancos, $this->ruc);
        ...
        $cbanco = '<h4><b>'.$idbancos.' '.$detalle.'</b></h4>'.
                  '<h5><b>Periodo: '.$ffecha1.' al '.$ffecha2.'</b></h5> 
                   <h5><b>Saldo inicial: '.number_format($saldo,2,",",".").'</b></h5> ';
...
if (isset($_GET['idbancos']))	{
    ...
    $gestion->BusquedaSaldo($idbancos,$ffecha1,$ffecha2);
